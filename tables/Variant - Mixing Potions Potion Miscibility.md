...
| 00 | Only one potion works, but its effect is permanent. Choose the simplest effect to make permanent, or the one that seems the most fun. For example, a [potion of healing](/items/potion-of-healing-xdmg.md) might increase the drinker's hit point maximum by 4, or [oil of etherealness](/items/oil-of-etherealness-xdmg.md) might permanently trap the user in the Ethereal Plane. At your discretion, an appropriate spell, such as [dispel magic](/spells/dispel-magic-xphb.md) or [remove curse](/spells/remove-curse-xphb.md), might end this lasting effect. |
^potion-miscibility