...
| 3 | Any creature that removes itself from the ship's [spelljamming helm](/items/spelljamming-helm-aag.md) receives a startling but harmless magical shock. |
...
| 10 | A creature seated in the ship's [spelljamming helm](/items/spelljamming-helm-aag.md) hears faint spacefaring chanteys in its mind except when the ship is under attack. |
^ship-quirks