...
| dice: d100 | Effect |
|------------|--------|
| 01–06 | One random creature in the region gains the ability to cast the [detect thoughts](/spells/detect-thoughts-xphb.md) spell (save DC 13) once over the next 24 hours, requiring no components. Intelligence is the spellcasting ability for this spell. |
| 07–12 | One random creature in the region is affected by the [mind blank](/spells/mind-blank-xphb.md) spell for the next 24 hours. |
...
| 71–76 | One random creature in the region gains the ability to cast the [telekinesis](/spells/telekinesis-xphb.md) spell (save DC 15) once over the next 24 hours, requiring no components. Intelligence is the spellcasting ability for this spell. |
