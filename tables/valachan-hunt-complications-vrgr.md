...
| 3 | The area is riddled with traps set by Chakuna. A random character must succeed on a DC 15 Wisdom ([Perception](/rules/skills.md#Perception)) check or fall into a [spiked pit](/traps-hazards/hidden-pit-xdmg.md) (see the "Dungeon Master's Guide"). |
| 4 | [Chuuls](/bestiary/aberration/chuul-xmm.md), [vine blights](/bestiary/plant/vine-blight-xmm.md), or [zombie plague spreaders](/bestiary/undead/zombie-plague-spreader-rhw.md) (see "chapter 5") ambush the party. |
| 5 | The characters find a tree bound in rope. One or more withered, oversized hearts hang from cords attached to its branches. Roll a die. If you roll an even number, the hearts look grim but are harmless. If you roll an odd number, the `1d6` hearts have the statistics of gnashing [death's heads](/bestiary/undead/deaths-head-rhw.md) (see "chapter 5") and attack. |
...
| 7 | The party encounters a [druid](/bestiary/humanoid/druid-xmm.md), [green hag](/bestiary/fey/green-hag-xmm.md), or [displacer beast](/bestiary/monstrosity/displacer-beast-xmm.md) that is not part of the hunt. If a character succeeds on a DC 16 Charisma ([Persuasion](/rules/skills.md#Persuasion)) check, that creature shows them a route that allows them to move at double their speed for the next hour and avoid rolling on this table at the end of that time. |
| 8 | An individual or a group of competitors—[gladiators](/bestiary/humanoid/gladiator-xmm.md), [scouts](/bestiary/humanoid/scout-xmm.md), or [tribal warriors](/bestiary/humanoid/warrior-infantry-xmm.md)—attempts to ambush the party. |
...
| 11 | Dinosaurs, [giant poisonous snakes](/bestiary/beast/giant-venomous-snake-xmm.md), or [hydras](/bestiary/monstrosity/hydra-xmm.md) attack the party. |
...
| 15 | [Panthers](/bestiary/beast/panther-xmm.md), [displacer beasts](/bestiary/monstrosity/displacer-beast-xmm.md), or werepanthers ([weretigers](/bestiary/monstrosity/weretiger-xmm.md)) attempt to ambush the party. |
| 16 | The characters discover the corpse of a competitor. Roll a die. If you roll an even number, the corpse has a [potion of healing](/items/potion-of-healing-xdmg.md). If you roll an odd number, the corpse's heart has been removed. |
