...
| [Disengage](/rules/actions.md#Disengage) | Your movement doesn't provoke [Opportunity Attacks](/rules/actions.md#Opportunity%20Attack) for the rest of the turn. |
| [Dodge](/rules/actions.md#Dodge) | Until the start of your next turn, attack rolls against you have [Disadvantage](/rules/variant-rules/disadvantage-xphb.md), and you make Dexterity saving throws with [Advantage](/rules/variant-rules/advantage-xphb.md). You lose this benefit if you have the [Incapacitated](/rules/conditions.md#Incapacitated) condition or if your [Speed](/rules/variant-rules/speed-xphb.md) is 0. |
