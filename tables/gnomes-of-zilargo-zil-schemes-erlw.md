...
| 2 | You have an anonymous contact who sends you missions via the [sending](/spells/sending-xphb.md) spell. When you do as you're asked, you receive handsome rewards. |
...
| 5 | You've acquired a [spellshard](/items/spellshard-erlw.md) (described in "chapter 5") that contains a vast amount of text in a strange code. |
