...
| dice: d6 | Effect |
|----------|--------|
| 1 | Every spell cast in the area triggers a wild magic surge. (Roll on the [Wild Magic Surge](/tables/wild-magic-surge-xphb.md) table in the "Sorcerer" section of the *Player's Handbook*.) |
...
| 3 | The area is affected by a [guards and wards](/spells/guards-and-wards-xphb.md)*spell*. |
...
| 6 | Random sections of the area are affected by an [antimagic field](/spells/antimagic-field-xphb.md) spell. |
^bizarre-magical-effects