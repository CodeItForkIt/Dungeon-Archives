...
*Use this column for [Cylinders](/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](/rules/variant-rules/sphere-area-of-effect-xphb.md).