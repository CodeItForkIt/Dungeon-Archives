...
When you cast the spell, you gain a number of [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md) equal to the [Hit Points](/rules/variant-rules/hit-points-xphb.md) of the first form into which you shape-shift. These [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md) vanish if any remain when the spell ends.
