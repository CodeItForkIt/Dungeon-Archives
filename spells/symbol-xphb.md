...
- spell/class/druid
- spell/class/wizard
- spell/feat/boon-of-siberys/mark-of-scribing
...
Once triggered, the glyph glows, filling a 60-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md) with [Dim Light](/rules/variant-rules/dim-light-xphb.md) for 10 minutes, after which time the spell ends. Each creature in the [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md) when the glyph activates is targeted by its effect, as is a creature that enters the [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md) for the first time on a turn or ends its turn there. A creature is targeted only once per turn.
