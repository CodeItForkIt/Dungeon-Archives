...
An aura of antimagic surrounds you in a 10-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md). No one can cast spells, take [Magic](/rules/actions.md#Magic) actions, or create other magical effects inside the aura, and those things can't target or otherwise affect anything inside it. Magical properties of magic items don't work inside the aura or on anything inside it.
