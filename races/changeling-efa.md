...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/EFA/Changeling.webp#right)
...
Thanks to your connection to the fey realm, you gain proficiency in two of the following skills of your choice: [Deception](/rules/skills.md#Deception), [Insight](/rules/skills.md#Insight), [Intimidation](/rules/skills.md#Intimidation), [Performance](/rules/skills.md#Performance), or [Persuasion](/rules/skills.md#Persuasion).
...
While shape-shifted with this trait, you have [Advantage](/rules/variant-rules/advantage-xphb.md) on Charisma checks.
