...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/MPMM/Duergar.webp#right)
...
Starting at 3rd level, you can cast the [enlarge/reduce](/spells/enlarge-reduce-xphb.md) spell on yourself with this trait, without requiring a material component. Starting at 5th level, you can also cast the [invisibility](/spells/invisibility-xphb.md) spell on yourself with this trait, without requiring a material component. Once you cast either of these spells with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast these spells using spell slots you have of the appropriate level.
