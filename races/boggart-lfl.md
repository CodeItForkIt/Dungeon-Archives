...
![A boggart in Lorwyn uses a frog as a dowsing pendulum](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/LFL/Boggart.webp#right)
...
Like their Lorwyn counterparts, Shadowmoor boggarts are drawn to magic. These boggarts might become Warlocks, particularly leaning toward the [Archfey Patron](/classes/warlock-xphb.md) subclass; some might believe their patron is Isilu. Others prove to be Sorcerers and are especially likely to manifest their power in the form of the [Wild Magic Sorcery](/classes/sorcerer-xphb.md) subclass.