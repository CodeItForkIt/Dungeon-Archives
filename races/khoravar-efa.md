...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/races/EFA/Khoravar.webp#right)
...
You know the [Friends](/spells/friends-xphb.md) cantrip. Whenever you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can replace that cantrip with a different cantrip from the Cleric, Druid, or Wizard spell list. Intelligence, Wisdom, or Charisma is your spellcasting ability for it (choose the ability when you select this species).

### Lethargy Resilience

When you fail a saving throw to avoid or end the [Unconscious](/rules/conditions.md#Unconscious) condition, you can succeed instead. Once you use this trait, you can't do so again until you finish `1d4` [Long Rests](/rules/variant-rules/long-rest-xphb.md).

### Skill Versatility

You gain proficiency in one skill or with one tool of your choice. Whenever you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can replace it with another skill or tool proficiency.
