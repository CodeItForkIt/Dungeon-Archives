...
An infernal war machine's engine, furnace, and weapons are magical and become inoperable within an [antimagic field](/spells/antimagic-field-xphb.md). When the engine or furnace comes into contact with such an effect, the infernal war machine shuts down and can't be restarted until both the engine and the furnace are free of the field.
...
If the driver is [incapacitated](/rules/conditions.md#Incapacitated), leaves the helm, or does nothing to alter the infernal war machine's course and speed, the vehicle moves in the same direction and at the same speed as it did during the driver's last turn until it hits an obstacle big enough to stop it.
...
- Cause the infernal war machine to take the [Dash](/rules/actions.md#Dash) or [Disengage](/rules/actions.md#Disengage) action while the vehicle's engine is running.  
- Insert a [soul coin](/items/soul-coin-bgdia.md) or pour a flask of demon ichor into the engine's furnace (see "Soul Fuel" and "Demon Ichor Boost" below).  
...
The engine at the heart of every infernal war machine has a furnace fueled by [soul coins](/items/soul-coin-bgdia.md). Among the vehicle's helm controls is a narrow slot into which [soul coins](/items/soul-coin-bgdia.md) can be fed. [soul coins](/items/soul-coin-bgdia.md) placed in this slot tumble into the furnace, which is two size categories smaller than the vehicle containing it.

An infernal war machine's furnace consumes a [soul coin](/items/soul-coin-bgdia.md) instantly, expending all the coin's remaining charges at once and destroying the coin in the process. The soul trapped in the coin becomes trapped in the furnace instead, powering the infernal war machine for a duration determined by how many charges the [soul coin](/items/soul-coin-bgdia.md) had when it was consumed: 1 charge, 24 hours; 2 charges, 48 hours; 3 charges, 72 hours. If it's still trapped in the furnace when this duration ends, the soul is destroyed. Not even divine intervention can restore a soul destroyed in this manner.
...
| 11–13 | **Blinding Smoke**. The helm station fills with smoke and is heavily obscured until this mishap ends. Any creature in the helm station is [blinded](/rules/conditions.md#Blinded) by the smoke. | 15 (Dex) |
...
| 20 | **Flip**. The vehicle flips over, falls [prone](/rules/conditions.md#Prone), and comes to a dead stop in an unoccupied space. Any unsecured creature holding on to the outside of the vehicle must succeed on a DC 20 Strength saving throw or be thrown off, landing [prone](/rules/conditions.md#Prone) in a random unoccupied space within 20 feet of the overturned vehicle. Creatures inside the vehicle fall [prone](/rules/conditions.md#Prone) and must succeed on a DC 15 Strength saving throw or take 10 (`3d6`) bludgeoning damage. | None |
^mishaps

### Vehicular Exhaustion

The harsh conditions of the Nine Hells can cause an infernal war machine to stop functioning properly, until it eventually breaks down. Such wear and tear can be represented using [exhaustion](/rules/conditions.md#Exhaustion), as described in [appendix A](/rules/conditions.md#Exhaustion) of the "Player's Handbook", with these modifications:

- When an infernal war machine reaches [exhaustion](/rules/conditions.md#Exhaustion) level 6, its hit points drop to 0, and the vehicle breaks down.  
- The only way to remove the effects of [exhaustion](/rules/conditions.md#Exhaustion) on an infernal war machine is to repair the vehicle.  

### Repairs

When an infernal war machine is damaged, suffers a mishap, or gains one or more levels of [exhaustion](/rules/conditions.md#Exhaustion), a creature can attempt to make repairs to the vehicle. The creature making the repairs must meet the following criteria:
...
- The creature must have the right tools for the job ([smith's tools](/items/smiths-tools-xphb.md) or [tinker's tools](/items/tinkers-tools-xphb.md), for example).  

Before beginning repairs, a creature must decide whether the repairs are aimed at ending a mishap, removing a level of [exhaustion](/rules/conditions.md#Exhaustion), or restoring the damaged vehicle's hit points. Each option is discussed below.
...
If the infernal war machine has one or more levels of [exhaustion](/rules/conditions.md#Exhaustion), a creature can spend 1 hour or more trying to reduce the vehicle's [exhaustion](/rules/conditions.md#Exhaustion) level. The vehicle must be stationary, and the creature must have spare parts to make the necessary repairs. After 1 hour of repair work, the creature makes a DC 15 Intelligence check, adding its proficiency bonus to the check if it's proficient with the tools used to make repairs. If the check succeeds, the vehicle's [exhaustion](/rules/conditions.md#Exhaustion) level decreases by 1. If the check fails, the vehicle's [exhaustion](/rules/conditions.md#Exhaustion) level remains unchanged, though the repair can be attempted again using the same replacement parts.
...
When an infernal war machine goes over a cliff or otherwise falls, the vehicle and all creatures on or inside it take damage from the fall as normal (`1d6` bludgeoning damage per 10 feet fallen, maximum `20d6`) and land [prone](/rules/conditions.md#Prone).
...
| 4 | A swirling cloud of dust envelops the vehicle. Any creature on or inside the vehicle that doesn't have total cover is [blinded](/rules/conditions.md#Blinded) by the dust until the start of its next turn unless it's using some kind of protective eyewear. |
...
| 6 | Your vehicle drives into a herd of [lemures](/bestiary/fiend/lemure-xmm.md), [manes](/bestiary/fiend/manes-xmm.md), or other fiends. The vehicle must make a DC 15 Strength or Dexterity check (driver's choice) to plow through the herd unimpeded. On a failed check, the herd counts as 30 feet of difficult terrain. |
| 7 | The vehicle drives off a 10-foot-high ledge and comes crashing down. Any unsecured creature on the outside of the vehicle must succeed on a DC 15 Dexterity saving throw or tumble off, taking normal damage from the fall and landing [prone](/rules/conditions.md#Prone) in an unoccupied space on the ground. |
