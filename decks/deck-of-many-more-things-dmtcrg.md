...
**Upright Meaning.** - **Person.** Someone with a distorted view of reality, perhaps a [cultist](/bestiary/humanoid/cultist-xmm.md) or a [warlock of the Great Old One](/bestiary/humanoid/warlock-of-the-great-old-one-mpmm.md); perhaps simply an eccentric person with a nonconformist style.  
...
**Reversed Meaning.** - **Person.** A person (perhaps a [druid](/bestiary/humanoid/druid-xmm.md)) dedicated to preserving nature against corrupting influences.  
...
- **Treasure.** An art object depicting the triumph of nature over corruption, or a magic item useful against Aberrations (such as a [Ring of Mind Shielding](/items/ring-of-mind-shielding-xdmg.md)).  
...
- **Treasure.** A treasure that incorporates fur, feathers, bones, or claws from a Beast, or a magic item that allows transformation into a Beast (such as a [Cloak of the Bat](/items/cloak-of-the-bat-xdmg.md) or [Staff of the Python](/items/staff-of-the-python-xdmg.md)).  
...
- **Treasure.** An ornate saddle, a goad, or another item related to the use of domestic animals, or a magic item that allows control of Beasts (such as a [Potion of Animal Friendship](/items/potion-of-animal-friendship-xdmg.md)).  
...
- **Treasure.** A valuable or magical pen, an ink vial, or a set of pigments (such as [Nolzur's Marvelous Pigments](/items/nolzurs-marvelous-pigments-xdmg.md)).  
...
- **Creature or Trap.** A trap involving written runes (such as a [Glyph of Warding](/spells/glyph-of-warding-xphb.md) or [Symbol](/spells/symbol-xphb.md) spell).  
...
- **Creature or Trap.** Someone who coordinates the efforts of different kinds of creatures, such as a [mind flayer](/bestiary/aberration/mind-flayer-xmm.md) mastermind using [grimlocks](/bestiary/aberration/grimlock-xmm.md) and [trolls](/bestiary/giant/troll-xmm.md) as agents.  
- **Place.** A bridge across a river or chasm.  
- **Treasure.** An art object depicting a bridge, or a magic item intended to help overcome obstacles (such as [Boots of Striding and Springing](/items/boots-of-striding-and-springing-xdmg.md)).  
...
- **Treasure.** An art object depicting walls, barriers. or a labyrinth; alternatively, a magic item that creates magical walls (such as a [Cube of Force](/items/cube-of-force-xdmg.md)).  
...
- **Treasure.** An art object depicting a peaceful scene, or a magic item that facilitates safe rest (such as a [Rod of Security](/items/rod-of-security-xdmg.md)).  
...
- **Treasure.** An art object that suggests frenetic activity, or a magic item that helps its user remain alert (such as a [Sentinel Shield](/items/sentinel-shield-xdmg.md)),  
...
- **Creature or Trap.** A creature (such as a [piercer](/bestiary/aberration/piercer-xmm.md) or a [roper](/bestiary/aberration/roper-xmm.md)) that mimics the features of natural caverns.  
- **Place.** A cavern or a cavernous building such as a large temple.  
- **Treasure.** A geode, jewelry made from gems and precious metals, or a magic item that grants [darkvision](/rules/senses.md#Darkvision) (such as [Goggles of Night](/items/goggles-of-night-xdmg.md)).  
...
- **Creature or Trap.** A construct, particularly designed to be animated (like a golem) as opposed to an ordinary object (like a [broom](/bestiary/construct/animated-broom-xmm.md) or [rug](/bestiary/construct/animated-rug-of-smothering-xmm.md)) that has been animated.  
...
- **Treasure.** An object fashioned with minimum alteration of its raw materials, or a magic item useful against Constructs (such as a [Mace of Smiting](/items/mace-of-smiting-xdmg.md)).  
...
- **Treasure.** An art object depicting dead bodies, a corpse just starting to decay, or a magic item that causes decay (such as a [Staff of Withering](/items/staff-of-withering-xdmg.md)).  
...
- **Creature or Trap.** A creature that induces confusion or erratic behavior (such as an [umber hulk](/bestiary/monstrosity/umber-hulk-xmm.md)).  
...
- **Creature or Trap.** A creature that prevents others from acting (such as a [ghoul](/bestiary/undead/ghoul-xmm.md)).  
...
- **Treasure.** A treasure that once held a being captive, such as an [Efreeti Bottle](/items/efreeti-bottle-xdmg.md) that has lost its magic or an empty [Iron Flask](/items/iron-flask-xdmg.md).  
...
- **Treasure.** An art object that looks very different from various perspectives, or a magic item that creates portals or allows teleportation (such as an [Amulet of the Planes](/items/amulet-of-the-planes-xdmg.md)).  
...
- **Treasure.** A jeweled chest or lockbox, or a magic item that resists change (such as an [Immovable Rod](/items/immovable-rod-xdmg.md)).  
...
- **Treasure.** An art object depicting the death of a Dragon, or a magic item useful against Dragons (such as a [Dragon Slayer](/items/dragon-slayer-xdmg.md)).  
...
- **Treasure.** An art object that incorporates material from an Elemental Plane or imagery of the elements, or a magic item that conjures or controls Elementals (such as a [Ring of Elemental Command](/items/ring-of-elemental-command-xdmg.md)).  
...
- **Creature or Trap.** A [medusa](/bestiary/monstrosity/medusa-xmm.md) or another creature with the power to petrify or a gaze attack.  
- **Place.** Somewhere with commanding views, such as a watchtower or a high promontory.  
- **Treasure.** A landscape painting or tapestry, or a magic item that enhances vision (such as [Goggles of Night](/items/goggles-of-night-xdmg.md)).  
...
- **Treasure.** A valuable sculpture or statue, a gemstone, or a magic item made from stone, such as a [Figurine of Wondrous Power](/items/figurine-of-wondrous-power-xdmg.md).  
...
**Upright Meaning.** - **Person.** A person with Fey ancestry or some other connection to the Fey (such as a [warlock of the Archfey](/bestiary/humanoid/warlock-of-the-archfey-mpmm.md)), or a person with a whimsical sense of humor.  
...
**Upright Meaning.** - **Person.** A tiefling, [warlock of the Fiend](/bestiary/humanoid/warlock-of-the-fiend-mpmm.md), member of a Fiend-worshiping cult, or person who seeks to manipulate others into harmful contracts.  
...
- **Creature or Trap.** A Fiend, a vengeful Undead (such as a [ghost](/bestiary/undead/ghost-xmm.md) or [revenant](/bestiary/undead/revenant-xmm.md)), or a creature dedicated to pursuing designated prey (such as an [invisible stalker](/bestiary/elemental/invisible-stalker-xmm.md)).  
...
- **Treasure.** A treasure symbolizing or commemorating the end of a feud or war, or a magic item that can charm or calm creatures (such as a [Rod of Rulership](/items/rod-of-rulership-xdmg.md)).  
...
- **Treasure.** A treasure stolen from a child or naive person, or magic intended to deceive (such as a [Hat of Disguise](/items/hat-of-disguise-xdmg.md)).  
...
- **Creature or Trap.** A creature connected with wealth, such as a Dragon or a [Xorn](/bestiary/elemental/xorn-xmm.md), or a treasure that doubles as a trap.  
...
- **Creature or Trap.** A trap or creature that uses the appearance of treasure as bait, such as a [mimic](/bestiary/monstrosity/mimic-xmm.md).  
...
- **Treasure.** A treasure depicting or commemorating the slaying of a Giant, or a magic item useful against Giants (such as a [Giant Slayer](/items/giant-slayer-xdmg.md)).  
...
- **Creature or Trap.** A monster some consider silly, such as a [flumph](/bestiary/aberration/flumph-xmm.md), an [owlbear](/bestiary/monstrosity/owlbear-xmm.md), or a [gelatinous cube](/bestiary/ooze/gelatinous-cube-xmm.md).  
- **Place.** A place dedicated to amusement, such as a fairground or a feasting hall.  
- **Treasure.** A humorous art object or magic item, such as a [Wand of Wonder](/items/wand-of-wonder-xdmg.md).  
...
- **Creature or Trap.** A creature with an unsettling laugh, such as a [gnoll](/bestiary/fiend/gnoll-warrior-xmm.md) or [hyena](/bestiary/beast/hyena-xmm.md), or a creature with a cruel sense of humor.  
- **Place.** A place associated with cruelty and pain, such as a torture chamber.  
- **Treasure.** An art object depicting pain or humiliation, or a magic item meant to inflict pain (such as a [Sword of Wounding](/items/sword-of-wounding-xdmg.md)).  
...
- **Treasure.** A magic item needed to overcome an obstacle or defeat an enemy, or the means to unlock a treasure (such as a [Chime of Opening](/items/chime-of-opening-xdmg.md)).  
...
- **Creature or Trap.** A knight who has failed to live up to their code of honor (such as a [death knight](/bestiary/undead/death-knight-xmm.md)).  
...
- **Creature or Trap.** A creature (such as a [will-o'-wisp](/bestiary/undead/will-o-wisp-xmm.md)) that leads travelers astray.  
- **Place.** A demiplane or similar place that can't be found on maps, or a location hidden behind a secret door.  
- **Treasure.** A treasure from another plane of existence, or a magic item that creates or accesses an extradimensional space (like a [Portable Hole](/items/portable-hole-xdmg.md)).  
...
- **Creature or Trap.** A creature that burrows underground, especially one that delves into the earth in search of prey (such as a [giant weasel](/bestiary/beast/giant-weasel-xmm.md)).  
...
- **Creature or Trap.** A creature that lives underground but hunts above ground (such as an [ankheg](/bestiary/monstrosity/ankheg-xmm.md) or a [bulette](/bestiary/monstrosity/bulette-xmm.md)).  
...
- **Creature or Trap.** A Monstrosity, especially one that superficially resembles an ordinary animal or person (such as a [displacer beast](/bestiary/monstrosity/displacer-beast-xmm.md) or [doppelganger](/bestiary/monstrosity/doppelganger-xmm.md)).  
...
- **Creature or Trap.** A Monstrosity that is a potential ally, such as a [hippogriff](/bestiary/monstrosity/hippogriff-xmm.md).  
...
- **Creature or Trap.** A lycanthrope, or a creature that appears to be an inanimate object until it strikes (such as a [gargoyle](/bestiary/elemental/gargoyle-xmm.md)).  
...
- **Treasure.** An art object depicting an ooze or the destruction of a particularly notable Ooze; alternatively, a magic item useful against Oozes (such as a [Ring of Acid Resistance](/items/ring-of-acid-resistance-xdmg.md)).  
...
- **Treasure.** An art object depicting a road or path, or a magic item that allows divination (such as a [Crystal Ball](/items/crystal-ball-xdmg.md) or a [Spell Scroll](/items/spell-scroll-level-6-xdmg.md) of [Find the Path](/spells/find-the-path-xphb.md)).  
...
- **Treasure.** An abstract art object, or a magic item that foils divination (such as an [Amulet of Proof against Detection and Location](/items/amulet-of-proof-against-detection-and-location-xdmg.md)).  
...
- **Treasure.** An art object depicting someone's calamitous fall, or a magic item that allows falling safely (such as a [Ring of Feather Falling](/items/ring-of-feather-falling-xdmg.md)).  
...
- **Creature or Trap.** A creature (such as a [piercer](/bestiary/aberration/piercer-xmm.md)) that attacks by falling on prey.  
- **Place.** An abandoned mansion or palace that is in disrepair due to the owner's downfall.  
- **Treasure.** An art object depicting flight or incorporating feathers, or a magic item that grants flight (such as [Winged Boots](/items/winged-boots-xdmg.md) or a [Cloak of the Bat](/items/cloak-of-the-bat-xdmg.md)).  
...
- **Treasure.** An art object crafted from wood or incorporating leaves; alternatively, a magic item that allows uncontrolled vegetation growth (such as a [Bag of Beans](/items/bag-of-beans-xdmg.md)).  
...
- **Creature or Trap.** A domesticated plant given artificial animation, such as an [awakened tree](/bestiary/plant/awakened-tree-xmm.md) or [shrub](/bestiary/plant/awakened-shrub-xmm.md).  
- **Place.** A place full of carefully pruned and neatly controlled vegetation, such as a topiary garden.  
- **Treasure.** A treasure that incorporates living greenery, such as an ornate terrarium or a potted topiary, or a magic item that allows control of vegetation (such as a [Staff of the Woodlands](/items/staff-of-the-woodlands-xdmg.md)).  
...
- **Treasure.** A magic item such as a [Staff of Healing](/items/staff-of-healing-xdmg.md) or a [Holy Avenger](/items/holy-avenger-xdmg.md); alternatively, valuable temple accouterments.  
...
- **Treasure.** A treasure securely locked away, or a magic item that contains a creature (such as an [Elemental Gem](/items/elemental-gem-xdmg.md) or an [Iron Flask](/items/iron-flask-xdmg.md)).  
...
- **Creature or Trap.** A creature unwillingly bound to serve someone (such as an [invisible stalker](/bestiary/elemental/invisible-stalker-xmm.md)).  
...
- **Treasure.** A treasure that hides a deadly secret, such as a ring with a spring-loaded poison needle, a [Dagger of Venom](/items/dagger-of-venom-xdmg.md), or a cursed magic item.  
...
- **Creature or Trap.** A creature that destroys equipment, such as a [rust monster](/bestiary/monstrosity/rust-monster-xmm.md) or a [black pudding](/bestiary/ooze/black-pudding-xmm.md).  
...
- **Creature or Trap.** A creature that protects others, such as a watchdog or [shield guardian](/bestiary/construct/shield-guardian-xmm.md), or a warding trap designed to repel invaders.  
...
- **Treasure.** An art object depicting ships or travel, or a magic item that facilitates travel (such as a [Folding Boat](/items/folding-boat-xdmg.md)).  
...
- **Treasure.** A treasure still in the hands of the person who made it, or a magic item (such as [Dimensional Shackles](/items/dimensional-shackles-xdmg.md)) that prevents magical movement.  
...
- **Treasure.** An art object that celebrates or depicts deliverance from death, or a magic item that wards off death (such as a [Periapt of Wound Closure](/items/periapt-of-wound-closure-xdmg.md) or a [Scarab of Protection](/items/scarab-of-protection-xdmg.md)).  
...
- **Creature or Trap.** A creature that grows in power as battle continues (such as a [black pudding](/bestiary/ooze/black-pudding-xmm.md) or a [hydra](/bestiary/monstrosity/hydra-xmm.md)).  
- **Place.** A place reached by descending stairs, such as a basement or a lower level of a dungeon.  
- **Treasure.** An intricate treasure that was difficult to create, or a magic item that helps accomplish difficult tasks (such as an [Ioun Stone of Mastery](/items/ioun-stone-mastery-xdmg.md)).  
...
*A statue depicts the god Istus offering the original [Deck of Many Things](/items/deck-of-many-things-xdmg.md) as a gift. The Statue card is a reminder of the past.*
...
- **Treasure.** A statuette or sculpture, either valuable or magical (such as a [Figurine of Wondrous Power](/items/figurine-of-wondrous-power-xdmg.md)).  
...
- **Creature or Trap.** A creature that clings to a memory of fallen glory (such as a [storm giant](/bestiary/giant/storm-giant-xmm.md) or a [mind flayer](/bestiary/aberration/mind-flayer-xmm.md)), a creature in the guise of a statue (such as a [mimic](/bestiary/monstrosity/mimic-xmm.md)), or a statue that functions as a trap.  
...
- **Creature or Trap.** A creature (perhaps a [flumph](/bestiary/aberration/flumph-xmm.md) or a [pixie](/bestiary/fey/pixie-xmm.md)) that offers aid but is too weak to provide meaningful help.  
...
- **Creature or Trap.** A predator, especially one that preys on people or slowly drains their life (such as a [vampire](/bestiary/undead/vampire-xmm.md)).  
...
- **Creature or Trap.** A parasite, [vampire](/bestiary/undead/vampire-xmm.md), or similar creature that siphons strength, happiness, or vitality from others, or a trap designed to separate those caught in it.  
...
- **Creature or Trap.** A temple guardian—perhaps a Celestial, Construct, or [guardian naga](/bestiary/celestial/guardian-naga-xmm.md).  
- **Place.** A temple, shrine, or other place of worship.  
- **Treasure.** A valuable ritual object, such as a candelabra or sacrificial knife, or a magic item linked to worship or divine magic (such as a [Candle of Invocation](/items/candle-of-invocation-xdmg.md)).  
...
- **Creature or Trap.** A creature that bestows curses (such as a [fomorian](/bestiary/giant/fomorian-xmm.md), [rakshasa](/bestiary/fiend/rakshasa-xmm.md), or [mummy](/bestiary/undead/mummy-xmm.md)).  
- **Place.** An area where crime, vice, or other impious behaviors are widespread.  
- **Treasure.** A treasure with superstitious meaning perhaps an amulet meant to ward off evil (such as a [Scarab of Protection](/items/scarab-of-protection-xdmg.md)).  
...
- **Treasure.** A ruler's regalia, or a magic item (such as a [Rod of Rulership](/items/rod-of-rulership-xdmg.md)) that imparts magical authority.  
...
- **Treasure.** An art object created as an act of resistance to tyranny, or a magic item that protects against restraint (such as a [Ring of Free Action](/items/ring-of-free-action-xdmg.md)).  
...
- **Creature or Trap.** A [mummy](/bestiary/undead/mummy-xmm.md), [wight](/bestiary/undead/wight-xmm.md), or similar Undead that lairs in its own tomb.  
...
- **Creature or Trap.** An incorporeal Undead (such as a [wraith](/bestiary/undead/wraith-xmm.md) or [specter](/bestiary/undead/specter-xmm.md)) that's not linked to the place of its death, burial place, or body.  
...
- **Treasure.** An art object depicting an isolated place or a lonely person; alternatively, [Daern's Instant Fortress](/items/daerns-instant-fortress-xdmg.md) or a similar magic item.  
...
- **Treasure.** A treasure featuring diamonds, pearls, or precious wood, or a magic item that increases endurance (such as an [Amulet of Health](/items/amulet-of-health-xdmg.md)).  
...
- **Creature or Trap.** An Undead creature sustained by a thirst for revenge or an unfinished task, such as a [ghost](/bestiary/undead/ghost-xmm.md) or [revenant](/bestiary/undead/revenant-xmm.md).  
...
- **Treasure.** An art object depicting the destruction of an Undead, or a magic item particularly useful against Undead (such as a [Mace of Disruption](/items/mace-of-disruption-xdmg.md)).  
...
- **Treasure.** An art object that reflects its creator's despair or sadness, or a [Sphere of Annihilation](/items/sphere-of-annihilation-xdmg.md).  
...
- **Creature or Trap.** A [skeleton](/bestiary/undead/skeleton-xmm.md), [zombie](/bestiary/undead/zombie-xmm.md), or similar Undead remnant of a living creature; alternatively, a trap that's broken and nonfunctional.  
...
- **Treasure.** A reliable treasure (such as gold coins), or a magic item that produces food or water (such as a [Decanter of Endless Water](/items/decanter-of-endless-water-xdmg.md) or an [Alchemy Jug](/items/alchemy-jug-xdmg.md)).  
