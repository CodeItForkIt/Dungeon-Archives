...
- [Spellcaster](/bestiary/humanoid/spellcaster-esk.md)  
- [Expert](/bestiary/humanoid/expert-esk.md)  
- [Warrior](/bestiary/humanoid/warrior-esk.md)  
...
|-------|------------|--------------|
| 2nd | 16 (`3d8 + 3`) | **Cunning Action.** On the expert's turn in combat, it can take the [Dash](/rules/actions.md#Dash), Disengage, or [Hide](/rules/actions.md#Hide) action as a bonus action. |
...
| 6th | 38 (`7d8 + 7`) | **Extra Attack.** The expert can attack twice, instead of once, whenever it takes the [Attack](/rules/actions.md#Attack) action on its turn. |
^experts-beyond-1st-level
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 2nd | 13 (`3d8`) | **Spellcasting.** The spellcaster learns another 1st-level spell: [bless](/spells/bless-xphb.md) (healer) or [burning hands](/spells/burning-hands-xphb.md) (mage). |
| 3rd | 18 (`4d8`) | **Spellcasting.** The spellcaster gains one 1st-level spell slot. The spellcaster also learns another 1st-level spell: [shield of faith](/spells/shield-of-faith-xphb.md) (healer) or [shield](/spells/shield-xphb.md) (mage). |
| 4th | 22 (`5d8`) | **Ability Score Improvement.** The spellcaster's Int. (mage) or Wis. (healer) score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the spellcaster's spell save DC and the bonus to hit of spell attacks, the bonuses in the Skills entry of the mage, the Wisdom saving throw bonus of the healer, and the passive [Perception](/rules/skills.md#Perception) of the healer. Spellcasting. The spellcaster learns another cantrip: [resistance](/spells/resistance-xphb.md) (healer) or [mage hand](/spells/mage-hand-xphb.md) (mage). |
| 5th | 27 (`6d8`) | **Proficiency Bonus.** The spellcaster's proficiency bonus increases by 1, so make the following changes in the stat block: increase the bonuses in the Saving Throws and Skills entries by 1, and increase the bonuses to hit of its spell and weapon attacks by 1.<br /><br />**Spellcasting.** The spellcaster gains one 1st-level spell slot and two 2nd-level spell slots. The spellcaster also learns one 2nd-level spell: [aid](/spells/aid-xphb.md) (healer) or [invisibility](/spells/invisibility-xphb.md) (mage) |
...
| 4th | 32 (`5d8 + 10`) | **Ability Score Improvement.** The warrior's Str. score increases by 2, raising the modifier by 1, so increase the warrior's [Athletics](/rules/skills.md#Athletics) bonus by 1, and increase the bonuses to hit and damage of the warrior's melee weapon attack by 1. |
...
| 6th | 45 (`7d8 + 14`) | **Extra Attack.** The warrior can attack twice, instead of once, whenever it takes the [Attack](/rules/actions.md#Attack) action on its turn. |
^warriors-beyond-1st-level