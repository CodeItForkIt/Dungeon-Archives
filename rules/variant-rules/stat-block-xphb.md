...
A stat block contains the game statistics of a [monster](/rules/variant-rules/monster-xphb.md). Each stat block includes the following information presented after the [monster's](/rules/variant-rules/monster-xphb.md) name.
