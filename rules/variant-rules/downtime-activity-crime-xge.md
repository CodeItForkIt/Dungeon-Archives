...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](/rules/skills.md#Stealth)), Dexterity using [thieves' tools](/items/thieves-tools-xphb.md), and the player's choice of Intelligence ([Investigation](/rules/skills.md#Investigation)), Wisdom ([Perception](/rules/skills.md#Perception)), or Charisma ([Deception](/rules/skills.md#Deception)).
