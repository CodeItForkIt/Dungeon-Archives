...
- subclass/psion/wilder
aliases:
- "Wilder"
---
# Wilder
*[Psion](psion-llps.md): Psionic Awakening*  
*Source: LaserLlama's Psion p. 8*  
...
> </thead><tbody>
> <tr class="class-progression"><td class"level">1st</td><td class"pb">+2</td><td class"feature"><a href='#Wilder (Level 1)' class='internal-link'>Wilder</a></td></tr>
> <tr class="class-progression"><td class"level">2nd</td><td class"pb">+2</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Psionic Burst (Level 3)' class='internal-link'>Psionic Burst</a></td></tr>
> <tr class="class-progression"><td class"level">4th</td><td class"pb">+2</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">5th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Mental Force (Level 6)' class='internal-link'>Mental Force</a></td></tr>
...
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Mental Torrent (Level 14)' class='internal-link'>Mental Torrent</a>, <a href='#Channeled Chaos (Level 14)' class='internal-link'>Channeled Chaos</a></td></tr>
> <tr class="class-progression"><td class"level">15th</td><td class"pb">+5</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">16th</td><td class"pb">+5</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">17th</td><td class"pb">+6</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">18th</td><td class"pb">+6</td><td class"feature"><a href='#Ascended Wilder (Level 18)' class='internal-link'>Ascended Wilder</a></td></tr>
...
### Inscrutable Mind (Level 1)

*1st-level Wilder feature*

The unpredictable storm that is your mind makes it difficult for others to dominate you. Whenever you are forced to make a saving throw to resist being [charmed](/rules/conditions.md#Charmed), [frightened](/rules/conditions.md#Frightened), or have your thoughts read, you have advantage on your roll.

Also, when you succeed on an Intelligence, Wisdom, or Charisma saving throw, you can spend 1 Psi Point and force the attacker to make an Intelligence saving throw. On a failed save, it takes psychic damage equal to your Psion level.

### Wild Psionics (Level 1)

*1st-level Wilder feature*

The untamed psionic power within you can have unpredictable effects when unleashed. Immediately after you manifest a Psion spell of 1st-level or higher, roll a `d8`. If the result of the roll is equal to the number of Psi Points you spent to manifest that spell you manifest a Psionic Surge along with the normal effects of the spell.

Roll a `d100` on the Psionic Surge table on the following page to determine the Psionic Surge effect that takes place.

![Psionic Surge Table](/tables/psionic-surge-table-llps.md)

### Wilder Spells (Level 1)
...
| Psion Level | Spell |
|-------------|-------|
| 1st | [hideous laughter](/spells/tashas-hideous-laughter-xphb.md) |
| 3rd | [crown of madness](/spells/crown-of-madness-xphb.md) |
| 5th | [cerebral blast](/spells/cerebral-blast-llspell.md) |
| 7th | [confusion](/spells/confusion-xphb.md) |
| 9th | [synaptic static](/spells/synaptic-static-xphb.md) |
^psion-level-spell

### Psionic Burst (Level 3)
...
In addition, when you damage a creature with a Psion spell while it is concentrating on a spell, it has disadvantage on its Constitution saving throw to maintain concentration.

### Channeled Chaos (Level 14)
...
### Ascended Wilder (Level 18)

*18th-level Wilder feature*
