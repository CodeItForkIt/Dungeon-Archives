...
You have learned the artful and ancient magic of [Runes](/lists/list-optfeaturetype-ll-runes.md).
...
**Runic Casting Modifier.** You can cast and concentrate on spells from your Runes, even when you have a Focus. If a Rune requires a target to make a saving throw, it does so against your Intellect save DC. If a Rune requires an attack roll, the the Invoking creature uses its Intelligence as follows:
...
> ![Runes](/lists/list-optfeaturetype-ll-runes.md#Runes)
