...
You gain proficiency in [Insight](/rules/skills.md#Insight) and [Performance](/rules/skills.md#Performance). Whenever you make a check with either of these proficiencies you gain a bonus to your roll equal to one roll of your Intellect Die. If you are already proficient in either skill you gain proficiency in another skill from the Savant skill list in its place.

Your intuitive understanding of musical composition and performance also grants you the benefits below:

- Whenever you would make a [Performance](/rules/skills.md#Performance) check you can choose to use your Intelligence in place of your Charisma.  
...
When a creature under the influence of your Theme makes a saving throw to resist being [charmed](/rules/conditions.md#Charmed), [frightened](/rules/conditions.md#Frightened), or [stunned](/rules/conditions.md#Stunned), you can use a reaction to have it automatically succeed.
...
Also, whenever you use a [Wondrous Theme](/classes/savant-virtuoso-llsave.md#Wondrous%20Theme%20(Level%203)) reaction, you can grant one creature under the influence of your Theme temporary hit points equal to your Intelligence modifier.
...
- When a creature fails its saving throw against [Disarming Melody](/classes/savant-virtuoso-llsave.md#Disarming%20Melody%20(Level%206)) it takes (additional) thunder damage equal to one roll of your Intellect Die.