...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Undead Patron (Level 3)' class='internal-link'>Undead Patron</a></td></tr>
...
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Superior Dread (Level 14)' class='internal-link'>Superior Dread</a></td></tr>
...
As a Bonus Action, you transform into an avatar of your patron's dreadful power, gaining the benefits below for 1 minute, until you have the [Incapacitated](/rules/conditions.md#Incapacitated) condition, or until you end the form (no action required). You can transform a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.

**Facsimile of Life.** You gain [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md) equal to `1d10` plus your Warlock level.

**Fearless Form.** You have Immunity to the [Frightened](/rules/conditions.md#Frightened) condition. If you are Frightened when you transform, the condition immediately ends for you.

**Frightful Avatar.** Once per turn, when you hit a creature with an attack roll, you can force it to make a Wisdom saving throw against your spell save DC. On a failed save, the target has the [Frightened](/rules/conditions.md#Frightened) condition until the end of your next turn.
...
|---------------|--------|
| 3 | [Bane](/spells/bane-xphb.md), [Blindness/Deafness](/spells/blindness-deafness-xphb.md), [Phantasmal Force](/spells/phantasmal-force-xphb.md), [Ray of Sickness](/spells/ray-of-sickness-xphb.md) |
| 5 | [Speak with Dead](/spells/speak-with-dead-xphb.md), [Summon Undead](/spells/summon-undead-xphb.md) |
| 7 | [Greater Invisibility](/spells/greater-invisibility-xphb.md), [Phantasmal Killer](/spells/phantasmal-killer-xphb.md) |
| 9 | [Antilife Shell](/spells/antilife-shell-xphb.md), [Cloudkill](/spells/cloudkill-xphb.md) |
^undead-spells
...
**Unholy Resuscitation.** If you drop to 0 Hit Points and don't die outright, you can cause your body to erupt with deathly energy. Each creature of your choice in a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from you makes a Constitution saving throw against your spell save DC, taking Necrotic damage equal to `2d10` plus your Charisma modifier on a failed save or half as much damage on a successful one. Your Hit Points then change to twice your Warlock level, and you gain 1 [Exhaustion](/rules/conditions.md#Exhaustion) level.
...
**Ghostly Flight.** You have a Fly Speed equal to your Speed and can hover. You can move through creatures and objects as if they were [Difficult Terrain](/rules/variant-rules/difficult-terrain-xphb.md), but you take `1d10` Force damage if you end your turn inside a creature or an object.
