...
**Starting Equipment:** *Choose A or B:* (A) [Greataxe](/items/greataxe-xphb.md), 4 [Handaxes](/items/handaxe-xphb.md), [Explorer's Pack](/items/explorers-pack-xphb.md), and 15 GP; or (B) 75 GP

## Multiclassing Barbarian

- **Weapon Proficiencies**: Martial weapons
- **Armor Training**: [Shields](/items/shield-xphb.md)
...
**Damage Resistance.** You have [Resistance](/rules/variant-rules/resistance-xphb.md) to Bludgeoning, Piercing, and Slashing damage.

**Rage Damage.** When you make an attack using Strength—with either a weapon or an [Unarmed Strike](/rules/variant-rules/unarmed-strike-xphb.md)—and deal damage to the target, you gain a bonus to the damage that increases as you gain levels as a Barbarian, as shown in the Rage Damage column of the Barbarian Features table.

**Strength Advantage.** You have [Advantage](/rules/variant-rules/advantage-xphb.md) on Strength checks and Strength saving throws.

**No Concentration or Spells.** You can't maintain [Concentration](/rules/conditions.md#Concentration), and you can't cast spells.

**Duration.** The Rage lasts until the end of your next turn, and it ends early if you don Heavy armor or have the [Incapacitated](/rules/conditions.md#Incapacitated) condition. If your Rage is still active on your next turn, you can extend the Rage for another round by doing one of the following:
...
While you aren't wearing any armor, your base [Armor Class](/rules/variant-rules/armor-class-xphb.md) equals 10 plus your Dexterity and Constitution modifiers. You can use a [Shield](/items/shield-xphb.md) and still gain this benefit.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [mastery properties](/rules/item-mastery.md) of two kinds of Simple or Martial Melee weapons of your choice, such as [Greataxes](/items/greataxe-xphb.md) and [Handaxes](/items/handaxe-xphb.md). Whenever you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can practice weapon drills and change one of those weapon choices.

When you reach certain Barbarian levels, you gain the ability to use the [mastery properties](/rules/item-mastery.md) of more kinds of weapons, as shown in the Weapon Mastery column of the Barbarian Features table.
...
You gain the [Ability Score Improvement](/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Barbarian levels 8, 12, and 16.
...
**Forceful Blow.** The target is pushed 15 feet straight away from you. You can then move up to half your [Speed](/rules/variant-rules/speed-xphb.md) straight toward the target without provoking [Opportunity Attacks](/rules/actions.md#Opportunity%20Attack).

**Hamstring Blow.** The target's [Speed](/rules/variant-rules/speed-xphb.md) is reduced by 15 feet until the start of your next turn. A target can be affected by only one Hamstring Blow at a time—the most recent one.
...
**Staggering Blow.** The target has [Disadvantage](/rules/variant-rules/disadvantage-xphb.md) on the next saving throw it makes, and it can't make [Opportunity Attacks](/rules/actions.md#Opportunity%20Attack) until the start of your next turn.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Irresistible Offense](/feats/boon-of-irresistible-offense-xphb.md) is recommended.
