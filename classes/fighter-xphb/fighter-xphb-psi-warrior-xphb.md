...
Once you take this action, you can't do so again until you finish a [Short](/rules/variant-rules/short-rest-xphb.md) or [Long Rest](/rules/variant-rules/long-rest-xphb.md) unless you expend a Psionic Energy Die (no action required) to restore your use of it.
...
As a [Bonus Action](/rules/variant-rules/bonus-action-xphb.md), you gain a [Fly Speed](/rules/variant-rules/fly-speed-xphb.md) equal to twice your [Speed](/rules/variant-rules/speed-xphb.md) until the end of the current turn. Once you take this [Bonus Action](/rules/variant-rules/bonus-action-xphb.md), you can't do so again until you finish a [Short](/rules/variant-rules/short-rest-xphb.md) or [Long Rest](/rules/variant-rules/long-rest-xphb.md) unless you expend a Psionic Energy Die (no action required) to restore your use of it.

### Telekinetic Thrust (Level 7)

When you deal damage to a target with your Psionic Strike, you can force the target to make a Strength saving throw (DC 8 plus your Intelligence modifier and [Proficiency Bonus](/rules/variant-rules/proficiency-xphb.md)). On a failed save, you can give the target the [Prone](/rules/conditions.md#Prone) condition or transport it up to 10 feet horizontally.
