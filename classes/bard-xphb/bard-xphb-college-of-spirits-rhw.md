...
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Empowered Channeling (Level 6)' class='internal-link'>Empowered Channeling</a></td></tr>
...
**Guiding Whispers.** You know the [Guidance](/spells/guidance-xphb.md) cantrip. It has a range of 60 feet when you cast it.

**Spiritual Focus.** You employ tools that aid you in channeling spirits. You gain a Gaming Set ([playing cards](/items/playing-cards-xphb.md)). You have proficiency with this Gaming Set, and you can use it or one of the following items as a Spellcasting Focus for your Bard spells: Arcane Focus ([crystal](/items/crystal-xphb.md) or [orb](/items/orb-xphb.md)), [Candle](/items/candle-xphb.md), or [Ink Pen](/items/ink-pen-xphb.md).
...
**Unleashing a Spirit.** As a [Magic](/rules/actions.md#Magic) action, you can unleash one of your channeled spirits. Choose one creature you can see within 30 feet of yourself as the spirit's target. The spirit then takes effect; if a spirit's effect requires a saving throw, the DC equals your Bard spell save DC.
...
| 5 | Fortune Teller. The target has [Advantage](/rules/variant-rules/advantage-xphb.md) on [D20 Tests](/rules/variant-rules/d20-test-xphb.md) until the start of your next turn. |
| 6 | Wayfarer. The target gains [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md) equal to a roll of your Bardic Inspiration die plus your Bard level. While the target has these Temporary Hit Points, its Speed increases by 10 feet. |
...
| 8 | Shade. The target has the [Invisible](/rules/conditions.md#Invisible) condition until the end of its next turn or until the target makes an attack roll, deals damage, or casts a spell. When the invisibility ends, each creature in a 5-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the target must succeed on a Constitution saving throw or take Necrotic damage equal to two rolls of your Bardic Inspiration die. |
...
| 10 | Coward. The target and each creature of your choice in a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the target must succeed on a Wisdom saving throw or have the [Frightened](/rules/conditions.md#Frightened) condition until the start of your next turn. While a creature is Frightened, its Speed is halved (round down), and it can take either an action or a Bonus Action, not both. |
| 11 | Brute. Each creature of your choice in a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the target makes a Strength saving throw. On a failed save, a creature takes Thunder damage equal to three rolls of your Bardic Inspiration die and has the [Prone](/rules/conditions.md#Prone) condition. On a successful save, a creature takes half as much damage only. |
| 12 | Priest. The target regains Hit Points equal to two rolls of your Bardic Inspiration die, and one of the following conditions of your choice ends on the target: [Blinded](/rules/conditions.md#Blinded), [Charmed](/rules/conditions.md#Charmed), [Deafened](/rules/conditions.md#Deafened), [Paralyzed](/rules/conditions.md#Paralyzed), [Poisoned](/rules/conditions.md#Poisoned), or [Stunned](/rules/conditions.md#Stunned). |
^spirits-from-beyond

### Empowered Channeling (Level 6)
