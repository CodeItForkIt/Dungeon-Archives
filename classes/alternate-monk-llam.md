...
- **Skill Proficiencies**: *Choose 2:* [Acrobatics](/rules/skills.md#Acrobatics), [Athletics](/rules/skills.md#Athletics), [History](/rules/skills.md#History), [Insight](/rules/skills.md#Insight), [Nature](/rules/skills.md#Nature), [Religion](/rules/skills.md#Religion), or [Stealth](/rules/skills.md#Stealth)
- **Weapon Proficiencies**: Simple weapons and [shortswords](/items/shortsword-xphb.md)
- **Tool Proficiencies**: a set of [artisan's tools](/items/artisans-tools-xphb.md) or a [musical instrument](/items/musical-instrument-xphb.md)

**Starting Equipment:** You start with the following items, plus anything provided by your background.

- (a) a [shortsword](/items/shortsword-xphb.md) or (b) any simple weapon
- (a) a [shortbow](/items/shortbow-xphb.md) and [20 arrows](/items/arrows-20-xphb.md) or (b) [20 darts](/items/dart-xphb.md)
- (a) a [dungeoneer's pack](/items/dungeoneers-pack-xphb.md) or (b) an [explorer's pack](/items/explorers-pack-xphb.md)
- (a) a [holy symbol](/items/holy-symbol-xphb.md) or (b) a [musical instrument](/items/musical-instrument-xphb.md)
...
- **Weapon Proficiencies**: Simple weapons, [shortswords](/items/shortsword-xphb.md)
...
Some styles of Martial Arts make use of exotic weapons like nunchaku ([clubs](/items/club-xphb.md)), kamas ([sickles](/items/sickle-xphb.md)), or sai ([daggers](/items/dagger-xphb.md)).
...
**Ki.** Your spiritual power is represented by a pool of Ki, equal to your Monk level + your Wisdom modifier (a minimum of 0). Ki is expended when you use it, and you regain all spent Ki whenever you finish a short or long rest. To regain your Ki, you must spend at least 30 minutes of the rest meditating.

You can only expend Ki on one feature or Technique per attack, ability check, reaction, or saving throw.

**Techniques Known.** At 2nd level, you know three [Mystic Techniques](/lists/list-optfeaturetype-llam-t.md) from the list at the end of this class. To learn a Technique you must meet any prerequisites it has. Whenever you gain a Monk level, you can replace one Technique you know with another.

At certain Monk levels you learn additional Techniques, as shown on the Techniques Known column of the Monk table.

**Saving Throws.** Techniques rely on your mastery of body and spirit, and grow in proportion to your self-control. When a Technique requires a saving throw, its saving throw DC is calculated as follows:
...
**Signature Techniques.** Most Traditions have a list of Signature Techniques that you learn at the Monk levels as noted in your Tradition. These do not count against your number of Techniques Known. These Techniques also cannot be replaced with other Techniques.
...
Your supernatural agility lets you dodge out of the way of certain area effects, like a black dragon's acid breath or a [lightning bolt](/spells/lightning-bolt-xphb.md) spell. Starting at 7th level, whenever you are subjected to an effect that allows you to make a Dexterity saving throw to take half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
...
> ![Alternate Monk; Mystic Techniques](/lists/list-optfeaturetype-llam-t.md#Alternate%20Monk;%20Mystic%20Techniques)
