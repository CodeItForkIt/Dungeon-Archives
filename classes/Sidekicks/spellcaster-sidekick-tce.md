...
- **Mage.** [mage hand](/spells/mage-hand-xphb.md), [ray of frost](/spells/ray-of-frost-xphb.md), [thunderwave](/spells/thunderwave-xphb.md)  
- **Healer.** [cure wounds](/spells/cure-wounds-xphb.md), [guidance](/spells/guidance-xphb.md), [sacred flame](/spells/sacred-flame-xphb.md)  
- **Prodigy.** [eldritch blast](/spells/eldritch-blast-xphb.md), [healing word](/spells/healing-word-xphb.md), [light](/spells/light-xphb.md)  
...
**Spellcasting Focus.** The sidekick can use a focus for its spells depending on the choice you made on the Spellcasting table. A Mage can use an arcane focus, a Healer can use a holy symbol, and a Prodigy can use an arcane focus or a [musical instrument](/items/musical-instrument-xphb.md).
