...
- json5e-class
tags:
- class/alternate-artificer
- compendium/src/5e/llaart
aliases:
- "Alternate Artificer"
---
# Alternate Artificer
...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value">Cantrips Known</th><th class="value">Spells Known</th><th class="value">1st</th><th class="value">2nd</th><th class="value">3rd</th><th class="value">4th</th><th class="value">5th</th><th class="value"><a href="/lists/list-optfeaturetype-llaart-inf.md">Infusions Known</a></th></tr>
> </thead><tbody>
...
- **Skill Proficiencies**: *Choose 2:* [Arcana](/rules/skills.md#Arcana), [History](/rules/skills.md#History), [Insight](/rules/skills.md#Insight), [Investigation](/rules/skills.md#Investigation), [Medicine](/rules/skills.md#Medicine), [Nature](/rules/skills.md#Nature), or [Sleight of Hand](/rules/skills.md#Sleight%20of%20Hand)
- **Weapon Proficiencies**: Simple weapons, [hand crossbows](/items/hand-crossbow-xphb.md), and firearms
- **Tool Proficiencies**: [Tinker's tools](/items/tinkers-tools-xphb.md) and One type of [artisan's tools](/items/artisans-tools-xphb.md)
...
You can make a Artificer quickly by following these suggestions. First, make Intelligence your highest ability score, followed by Dexterity. Second, choose the [artisan](/backgrounds/guild-artisan.md) background. Third, choose the [enhanced defense](/optional-features/enhanced-defense-llaart.md) and [repeating shot](/optional-features/repeating-shot-llaart.md) infusions.

## Class Features

### Infusions (Level 1)

You have learned to imbue objects with your signature brand of magic in order to produce wondrous items. At 1st level, you learn two [Infusions](/lists/list-optfeaturetype-llaart-inf.md) of your choice from the list at the end of this class. The Infusions Known column of the artificer table shows when you learn more Infusions of your choice.
...
**Infusing an Object.** At the end of a long rest, you can use your tinker's tools to imbue an Infusion you know into a nonmagical object. To do so, you must be able to touch the object with your tools.
...
**Replicate Magic Item.** You can also use your Infusions to replicate magic items you have studied. During a long rest, you can spend 1 hour using tinker's tools to examine a magic item you touch. At the end of that long rest, you can replace one Infusion you know with the knowledge of this magic item. After which, you can infuse an object with the properties of that magic item, following all the rules for your other Infusions.
...
**Cantrips.** At 2nd level, you learn two cantrips of your choice from the Artificer spell list. You learn an additional Artificer cantrip of your choice at 4th level and another at 10th level.

**Spell Slots.** The Artificer table shows how many spell slots you have to cast your spells of 1st-level and higher. To cast a spell, you must expend a slot equal to the spell's level or higher. You regain all expended spell slots when you finish a long rest.

For example, if you know the 1st-level spell [magic missile](/spells/magic-missile-xphb.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [magic missile](/spells/magic-missile-xphb.md) using either spell slot.

**Spells Known of 1st-level and Higher.** You know two 1st-level spells of your choice from the Artificer spell list. The Spells Known column of the Artificer Table shows when you learn more Artificer spells of your choice. The Spells Known column of the Artificer table shows when you learn more artificer spells of your choice. Each spell must be of a level for which you have spell slots. For example, when you reach 5th level in this class, you can learn one new artificer spell of either 1st or 2nd-level.
...
**Spellcasting Focus.** You must use either your tinker's tools, a set of [artisan's tools](/items/artisans-tools-xphb.md) with which you are proficient, or an item bearing one of your Infusions as the spellcasting focus for your artificer spells.

While you have access to your tinker's tools, you know both the [mending](/spells/mending-xphb.md) cantrip and [identify](/spells/identify-xphb.md), but they don't count against your number of Spells Known. You can use your tinker's tools to cast identify by spending a spell slot, or as a ritual spell.
...
> ![Artificer Infusions (Alternate)](/lists/list-optfeaturetype-llaart-inf.md#Artificer%20Infusions%20(Alternate))
