...
You can increase your powers of perception. As a [Bonus Action](/rules/variant-rules/bonus-action-xphb.md), choose one of the following benefits, which lasts until you start a [Short](/rules/variant-rules/short-rest-xphb.md) or [Long Rest](/rules/variant-rules/long-rest-xphb.md). You can't use this feature again until you finish a [Short](/rules/variant-rules/short-rest-xphb.md) or [Long Rest](/rules/variant-rules/long-rest-xphb.md).

**Darkvision.** You gain [Darkvision](/rules/senses.md#Darkvision) with a range of 120 feet.

**Greater Comprehension.** You can read any language.

**See Invisibility.** You can cast [See Invisibility](/spells/see-invisibility-xphb.md) without expending a spell slot.
