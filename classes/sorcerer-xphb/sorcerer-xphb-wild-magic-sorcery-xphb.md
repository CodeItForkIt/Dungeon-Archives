...
You have the ability to twist fate using your wild magic. Immediately after another creature you can see rolls the `d20` for a [D20 Test](/rules/variant-rules/d20-test-xphb.md), you can take a [Reaction](/rules/variant-rules/reaction-xphb.md) and spend 1 Sorcery Point to roll `1d4` and apply the number rolled as a bonus or penalty (your choice) to the `d20` roll.
