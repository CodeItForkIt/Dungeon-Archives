...
- **Tool Proficiencies**: [Thieves' Tools](/items/thieves-tools-xphb.md), [Tinker's Tools](/items/tinkers-tools-xphb.md), and one type of [Artisan's Tools](/items/artisans-tools-xphb.md) of your choice
...
**Starting Equipment:** *Choose A or B:* (A) [Studded Leather Armor](/items/studded-leather-armor-xphb.md), [Dagger](/items/dagger-xphb.md), [Thieves' Tools](/items/thieves-tools-xphb.md), [Tinker's Tools](/items/tinkers-tools-xphb.md), [Dungeoneer's Pack](/items/dungeoneers-pack-xphb.md), and 16 GP; or (B) 150 GP
...
- **Tool Proficiencies**: [Tinker's Tools](/items/tinkers-tools-xphb.md)
...
**Tools Required.** You produce your Artificer spells through tools. You can use [Thieves' Tools](/items/thieves-tools-xphb.md), [Tinker's Tools](/items/tinkers-tools-xphb.md), or another kind of [Artisan's Tools](/items/artisans-tools-xphb.md) with which you have proficiency as a [Spellcasting Focus](/rules/variant-rules/spellcasting-focus-xphb.md), and you must have one of those focuses in hand when you cast an Artificer spell (meaning the spell has an *M* component when you cast it).

**Cantrips.** You know two Artificer cantrips of your choice. [Acid Splash](/spells/acid-splash-xphb.md) and [Prestidigitation](/spells/prestidigitation-xphb.md) are recommended.

Whenever you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can replace one of your cantrips from this feature with another Artificer cantrip of your choice.
...
**Spell Slots.** The Artificer Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md).

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Artificer spells. [Cure Wounds](/spells/cure-wounds-xphb.md) and [Grease](/spells/grease-xphb.md) are recommended.
...
**Changing Your Prepared Spells.** Whenever you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with other Artificer spells for which you have spell slots.

**Spellcasting Ability.** Intelligence is your spellcasting ability for your Artificer spells.

### Tinker's Magic (Level 1)

You know the [Mending](/spells/mending-xphb.md) cantrip.

As a [Magic](/rules/actions.md#Magic) action while holding [Tinker's Tools](/items/tinkers-tools-xphb.md), you can create one item in an unoccupied space within 5 feet of yourself, choosing the item from the following list:

- [Ball Bearings](/items/ball-bearings-xphb.md)  
- [Basket](/items/basket-xphb.md)  
- [Bedroll](/items/bedroll-xphb.md)  
- [Bell](/items/bell-xphb.md)  
- [Blanket](/items/blanket-xphb.md)  
- [Block and Tackle](/items/block-and-tackle-xphb.md)  
- [Bottle, Glass](/items/glass-bottle-xphb.md)  
- [Bucket](/items/bucket-xphb.md)  
- [Caltrops](/items/caltrops-xphb.md)  
- [Candle](/items/candle-xphb.md)  
- [Crowbar](/items/crowbar-xphb.md)  
- [Flask](/items/flask-xphb.md)  
- [Grappling Hook](/items/grappling-hook-xphb.md)  
- [Hunting Trap](/items/hunting-trap-xphb.md)  
- [Jug](/items/jug-xphb.md)  
- [Lamp](/items/lamp-xphb.md)  
- [Manacles](/items/manacles-xphb.md)  
- [Net](/items/net-xphb.md)  
- [Oil](/items/oil-xphb.md)  
- [Paper](/items/paper-xphb.md)  
- [Parchment](/items/parchment-xphb.md)  
- [Pole](/items/pole-xphb.md)  
- [Pouch](/items/pouch-xphb.md)  
- [Rope](/items/rope-xphb.md)  
- [Sack](/items/sack-xphb.md)  
- [Shovel](/items/shovel-xphb.md)  
- [Spikes, Iron](/items/iron-spikes-xphb.md)  
- [String](/items/string-xphb.md)  
- [Tinderbox](/items/tinderbox-xphb.md)  
- [Torch](/items/torch-xphb.md)  
- [Vial](/items/vial-xphb.md)  

See the rules for the item in the "Player's Handbook". The item lasts until you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), at which point it vanishes.

You can use this feature a number of times equal to your Intelligence modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md).

### Replicate Magic Item (Level 2)

You have learned arcane plans that you use to make magic items.

**Plans Known.** When you gain this feature, choose four plans to learn from the Magic Item Plans (Artificer Level 2+) table (see the "Dungeon Master's Guide" for the items' descriptions). [Bag of Holding](/items/bag-of-holding-xdmg.md), [Cap of Water Breathing](/items/cap-of-water-breathing-xdmg.md), [Sending Stones](/items/sending-stones-xdmg.md), and [Wand of the War Mage](/items/1-wand-of-the-war-mage-xdmg.md) are recommended. Whenever you gain an Artificer level, you can replace one of the plans you know with a new plan for which you qualify.
...
**Creating an Item.** When you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can create one or two different magic items if you have [Tinker's Tools](/items/tinkers-tools-xphb.md) in hand. Each item is based on one of the plans you know for this feature.

If a created item requires [Attunement](/rules/variant-rules/attunement-xphb.md), you can attune yourself to it the instant you create it. If you decide to attune to the item later, you must do so using the normal process for [Attunement](/rules/variant-rules/attunement-xphb.md).

When you reach certain Artificer levels specified in the Magic Items column of the Artificer Features table, the number of magic items you can create at the end of a [Long Rest](/rules/variant-rules/long-rest-xphb.md) increases. Each item you create must be based on a different plan you know.
...
If an item that you created with this feature is a container, such as a [Bag of Holding](/items/bag-of-holding-xdmg.md), and it vanishes, its contents harmlessly appear in and around its space.

**Spellcasting Focus.** You can use any Wand or Weapon created by this feature as a [Spellcasting Focus](/rules/variant-rules/spellcasting-focus-xphb.md) in lieu of using a set of [Artisan's Tools](/items/artisans-tools-xphb.md).
...
|-----------------|------------|
| [Alchemy Jug](/items/alchemy-jug-xdmg.md) | No |
| [Bag of Holding](/items/bag-of-holding-xdmg.md) | No |
| [Cap of Water Breathing](/items/cap-of-water-breathing-xdmg.md) | No |
| Common magic item that isn't a Potion, a Scroll, or cursed* | Varies |
| [Goggles of Night](/items/goggles-of-night-xdmg.md) | No |
| [Manifold Tool](/items/manifold-tool-efa.md) | Yes |
| [Repeating Shot](/items/repeating-shot-efa.md) | Yes |
| [Returning Weapon](/items/returning-weapon-efa.md) | No |
| [Rope of Climbing](/items/rope-of-climbing-xdmg.md) | No |
| [Sending Stones](/items/sending-stones-xdmg.md) | No |
| [Shield +1](/items/1-shield-xdmg.md) | No |
| [Wand of Magic Detection](/items/wand-of-magic-detection-xdmg.md) | No |
| [Wand of Secrets](/items/wand-of-secrets-xdmg.md) | No |
| [Wand of the War Mage +1](/items/1-wand-of-the-war-mage-xdmg.md) | Yes |
| [Weapon +1](/items/1-weapon-xdmg.md) | No |
| [Wraps of Unarmed Power, +1](/items/1-wraps-of-unarmed-power-xdmg.md) | No |
^magic-item-plans-artificer-level-2
...
| Magic Item Plan | Attunement |
|-----------------|------------|
| [Armor +1](/items/1-armor-xdmg.md) | No |
| [Boots of Elvenkind](/items/boots-of-elvenkind-xdmg.md) | No |
| [Boots of the Winding Path](/items/boots-of-the-winding-path-efa.md) | Yes |
| [Cloak of Elvenkind](/items/cloak-of-elvenkind-xdmg.md) | Yes |
| [Cloak of the Manta Ray](/items/cloak-of-the-manta-ray-xdmg.md) | Yes |
| [Dazzling Weapon](/items/dazzling-weapon-efa.md) | Yes |
| [Eyes of Charming](/items/eyes-of-charming-xdmg.md) | Yes |
| [Eyes of Minute Seeing](/items/eyes-of-minute-seeing-xdmg.md) | No |
| [Gloves of Thievery](/items/gloves-of-thievery-xdmg.md) | No |
| [Helm of Awareness](/items/helm-of-awareness-efa.md) | No |
| [Lantern of Revealing](/items/lantern-of-revealing-xdmg.md) | No |
| [Mind Sharpener](/items/mind-sharpener-efa.md) | Yes |
| [Necklace of Adaptation](/items/necklace-of-adaptation-xdmg.md) | Yes |
| [Pipes of Haunting](/items/pipes-of-haunting-xdmg.md) | No |
| [Repulsion Shield](/items/repulsion-shield-efa.md) | No |
| [Ring of Swimming](/items/ring-of-swimming-xdmg.md) | No |
| [Ring of Water Walking](/items/ring-of-water-walking-xdmg.md) | No |
| [Sentinel Shield](/items/sentinel-shield-xdmg.md) | No |
| [Spell-Refueling Ring](/items/spell-refueling-ring-efa.md) | Yes |
| [Wand of Magic Missiles](/items/wand-of-magic-missiles-xdmg.md) | No |
| [Wand of Web](/items/wand-of-web-xdmg.md) | Yes |
| [Weapon of Warning](/items/weapon-of-warning-xdmg.md) | Yes |
^magic-item-plans-artificer-level-6
...
| Magic Item Plan | Attunement |
|-----------------|------------|
| [Armor of Resistance](/items/armor-of-resistance-xdmg.md) | Yes |
| [Dagger of Venom](/items/dagger-of-venom-xdmg.md) | No |
| [Elven Chain](/items/elven-chain-xdmg.md) | No |
| [Ring of Feather Falling](/items/ring-of-feather-falling-xdmg.md) | Yes |
| [Ring of Jumping](/items/ring-of-jumping-xdmg.md) | Yes |
| [Ring of Mind Shielding](/items/ring-of-mind-shielding-xdmg.md) | Yes |
| [Shield, +2](/items/2-shield-xdmg.md) | No |
| Uncommon Wondrous Item that isn't cursed* | Varies |
| [Wand of the War Mage, +2](/items/2-wand-of-the-war-mage-xdmg.md) | Yes |
| [Weapon, +2](/items/2-weapon-xdmg.md) | No |
| [Wraps of Unarmed Power, +2](/items/2-wraps-of-unarmed-power-xdmg.md) | No |
^magic-item-plans-artificer-level-10
...
| Magic Item Plan | Attunement |
|-----------------|------------|
| [Armor, +2](/items/2-armor-xdmg.md) | No |
| [Arrow-Catching Shield](/items/arrow-catching-shield-xdmg.md) | Yes |
| [Flame Tongue](/items/flame-tongue-xdmg.md) | Yes |
| Rare Wondrous Item that isn't cursed* | Varies |
| [Ring of Free Action](/items/ring-of-free-action-xdmg.md) | Yes |
| [Ring of Protection](/items/ring-of-protection-xdmg.md) | Yes |
| [Ring of the Ram](/items/ring-of-the-ram-xdmg.md) | Yes |
^magic-item-plans-artificer-level-14
...
You gain an Artificer subclass of your choice. The [Alchemist](/classes/artificer-alchemist-efa.md), [Armorer](/classes/artificer-armorer-efa.md), [Artillerist](/classes/artificer-artillerist-efa.md), and [Battle Smith](/classes/artificer-battle-smith-efa.md), and [Cartographer](/classes/artificer-cartographer-efa.md) subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Artificer levels. For the rest of your career, you gain each of your subclass's features that are of your Artificer level or lower.

### Ability Score Improvement (Level 4)

You gain the [Ability Score Improvement](/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Artificer levels 8, 12, and 16.
...
Your [Replicate Magic Item](/classes/artificer-efa.md#Replicate%20Magic%20Item%20(Level%202)) feature gains the following options.

**Charge Magic Item.** As a [Bonus Action](/rules/variant-rules/bonus-action-xphb.md), you can touch a magic item within 5 feet of yourself that you created with Replicate Magic Item and that uses charges. You expend a level 1+ spell slot and recharge the item. The number of charges the item regains is equal to the level of spell slot expended.

**Drain Magic Item.** As a [Bonus Action](/rules/variant-rules/bonus-action-xphb.md), you can touch a magic item within 5 feet of yourself that you created with Replicate Magic Item and cause the item to vanish, converting its magical energy into a spell slot. The slot is level 1 if the item is Common or level 2 if the item is Uncommon or Rare. Once you use this feature, you can't do so again until you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md). Any spell slot you create with this feature vanishes when you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md).

**Transmute Magic Item.** As a [Magic](/rules/actions.md#Magic) action, you can touch one magic item within 5 feet of yourself that you created with Replicate Magic Item and transform it into a different magic item. The resulting item must be based on a magic item plan you know. Once you use this feature, you can't do so again until you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md).

### Flash of Genius (Level 7)

When you or a creature you can see within 30 feet of you fails an ability check or a saving throw, you can take a [Reaction](/rules/variant-rules/reaction-xphb.md) to add a bonus to the roll, potentially causing it to succeed. The bonus equals your Intelligence modifier (minimum of +1).

You can take this [Reaction](/rules/variant-rules/reaction-xphb.md) a number of times equal to your Intelligence modifier (minimum of once). You regain all expended uses when you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md).

### Ability Score Improvement (Level 8)

You gain the [Ability Score Improvement](/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify.
...
Whenever you finish a [Long Rest](/rules/variant-rules/long-rest-xphb.md), you can touch one Simple or Martial weapon or one item that you can use as a [Spellcasting Focus](/rules/variant-rules/spellcasting-focus-xphb.md), and you store a spell in it, choosing a level 1, 2, or 3 Artificer spell that has a casting time of an action and doesn't require a Material component that is consumed by the spell (you needn't have the spell prepared).

While holding the object, a creature can take a [Magic](/rules/actions.md#Magic) action to produce the spell's effect from it, using your spellcasting ability modifier. If the spell requires [Concentration](/rules/conditions.md#Concentration), the creature must concentrate. Once a creature has used the object to produce the spell's effect, the object can't be used this way again until the start of the creature's next turn.
...
**Refreshed Genius.** When you finish a [Short Rest](/rules/variant-rules/short-rest-xphb.md), you regain one expended use of your [Flash of Genius](/classes/artificer-efa.md#Flash%20of%20Genius%20(Level%207)) feature.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Energy Resistance](/feats/boon-of-energy-resistance-xphb.md) is recommended.
...
**Cheat Death.** If you're reduced to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md) but not killed outright, you can disintegrate any number of Uncommon or Rare magic items created by your Replicate Magic Item feature. If you do so, your [Hit Points](/rules/variant-rules/hit-points-xphb.md) instead change to a number equal to 20 times the number of magic items disintegrated.

**Magical Guidance.** When you finish a [Short Rest](/rules/variant-rules/short-rest-xphb.md), you regain all expended uses of your [Flash of Genius](/classes/artificer-efa.md#Flash%20of%20Genius%20(Level%207)) if you have [Attunement](/rules/variant-rules/attunement-xphb.md) to at least one magic item.