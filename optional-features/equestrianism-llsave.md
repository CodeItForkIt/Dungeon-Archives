...
You have learned to tend to horses and other trained mounts. You gain proficiency in [Animal Handling](/rules/skills.md#Animal%20Handling), and whenever you make a Wisdom ([Animal Handling](/rules/skills.md#Animal%20Handling)) check, you gain a bonus to your roll equal to one roll of your Intellect Die.
