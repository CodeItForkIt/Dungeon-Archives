...
- **Equipment.** A [hunting trap](/items/hunting-trap-xphb.md), a totemic token or set of tattoos marking your loyalty to Uthgar and your tribal totem, a set of [traveler's clothes](/items/travelers-clothes-xphb.md), and a [pouch](/items/pouch-xphb.md) containing 10 gp  
...
Use the tables for the [outlander](/backgrounds/outlander.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of an Uthgardt tribe.
