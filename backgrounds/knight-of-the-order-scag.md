...
- **Equipment.** One set of [traveler's clothes](/items/travelers-clothes-xphb.md), a signet, banner, or seal representing your place or rank in the order, and a [pouch](/items/pouch-xphb.md) containing 10 gp  
...
Use the tables for the [soldier](/backgrounds/soldier-xphb.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a knight of your order.
