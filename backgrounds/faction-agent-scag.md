...
- **Equipment.** Badge or emblem of your faction, a copy of a seminal faction text (or code-book for a covert faction), a set of [common clothes](/items/common-clothes.md), and a [pouch](/items/pouch-xphb.md) containing 15 gp  
...
Use the tables for the [acolyte](/backgrounds/acolyte-xphb.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a faction agent. (For instance, consider the words "faith" and "faction" to be interchangeable.)
