...
- **Equipment.** A uniform in the style of your unit and indicative of your rank, a [horn](/items/horn-xphb.md) with which to summon help, a set of [manacles](/items/manacles-xphb.md), and a [pouch](/items/pouch-xphb.md) containing 10 gp  
...
Use the tables for the [soldier](/backgrounds/soldier-xphb.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of the city watch.
