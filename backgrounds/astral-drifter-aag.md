...
![Plasmoid Astral Drifter](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/backgrounds/AAG/Astral%20Drifter.webp#right)
...
- **Equipment.** A set of [traveler's clothes](/items/travelers-clothes-xphb.md), a diary, an [ink pen](/items/ink-pen-xphb.md), a [bottle of ink](/items/ink-xphb.md), and a [pouch](/items/pouch-xphb.md) containing 10 gp  
...
You gain the [Magic Initiate feat](/feats/magic-initiate-xphb.md) from the "Player's Handbook" and must choose cleric for the feat.
