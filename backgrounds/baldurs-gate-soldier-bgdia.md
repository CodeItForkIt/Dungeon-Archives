...
- **Equipment.** An insignia of rank, a trophy taken from a fallen enemy (a [dagger](/items/dagger-xphb.md), broken blade, or piece of a banner), a bone [dice set](/items/dice-set-xphb.md) or [playing card set](/items/playing-cards-xphb.md), a set of [common clothes](/items/common-clothes.md), and a belt [pouch](/items/pouch-xphb.md) containing 10 gp  
