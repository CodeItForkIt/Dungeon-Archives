...
- **Equipment.** A set of [fine clothes](/items/fine-clothes-xphb.md), a [signet ring](/items/signet-ring.md) or brooch, a scroll of pedigree, a skin of fine zzar or wine, and a purse containing 20 gp  
...
Use the tables for the [noble](/backgrounds/noble-xphb.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of a Waterdhavian family.
