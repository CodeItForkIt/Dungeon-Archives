...
![A Quandrix student magically gazes into the intricate patterns of nature](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/backgrounds/SCC/Quandrix%20Student.webp#right)

- **Skill Proficiencies.** [Arcana](/rules/skills.md#Arcana), [Nature](/rules/skills.md#Nature)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** One of your choice  
- **Equipment.** A [bottle of black ink](/items/ink-xphb.md), an [ink pen](/items/ink-pen-xphb.md), an [abacus](/items/abacus.md), a book of arcane theory, a school uniform, and a [pouch](/items/pouch-xphb.md) containing 15 gp  
...
You gain the [Strixhaven Initiate](/feats/strixhaven-initiate-scc.md) feat and must choose Quandrix within it.
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [Entangle](/spells/entangle-xphb.md), [Guiding Bolt](/spells/guiding-bolt-xphb.md) |
| 2nd | [Enlarge/Reduce](/spells/enlarge-reduce-xphb.md), [Vortex Warp](/spells/vortex-warp-scc.md) |
| 3rd | [Aura of Vitality](/spells/aura-of-vitality-xphb.md), [Haste](/spells/haste-xphb.md) |
| 4th | [Control Water](/spells/control-water-xphb.md), [Freedom of Movement](/spells/freedom-of-movement-xphb.md) |
| 5th | [Circle of Power](/spells/circle-of-power-xphb.md), [Passwall](/spells/passwall-xphb.md) |
^quandrix-spells
...
When you make your character, you may roll once on the [Quandrix Trinkets](/items/quandrix-trinket-scc.md) table, instead of on the [Trinkets table](/items/trinket-xphb.md) in the "Player's Handbook", for your starting trinket.