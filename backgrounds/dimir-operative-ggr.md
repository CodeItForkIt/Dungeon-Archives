...
- **Tool Proficiencies.** [Disguise kit](/items/disguise-kit-xphb.md)  
- **Languages.** One of your choice  
- **Equipment.** A Dimir insignia, three small knives, a set of dark-colored [common clothes](/items/common-clothes.md), and the starting equipment of the background described in this chapter for your secondary guild  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](/spells/encode-thoughts-ggr.md), [mage hand](/spells/mage-hand-xphb.md) |
| 1st | [disguise self](/spells/disguise-self-xphb.md), [sleep](/spells/sleep-xphb.md) |
| 2nd | [detect thoughts](/spells/detect-thoughts-xphb.md), [pass without trace](/spells/pass-without-trace-xphb.md) |
| 3rd | [gaseous form](/spells/gaseous-form-xphb.md), [meld into stone](/spells/meld-into-stone-xphb.md), [nondetection](/spells/nondetection-xphb.md) |
| 4th | [arcane eye](/spells/arcane-eye-xphb.md), [freedom of movement](/spells/freedom-of-movement-xphb.md) |
| 5th | [modify memory](/spells/modify-memory-xphb.md) |
^dimir-guild-spells

Your magic is meant to be subtle and undetectable, but it might pull shadows or clouds of mist around you as you cast your spells. Using the [encode thoughts](/spells/encode-thoughts-ggr.md) cantrip described below, you can turn a creature's thoughts (including your own) into a thought strand that others can potentially read, share, or steal. These thought strands are treated as valuable currency among the Dimir.
