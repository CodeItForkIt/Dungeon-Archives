...
- **Equipment.** A uniform of your company ([traveler's clothes](/items/travelers-clothes-xphb.md) in quality), an insignia of your rank, a gaming set of your choice, and a [pouch](/items/pouch-xphb.md) containing the remainder of your last wages (10 gp).  
...
Use the tables for the [soldier](/backgrounds/soldier-xphb.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a mercenary.
