...
- **Equipment.** Your inheritance, a set of [traveler's clothes](/items/travelers-clothes-xphb.md), the tool you choose for this background's tool proficiency (gaming set or musical instrument), and a [pouch](/items/pouch-xphb.md) containing 15 gp  
...
Use the tables for the [folk hero](/backgrounds/folk-hero.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as an inheritor.
