...
- **Equipment.** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [hammer](/items/hammer.md), a [block and tackle](/items/block-and-tackle-xphb.md), a set of [common clothes](/items/common-clothes.md), and a belt [pouch](/items/pouch-xphb.md) containing 5 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](/spells/produce-flame-xphb.md), [shocking grasp](/spells/shocking-grasp-xphb.md) |
| 1st | [chaos bolt](/spells/chaos-bolt-xge.md), [create or destroy water](/spells/create-or-destroy-water-xphb.md), [unseen servant](/spells/unseen-servant-xphb.md) |
| 2nd | [heat metal](/spells/heat-metal-xphb.md), [rope trick](/spells/rope-trick-xphb.md) |
| 3rd | [call lightning](/spells/call-lightning-xphb.md), [elemental weapon](/spells/elemental-weapon-xphb.md), [glyph of warding](/spells/glyph-of-warding-xphb.md) |
| 4th | [conjure minor elementals](/spells/conjure-minor-elementals-xphb.md), [divination](/spells/divination-xphb.md), [Otiluke's resilient sphere](/spells/otilukes-resilient-sphere-xphb.md) |
| 5th | [animate objects](/spells/animate-objects-xphb.md), [conjure elemental](/spells/conjure-elemental-xphb.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](/spells/rope-trick-xphb.md) spell, the portal might be outlined by harmless, showy sparkles.

If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [mizzium apparatus](/items/mizzium-apparatus-ggr.md) described in "chapter 5" is a magical version of this gear.

The [chaos bolt](/spells/chaos-bolt-xge.md) spell is a favorite of Izzet spellcasters because of its unpredictable nature.
