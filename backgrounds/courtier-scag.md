...
- **Equipment.** A set of [fine clothes](/items/fine-clothes-xphb.md) and a [pouch](/items/pouch-xphb.md) containing 5 gp  
...
Use the tables for the [guild artisan](/backgrounds/guild-artisan.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a courtier.
