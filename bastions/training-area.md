...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](/rules/variant-rules/unarmed-strike-xphb.md) or a weapon, you can take a [Reaction](/rules/variant-rules/reaction-xphb.md) to reduce this damage by `1d4`. |
...
| Unarmed Combat Expert | When you hit with your [Unarmed Strike](/rules/variant-rules/unarmed-strike-xphb.md) and deal damage, the attack deals an extra `1d4` Bludgeoning damage. |
| Weapon Expert | Choose a kind of Simple or Martial weapon, such as [Spear](/items/spear-xphb.md) or [Longbow](/items/longbow-xphb.md). If you aren't proficient with the weapon, you gain proficiency with it. If you already have proficiency with the weapon, you can use its mastery property. |
^expert-trainers
