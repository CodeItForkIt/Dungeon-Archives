...
![A Docent](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/adventure/VEoR/070-04-004.docent.webp#right)
...
**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `d6`): (1–2) [detect evil and good](/spells/detect-evil-and-good-xphb.md) or (3–6) [detect magic](/spells/detect-magic-xphb.md). The docent decides when to cast the spell.
