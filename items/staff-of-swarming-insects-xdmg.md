...
While holding the staff , you can take a [Magic](/rules/actions.md#Magic) action and expend 1 charge to cause a swarm of harmless flying insects to fill a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from you. The insects remain for 10 minutes, making the area [Heavily Obscured](/rules/variant-rules/heavily-obscured-xphb.md) for creatures other than you. A strong wind (like that created by [Gust of Wind](/spells/gust-of-wind-xphb.md)) disperses the swarm and ends the effect.
...
| Spell | Charge Cost |
|-------|-------------|
| [Giant Insect](/spells/giant-insect-xphb.md) | 4 |
| [Insect Plague](/spells/insect-plague-xphb.md) | 5 |
^spell-charge-cost
