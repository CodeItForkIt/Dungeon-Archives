...
---
# Stonemaker War Pick
*Weapon ([war pick](/items/war-pick-xphb.md)), very rare (requires attunement)*  
...
- **Meld into Stone.** You can cast the [Meld into Stone](/spells/meld-into-stone-xphb.md) spell from this war pick. Once this property is used, it can't be used again until the next dawn.  
