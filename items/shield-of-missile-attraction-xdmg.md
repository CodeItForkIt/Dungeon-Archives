...
---
# Shield of Missile Attraction
*Armor ([shield](/items/shield-xphb.md)), cursed item, rare (requires attunement)*  
...
This Shield is cursed. Attuning to it curses you until you are targeted by a [Remove Curse](/spells/remove-curse-xphb.md) spell or similar magic. Removing the Shield fails to end the curse on you. Whenever an attack with a Ranged weapon targets a creature within 10 feet of you, the curse causes you to become the target instead.
