...
A creature wearing a survival mantle can breathe normally in any environment (including a vacuum) and has advantage on saving throws against harmful gases (such as those created by a [cloudkill](/spells/cloudkill-xphb.md) spell, a [stinking cloud](/spells/stinking-cloud-xphb.md) spell, inhaled poisons, and the breath weapons of some dragons).
