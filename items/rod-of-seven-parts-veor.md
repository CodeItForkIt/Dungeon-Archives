...
---
# Rod of Seven Parts
*Weapon ([quarterstaff](/items/quarterstaff-xphb.md)), rod, artifact (requires attunement)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/VEoR/Rod%20of%20Seven%20Parts.webp#right)
...
Eons ago, a war between the primordials and the gods scarred the planes of existence. A demon lord named [Miska the Wolf-Spider](/bestiary/npc/miska-the-wolf-spider-veor.md) eventually pushed the primordials' enemies to the brink of annihilation.
...
| Piece | Spell |
|-------|-------|
| First | [Commune](/spells/commune-xphb.md) |
| Second | [Arcane Gate](/spells/arcane-gate-xphb.md) |
| Third | [Reverse Gravity](/spells/reverse-gravity-xphb.md) (spell save DC 18) |
| Fourth | [Regenerate](/spells/regenerate-xphb.md) |
| Fifth | [Find the Path](/spells/find-the-path-xphb.md) |
| Sixth | [Mirage Arcane](/spells/mirage-arcane-xphb.md) |
| Seventh | [Simulacrum](/spells/simulacrum-xphb.md) |
^rod-pieces
...
The Rod of Seven Parts has 7 charges and regains `1d4 + 3` expended charges daily at dawn. While holding the rod, you can use an action to expend 1 charge and cast any of the spells in the Rod Pieces table. You can also use an action to cast [Detect Evil and Good](/spells/detect-evil-and-good-xphb.md) from the rod without using any charges.
...
![A piece of the Rod of Seven Parts](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/VEoR/Rod%20of%20Seven%20Parts%20Piece.webp#center)
