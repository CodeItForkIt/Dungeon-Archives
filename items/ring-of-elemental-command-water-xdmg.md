...
The ring has 5 charges and regains `1d4 + 1` expended charges daily at dawn. While wearing the ring, you can cast a spell from it. A spell cast from the ring has a save DC of 18. Choose the spell from the following list: [Create or Destroy Water](/spells/create-or-destroy-water-xphb.md) (1 charge), [Ice Storm](/spells/ice-storm-xphb.md) (2 charges), [Tsunami](/spells/tsunami-xphb.md) (5 charges), [Wall of Ice](/spells/wall-of-ice-xphb.md) (3 charges), [Water Walk](/spells/water-walk-xphb.md) (2 charges)
