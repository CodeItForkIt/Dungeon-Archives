...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/EGW/Infiltrator%27s%20Key.webp#right)
...
- The key can be used as [thieves' tools](/items/thieves-tools-xphb.md) for the purpose of opening locks. When using the key, you are considered proficient in [thieves' tools](/items/thieves-tools-xphb.md) and you have advantage on ability checks made to open locks.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [alter self](/spells/alter-self-xphb.md), [invisibility](/spells/invisibility-xphb.md), [knock](/spells/knock-xphb.md), or [pass without trace](/spells/pass-without-trace-xphb.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [dimension door](/spells/dimension-door-xphb.md), [gaseous form](/spells/gaseous-form-xphb.md), or [mislead](/spells/mislead-xphb.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
