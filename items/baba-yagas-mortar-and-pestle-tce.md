...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/TCE/Baba%20Yaga%27s%20Mortar%20and%20Pestle.webp#right)
...
You can also use the artifact as [alchemist's supplies](/items/alchemists-supplies-xphb.md), [brewer's supplies](/items/brewers-supplies-xphb.md), [cook's utensils](/items/cooks-utensils-xphb.md), an [herbalism kit](/items/herbalism-kit-xphb.md), and a [poisoner's kit](/items/poisoners-kit-xphb.md). You have advantage on any check you make using the artifact as one of these tools.
