...
---
# Nightbringer
*Weapon ([mace](/items/mace-xphb.md)), legendary (requires attunement)*  
...
You are immune to the [charmed](/rules/conditions.md#Charmed) and [frightened](/rules/conditions.md#Frightened) conditions, and you gain immunity to one of the following damage types (choose when you attune to the weapon): acid, cold, fire, lightning, or poison.
