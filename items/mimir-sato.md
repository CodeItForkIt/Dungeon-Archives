...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/SatO/Mimir.webp#right)
...
While the device is floating, you can use an action to cast [legend lore](/spells/legend-lore-xphb.md) from the device. The device speaks the revealed lore aloud. Once this property has been used, it can't be used again until the next dawn.
