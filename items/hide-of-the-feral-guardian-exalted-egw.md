...
---
# Hide of the Feral Guardian (Exalted)
*Light armor ([studded leather armor](/items/studded-leather-armor-xphb.md)), legendary (requires attunement)*  
...
- As an action, you can use the armor to cast [polymorph](/spells/polymorph-xphb.md) on yourself, transforming into a [giant owl](/bestiary/celestial/giant-owl-xmm.md) while retaining your Intelligence, Wisdom, and Charisma scores. This property can't be used again until the next dawn.  
...
- When you cast the [polymorph](/spells/polymorph-xphb.md) spell using this armor, you can transform into a [cave bear](/bestiary/beast/polar-bear-xmm.md).  
...
- When you cast the [polymorph](/spells/polymorph-xphb.md) spell using this armor, you can transform into a [guardian wolf](/bestiary/monstrosity/guardian-wolf-egw.md).  
