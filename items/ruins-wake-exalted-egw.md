...
---
# Ruin's Wake (Exalted)
*Weapon ([spear](/items/spear-xphb.md)), artifact (requires attunement)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/EGW/Ruin%27s%20Wake.webp#right)
...
A slaughter-loving [balor](/bestiary/fiend/balor-xmm.md) named Yarrowish lives within Ruin's Wake. The weapon desires only to draw blood and pushes its wielder to solve problems with violence.
