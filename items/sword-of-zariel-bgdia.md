...
---
# Sword of Zariel
*Weapon ([longsword](/items/longsword-xphb.md)), artifact (requires attunement by a creature the sword deems worthy)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/BGDIA/Sword%20of%20Zariel.webp#right)
...
The sword deals an extra 9 (`2d8`) radiant damage to any creature it hits, or 16 (`3d10`) radiant damage if you're wielding the weapon with two hands. An evil creature that takes this radiant damage must succeed on a DC 17 Constitution saving throw or be [blinded](/rules/conditions.md#Blinded) until the end of its next turn.
