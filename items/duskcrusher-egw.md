...
---
# Duskcrusher
*Weapon ([warhammer](/items/warhammer-xphb.md)), very rare (requires attunement)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/EGW/Duskcrusher.webp#right)
...
While you are holding Duskcrusher and its radiant head is active, you can use an action to cast the [sunbeam](/spells/sunbeam-xphb.md) spell (save DC 15) from the weapon, and this action can't be used again until the next dawn.
