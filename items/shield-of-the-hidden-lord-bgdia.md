...
---
# Shield of the Hidden Lord
*Armor ([shield](/items/shield-xphb.md)), legendary (requires attunement)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/BGDIA/Shield%20of%20the%20Hidden%20Lord.webp#right)
...
- The shield has 3 charges. You can use an action to expend 1 charge to cast [fireball](/spells/fireball-xphb.md) or 2 charges to cast [wall of fire](/spells/wall-of-fire-xphb.md) from the shield (save DC 21 for each). The [wall of fire](/spells/wall-of-fire-xphb.md) spell lasts for 1 minute (no [concentration](/rules/conditions.md#Concentration) required). The shield regains all expended charges daily at dawn.  
