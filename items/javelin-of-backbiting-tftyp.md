...
---
# Javelin of Backbiting
*Weapon ([javelin](/items/javelin-xphb.md)), cursed item, very rare (requires attunement)*  
...
This weapon is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with [remove curse](/spells/remove-curse-xphb.md) or similar magic, you are unwilling to part with the weapon, keeping it within reach at all times. In addition, you have disadvantage on attack rolls made with weapons other than this one.
