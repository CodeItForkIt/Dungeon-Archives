...
---
# Needle of Mending
*Weapon ([dagger](/items/dagger-xphb.md)), rare (requires attunement)*  
...
You gain a +1 bonus to attack and damage rolls made with the dagger. While holding it, you can use an action to cast the [mending](/spells/mending-xphb.md) cantrip from it.
