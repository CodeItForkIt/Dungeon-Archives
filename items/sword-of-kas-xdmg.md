...
You gain a +3 bonus to attack rolls and damage rolls made with the sword, which scores a [Critical Hit](/rules/variant-rules/critical-hit-xphb.md) on a roll of 19 or 20 on the `d20` and deals an extra `2d10` Slashing damage to Undead.
...
- [Call Lightning](/spells/call-lightning-xphb.md)  
- [Divine Word](/spells/divine-word-xphb.md)  
- [Finger of Death](/spells/finger-of-death-xphb.md)  
...
- **Battle Hunger.** You add `1d10` to your [Initiative](/rules/variant-rules/initiative-xphb.md) rolls.  
...
The Sword of Kas also seeks to destroy anyone corrupted by the [Eye and Hand of Vecna](/items/eye-and-hand-of-vecna-xdmg.md).

## Destroying the Sword

A creature attuned to both the [Eye of Vecna](/items/eye-of-vecna-xdmg.md) and the [Hand of Vecna](/items/hand-of-vecna-xdmg.md) can use the [Wish](/spells/wish-xphb.md) property of those combined Artifacts to unmake the Sword of Kas, provided the sword is within 30 feet of the spell's caster. Upon casting Wish, the creature makes a DC 18 Charisma saving throw. On a failed save, nothing happens, and the [Wish](/spells/wish-xphb.md) spell is wasted. On a successful save, the Sword of Kas is destroyed.
