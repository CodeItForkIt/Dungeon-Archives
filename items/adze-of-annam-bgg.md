...
---
# Adze of Annam
*Weapon ([greataxe](/items/greataxe-xphb.md)), artifact (requires attunement)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/BGG/Adze%20of%20Annam.webp#right)
...
As an action, you can call upon the might of the All-Father and use the adze to cast [move earth](/spells/move-earth-xphb.md) or [fabricate](/spells/fabricate-xphb.md). Once this property is used, it can't be used again until the next dawn.
