...
While wearing the cloak in an area of [Dim Light](/rules/variant-rules/dim-light-xphb.md) or [Darkness](/rules/variant-rules/darkness-xphb.md), you can cast [Polymorph](/spells/polymorph-xphb.md) on yourself, shape-shifting into a [Bat](/bestiary/beast/bat-xmm.md). While in that form, you retain your Intelligence, Wisdom, and Charisma scores. The cloak can't be used this way again until the next dawn.
