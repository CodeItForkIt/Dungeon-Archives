...
While holding the rod, you have [Advantage](/rules/variant-rules/advantage-xphb.md) on Wisdom ([Perception](/rules/skills.md#Perception)) checks and on [Initiative](/rules/variant-rules/initiative-xphb.md) rolls.

## Spells

While holding the rod, you can cast the following spells from it:

- [Detect Evil and Good](/spells/detect-evil-and-good-xphb.md)  
- [Detect Magic](/spells/detect-magic-xphb.md)  
- [Detect Poison and Disease](/spells/detect-poison-and-disease-xphb.md)  
