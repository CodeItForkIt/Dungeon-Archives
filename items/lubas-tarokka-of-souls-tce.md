...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/TCE/Luba%27s%20Tarokka%20of%20Souls.webp#right)
...
While holding the deck, you can use an action to cast one of the following spells (save DC 18) from it: [comprehend languages](/spells/comprehend-languages-xphb.md), [detect evil and good](/spells/detect-evil-and-good-xphb.md), [detect magic](/spells/detect-magic-xphb.md), [detect poison and disease](/spells/detect-poison-and-disease-xphb.md), [locate object](/spells/locate-object-xphb.md), or [scrying](/spells/scrying-xphb.md). Once you use the deck to cast a spell, you can't cast that spell again from it until the next dawn.
...
| dice: d100 | Card | Soul |
|------------|------|------|
| 1 | Artifact | [Flameskull](/bestiary/undead/flameskull-xmm.md) |
| 2 | Beast | [Wraith](/bestiary/undead/wraith-xmm.md) |
| 3 | Broken | [Banshee](/bestiary/undead/banshee-xmm.md) |
| 4 | Darklord | [Vampire](/bestiary/undead/vampire-xmm.md) |
| 5 | Donjon | [Mummy](/bestiary/undead/mummy-xmm.md) |
| 6 | Executioner | [Death knight](/bestiary/undead/death-knight-xmm.md) |
| 7 | Ghost | [Ghost](/bestiary/undead/ghost-xmm.md) |
| 8 | Horseman | [Mummy lord](/bestiary/undead/mummy-lord-xmm.md) |
| 9 | Innocent | [Ghost](/bestiary/undead/ghost-xmm.md) |
| 10 | Marionette | [Mummy](/bestiary/undead/mummy-xmm.md) |
| 11 | Mists | [Wraith](/bestiary/undead/wraith-xmm.md) |
| 12 | Raven | [Vampire spawn](/bestiary/undead/vampire-spawn-xmm.md) |
| 13 | Seer | [Vampire](/bestiary/undead/vampire-xmm.md) |
| 14 | Tempter | [Vampire spawn](/bestiary/undead/vampire-spawn-xmm.md) |
| 15-100 | — | — |
^souls-of-the-tarokka
...
Luba's Tarokka of Souls can be destroyed only if all fourteen souls within are released and destroyed. This reveals a fifteenth soul, a [lich](/bestiary/undead/lich-xmm.md), that inhabits the Nether card, which appears only when the fourteen souls are defeated. If this ancient entity is destroyed, the Nether card vanishes and the deck becomes a normal tarokka deck, with no special properties, but it includes a new card of the DM's design.
