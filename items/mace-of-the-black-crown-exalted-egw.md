...
---
# Mace of the Black Crown (Exalted)
*Weapon ([mace](/items/mace-xphb.md)), artifact (requires attunement)*  
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/items/EGW/Mace%20of%20the%20Black%20Crown.webp#right)
...
- While holding the mace, you can use an action to summon an [imp](/bestiary/fiend/imp-xmm.md). Any devil you summon with this mace is friendly to you and your companions for the duration. The imp obeys any verbal commands that you issue to it and returns to the Nine Hells 10 minutes after you summoned it. This property can't be used again until the next dawn.  

> [!note] Betrayer Artifact Properties
> 
> The Arms of the Betrayers advance in power in the same manner as the Vestiges of Divergence. In its dormant state, each of these artifacts has one [minor beneficial](artifact-properties-minor-beneficial-properties-xdmg.md) property and one [minor detrimental](artifact-properties-minor-detrimental-properties-xdmg.md) property. When the artifact attains an awakened state, it gains an additional [minor beneficial](artifact-properties-minor-beneficial-properties-xdmg.md) property and an additional [minor detrimental](artifact-properties-minor-detrimental-properties-xdmg.md) property. When the item reaches its exalted state, it gains a [major beneficial](artifact-properties-major-beneficial-properties-xdmg.md) property. See "Artifact Properties" in chapter 7 of the Dungeon Master's Guide for more information.
...
- The weapon's Summon Devil feature can also be used to summon a [bearded devil](/bestiary/fiend/bearded-devil-xmm.md).  
...
- The weapon's Summon Devil feature can also be used to summon a [barbed devil](/bestiary/fiend/barbed-devil-xmm.md).  
