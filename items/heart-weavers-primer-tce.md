...
This pristine book smells faintly of a random scent you find pleasing. When found, the book contains the following spells: [antipathy/sympathy](/spells/antipathy-sympathy-xphb.md), [charm person](/spells/charm-person-xphb.md), [dominate person](/spells/dominate-person-xphb.md), [enthrall](/spells/enthrall-xphb.md), [hypnotic pattern](/spells/hypnotic-pattern-xphb.md), [modify memory](/spells/modify-memory-xphb.md), and [suggestion](/spells/suggestion-xphb.md). It functions as a spellbook for you.
