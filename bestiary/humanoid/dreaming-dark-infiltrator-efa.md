...
---
# [Dreaming Dark Infiltrator](/bestiary/humanoid/dreaming-dark-infiltrator-efa.md)
...
"gear":
  - "[chain shirt](/items/chain-shirt-xphb.md)"
...
"actions":
  ...
  - "desc": "The infiltrator casts one of the following spells, requiring no Material\
      ...
      \ DC 15):\n\n**3/day:** [Detect Thoughts](/spells/detect-thoughts-xphb.md)\n\
      \n**1/day:** [Synaptic Static](/spells/synaptic-static-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature hit by the infiltrator's Mind\
      ...
      \ and is cursed. While cursed in this way, it has [Disadvantage](/rules/variant-rules/disadvantage-xphb.md)\
      ...
      \ A cursed creature repeats the save whenever it finishes a [Short](/rules/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](/rules/variant-rules/long-rest-xphb.md), ending the effect\
      \ on itself on a success. *Success:* Half damage only."
    "name": "Mind Curse"
"source":
  - "EFA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EFA/Dreaming%20Dark%20Infiltrator.webp"
```
^statblock