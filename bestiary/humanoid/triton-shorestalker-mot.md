...
- "Triton Shorestalker"
---
# [Triton Shorestalker](/bestiary/humanoid/triton-shorestalker-mot.md)
...
"traits":
  ...
  - "desc": "The triton can breathe air and water."
    "name": "Amphibious"
  - "desc": "The triton can take the [Disengage](/rules/actions.md#Disengage) or [Hide](/rules/actions.md#Hide)\
      \ actions as a bonus action on each of its turns."
    "name": "Nimble Escape"
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 6\
      ...
      \ a creature to 0 hit points, that creature is stable but [poisoned](/rules/conditions.md#Poisoned)\
