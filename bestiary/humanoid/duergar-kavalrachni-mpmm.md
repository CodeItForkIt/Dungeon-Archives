...
- "Duergar Kavalrachni"
---
# [Duergar Kavalrachni](/bestiary/humanoid/duergar-kavalrachni-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 107, Mordenkainen's Tome of Foes p. 189*  

Kavalrachni are duergar cavalry trained to fight while riding [female steeders](/bestiary/monstrosity/female-steeder-mpmm.md) (in this book) or other Underdark creatures as mounts.
...
"ac": !!int "16"
"ac_class": "[scale mail](/items/scale-mail-xphb.md), [shield](/items/shield-xphb.md)"
"hp": !!int "26"
"hit_dice": "4d8 + 8"
"modifier": !!int "0"
"stats":
...
"actions":
  ...
  - "desc": "The duergar magically turns [invisible](/rules/conditions.md#Invisible)\
      ...
      \ with it. While the [invisible](/rules/conditions.md#Invisible) duergar is\
      \ mounted, the mount is [invisible](/rules/conditions.md#Invisible) as well.\
