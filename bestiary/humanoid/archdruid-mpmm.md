...
- "Archdruid"
---
# [Archdruid](/bestiary/humanoid/archdruid-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 48, Volo's Guide to Monsters p. 210*  

Archdruids watch over the natural wonders of their domains. They seldom interact with folk away from their druid groves and shrines, unless there is a great threat to the natural order or to a nearby community. An archdruid typically has one or more pupils who are [druids](/bestiary/humanoid/druid-xmm.md), and the archdruid's lair is usually guarded by loyal Beasts and Fey creatures.
...
|----------|---------------|
| 1 | [Air elemental](/bestiary/elemental/air-elemental-xmm.md) |
| 2 | [Earth elemental](/bestiary/elemental/earth-elemental-xmm.md) |
| 3 | [Fire elemental](/bestiary/elemental/fire-elemental-xmm.md) |
| 4 | [Giant crocodile](/bestiary/beast/giant-crocodile-xmm.md) |
| 5 | [Mammoth](/bestiary/beast/mammoth-xmm.md) |
| 6 | [Flail snail](/bestiary/elemental/flail-snail-mpmm.md) |
| 7 | [Triceratops](/bestiary/beast/triceratops-xmm.md) |
| 8 | [Water elemental](/bestiary/elemental/water-elemental-xmm.md) |
^archdruid-favored-shapes
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +9 to hit, range 120 ft., one target. *Hit:*\
      \ 26 (6d6 + 5) fire damage, and the target is [blinded](/rules/conditions.md#Blinded)\
      \ until the start of the druid's next turn."
    "name": "Wildfire"
  - "desc": "The archdruid casts one of the following spells, using Wisdom as the\
      \ spellcasting ability (spell save DC 17):\n\n**At will:** [beast sense](/spells/beast-sense-xphb.md),\
      \ [entangle](/spells/entangle-xphb.md), [speak with animals](/spells/speak-with-animals-xphb.md)\n\
      \n**3/day each:** [animal messenger](/spells/animal-messenger-xphb.md), [dominate\
      \ beast](/spells/dominate-beast-xphb.md), [faerie fire](/spells/faerie-fire-xphb.md),\
      \ [tree stride](/spells/tree-stride-xphb.md)\n\n**1/day each:** [commune with\
      \ nature](/spells/commune-with-nature-xphb.md) (as an action), [mass cure wounds](/spells/mass-cure-wounds-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
