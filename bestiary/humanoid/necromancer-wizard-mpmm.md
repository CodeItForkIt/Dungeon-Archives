...
- "Necromancer Wizard"
---
# [Necromancer Wizard](/bestiary/humanoid/necromancer-wizard-mpmm.md)
...
"actions":
  ...
  - "desc": "The necromancer casts one of the following spells, using Intelligence\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The necromancer magically summons five [skeletons](/bestiary/undead/skeleton-xmm.md)\
      ...
      \ take their turns immediately after the necromancer. Each lasts for 1 hour,\
      \ until it or the necromancer dies, or until the necromancer dismisses it as\
      \ a bonus action."
