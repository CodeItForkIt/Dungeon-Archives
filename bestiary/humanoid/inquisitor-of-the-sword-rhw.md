...
---
# [Inquisitor of the Sword](/bestiary/humanoid/inquisitor-of-the-sword-rhw.md)
*Source: RHW p. 273*  
...
"traits":
  - "desc": "At the start of each of its turns, if the inquisitor has at least 1 [Hit\
      \ Point](/rules/variant-rules/hit-points-xphb.md), it regains 10 [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      \ and can end one condition on itself."
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Slashing\
      \ damage plus 4 (1d8) Psychic damage. Critical *Hit:* If the target is a shape-shifted\
      \ creature, it takes an additional 4 (1d8) Slashing damage. *Hit or Miss:*\
      \ The inquisitor can teleport up to 60 feet to an unoccupied space it can see."
  ...
  - "desc": "The inquisitor casts one of the following spells, requiring no spell\
      ...
      \ [Dimension Door](/spells/dimension-door-xphb.md), [Fly](/spells/fly-xphb.md),\
