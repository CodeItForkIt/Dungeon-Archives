...
---
# [Harmonium Peacekeeper](/bestiary/humanoid/harmonium-peacekeeper-mpp.md)
...
"traits":
  - "desc": "The peacekeeper has advantage on an attack roll against a creature if\
      ...
      \ and the ally doesn't have the [incapacitated](/rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Pack Tactics"
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 10 ft., one target. *Hit:*\
      \ 8 (1d10 + 3) piercing damage plus 4 (1d8) lightning damage. If the target\
      \ is a Large or smaller creature, it has the [grappled](/rules/conditions.md#Grappled)\
      \ condition (escape DC 13). Until the [grappled](/rules/conditions.md#Grappled)\
      \ condition ends, the target has the [restrained](/rules/conditions.md#Restrained)\
