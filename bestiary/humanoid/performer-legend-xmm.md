...
- "Performer Legend"
---
# [Performer Legend](/bestiary/humanoid/performer-legend-xmm.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, each creature in a 20-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ and the target has the [Charmed](/rules/conditions.md#Charmed) or [Frightened](/rules/conditions.md#Frightened)\
  ...
  - "desc": "The performer casts one of the following spells, requiring no Material\
      ...
      \ Image](/spells/major-image-xphb.md), [Project Image](/spells/project-image-xphb.md)"
    "name": "Spellcasting"
"reactions":
