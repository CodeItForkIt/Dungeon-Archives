...
---
# [Ghallanda Troubleshooter](/bestiary/humanoid/ghallanda-troubleshooter-efa.md)
...
"gear":
  - "six [daggers](/items/dagger-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +5, reach 5 ft. or range 20/60 ft.\
      \ *Hit:* 5 (1d4 + 3) Piercing damage, and the target has the [Poisoned](/rules/conditions.md#Poisoned)\
  ...
  - "desc": "The troubleshooter casts one of the following spells, requiring no Material\
      ...
      \n**1/day each:** [Sleep](/spells/sleep-xphb.md), [Unseen Servant](/spells/unseen-servant-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The troubleshooter takes the [Disengage](/rules/actions.md#Disengage)\
      \ or [Hide](/rules/actions.md#Hide) action."
    "name": "Nimble Escape"
"source":
  - "EFA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EFA/Ghallanda%20Troubleshooter.webp"
```
^statblock