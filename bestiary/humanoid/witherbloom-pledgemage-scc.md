...
---
# [Witherbloom Pledgemage](/bestiary/humanoid/witherbloom-pledgemage-scc.md)
...
"actions":
  ...
  - "desc": "The apprentice casts one of the following spells, requiring no material\
      ...
      \ ward](/spells/death-ward-xphb.md), [pass without trace](/spells/pass-without-trace-xphb.md),\
...
"reactions":
  - "desc": "When the pledgemage sees a creature within 30 feet of itself drop to\
      ...
      \ on a DC 13 Constitution saving throw or become [poisoned](/rules/conditions.md#Poisoned)\
      \ for 1 minute. While [poisoned](/rules/conditions.md#Poisoned) in this way,\
      \ the target takes 3 (1d6) poison damage at the start of each of its turns.\
      \ The target can repeat the save at the end of each of its turns, ending the\
