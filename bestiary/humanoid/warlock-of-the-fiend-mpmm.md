...
---
# [Warlock of the Fiend](/bestiary/humanoid/warlock-of-the-fiend-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 255, Volo's Guide to Monsters p. 219*  

Warlocks of the Fiend gain their powers through magical pacts forged with archfiends of the Lower Planes. These warlocks often keep [imps](/bestiary/fiend/imp-xmm.md) or [quasits](/bestiary/fiend/quasit-xmm.md) as companions, and they tend toward philosophical extremes: consorting with fiendish cults or dedicating their lives to destroying such cults.
...
"actions":
  ...
  - "desc": "The warlock casts one of the following spells, using Charisma as the\
      ...
      \n**1/day each:** [banishment](/spells/banishment-xphb.md), [plane shift](/spells/plane-shift-xphb.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Warlock%20of%20the%20Fiend.webp"
```
^statblock
