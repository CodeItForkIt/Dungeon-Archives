...
Any temple of [Lolth](/deities/drow-lolth-mtf.md) also functions as a matron mother's lair while she is inside it, unless she has renounced Lolth or another matron mother is present. When two or more matron mothers gather within a temple of their goddess, none of them can use it as their lair.
...
"traits":
  - "desc": "The drow has advantage on saving throws against being [charmed](/rules/conditions.md#Charmed),\
    ...
    "name": "Fey Ancestry"
  - "desc": "The drow wields a [tentacle rod](/items/tentacle-rod-xdmg.md)."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:*\
      ...
      \ a DC 19 Wisdom saving throw or become [frightened](/rules/conditions.md#Frightened)\
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 15 ft., one creature. *Hit:*\
      \ 3 (1d6) bludgeoning damage. If the target is hit three times by the [rod](/items/tentacle-rod-xdmg.md)\
  ...
  - "desc": "The drow casts one of the following spells, requiring no material components\
      ...
      \ will:** [command](/spells/command-xphb.md), [dancing lights](/spells/dancing-lights-xphb.md),\
      \ [detect magic](/spells/detect-magic-xphb.md), [thaumaturgy](/spells/thaumaturgy-xphb.md)\n\
      \n**2/day each:** [banishment](/spells/banishment-xphb.md), [blade barrier](/spells/blade-barrier-xphb.md),\
      \ [cure wounds](/spells/cure-wounds-xphb.md), [hold person](/spells/hold-person-xphb.md),\
      \ [plane shift](/spells/plane-shift-xphb.md), [silence](/spells/silence-xphb.md)\n\
      ...
      \ [faerie fire](/spells/faerie-fire-xphb.md), [gate](/spells/gate-xphb.md),\
      \ [levitate](/spells/levitate-xphb.md) (self only), [suggestion](/spells/suggestion-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  ...
  - "desc": "The drow magically summons a [glabrezu](/bestiary/fiend/glabrezu-xmm.md)\
      \ or a [yochlol](/bestiary/fiend/yochlol-xmm.md). The summoned creature appears\
      \ in an unoccupied space within 60 feet of its summoner, acts as an ally of\
      \ its summoner, and can't summon other demons. It remains for 10 minutes, until\
