...
---
# [Lorehold Professor of Order](/bestiary/humanoid/lorehold-professor-of-order-scc.md)
...
"actions":
  ...
  - "desc": "*Melee Spell Attack:* +7 to hit, reach 30 ft., one target. *Hit:* 13\
      ...
      \ away from the professor and become [restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The professor casts one of the following spells, requiring no material\
      ...
      \ DC 15):\n\n**At will:** [comprehend languages](/spells/comprehend-languages-xphb.md),\
      \ [guidance](/spells/guidance-xphb.md), [light](/spells/light-xphb.md)\n\n**2/day\
      \ each:** [dimension door](/spells/dimension-door-xphb.md), [locate object](/spells/locate-object-xphb.md),\
...
"source":
  - "SCC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SCC/Lorehold%20Professor%20of%20Order.webp"
```
^statblock