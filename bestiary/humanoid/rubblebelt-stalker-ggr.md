...
- "Rubblebelt Stalker"
---
# [Rubblebelt Stalker](/bestiary/humanoid/rubblebelt-stalker-ggr.md)
...
"traits":
  - "desc": "In the first round of a combat, the stalker has advantage on attack rolls\
    ...
    "name": "Ambusher"
  - "desc": "The stalker can take the [Disengage](/rules/actions.md#Disengage) or\
      \ [Hide](/rules/actions.md#Hide) action as a bonus action on each of its turns."
    "name": "Nimble Escape"
