...
---
# [Astral Elf Aristocrat](/bestiary/humanoid/astral-elf-aristocrat-bam.md)
...
"ac": !!int "16"
"ac_class": "[elven chain](/items/elven-chain-xdmg.md)"
"hp": !!int "103"
"hit_dice": "23d8"
"modifier": !!int "2"
"stats":
...
"traits":
  - "desc": "The elf has advantage on saving throws it makes to avoid or end the [charmed](/rules/conditions.md#Charmed)\
    ...
    "name": "Fey Ancestry"
  - "desc": "The elf wears a suit of [elven chain](/items/elven-chain-xdmg.md)."
...
"actions":
  ...
  - "desc": "The elf casts one of the following spells, using Intelligence as the\
      \ spellcasting ability:\n\n**1/day each:** [fly](/spells/fly-xphb.md), [mislead](/spells/mislead-xphb.md),\
...
"bonus_actions":
  ...
  - "desc": "The elf has a 50 percent chance of magically summoning a [young solar\
      \ dragon](/bestiary/dragon/young-solar-dragon-bam.md). A summoned dragon appears\
      \ in an unoccupied space that the summoner can see, acts on its own initiative\
      \ count, and is an ally of its summoner. It remains for 10 minutes, until it\
