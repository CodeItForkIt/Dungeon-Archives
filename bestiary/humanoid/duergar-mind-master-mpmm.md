...
- "Duergar Mind Master"
---
# [Duergar Mind Master](/bestiary/humanoid/duergar-mind-master-mpmm.md)
...
"bonus_actions":
  - "desc": "For 1 minute, the duergar magically decreases in size, along with anything\
      ...
      \ ([Stealth](/rules/skills.md#Stealth)) checks and a +5 bonus to its AC. It\
      \ can also take a bonus action on each of its turns to take the [Hide](/rules/actions.md#Hide)\
      \ action."
    "name": "Reduce (Recharges after a Short or Long Rest)"
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Duergar%20Mind%20Master.webp"
```
^statblock
