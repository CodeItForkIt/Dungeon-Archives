...
- "Orien Enforcer"
---
# [Orien Enforcer](/bestiary/humanoid/orien-enforcer-efa.md)
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 13, each creature in a 20-foot-radius\
      ...
      \ point the enforcer can see within 60 feet. *Failure:* 13 (3d8) Lightning\
...
"bonus_actions":
  - "desc": "The enforcer casts [Misty Step](/spells/misty-step-xphb.md), using Intelligence\
...
"reactions":
  - "desc": "Trigger: The enforcer takes damage from a melee attack. _Response:_ The\
      ...
      \ saving throw, or its [Speed](/rules/variant-rules/speed-xphb.md) is halved\
      \ until the start of the enforcer's next turn."
    "name": "Temporal Disruption (1/Day)"
"source":
  - "EFA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EFA/Orien%20Enforcer.webp"
```
^statblock