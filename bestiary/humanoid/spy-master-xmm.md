...
- "Spy Master"
---
# [Spy Master](/bestiary/humanoid/spy-master-xmm.md)
...
"gear":
  ...
  - "[thieves' tools](/items/thieves-tools-xphb.md)"
...
"actions":
  ...
  - "desc": "The spy throws a bomb to a point it can see within 30 feet of itself.\
      \ *Constitution Saving Throw:* DC 16, each creature in a 20-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ the spy's next turn. *Success:* Half damage only."
    "name": "Smoke Bomb (1/Day)"
"bonus_actions":
  - "desc": "The spy takes the [Dash](/rules/actions.md#Dash), [Disengage](/rules/actions.md#Disengage),\
