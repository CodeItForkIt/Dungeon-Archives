...
- "Bard"
---
# [Bard](/bestiary/humanoid/bard-mpmm.md)
...
"actions":
  ...
  - "desc": "The bard casts one of the following spells, using Charisma as the spellcasting\
      ...
      \n**1/day each:** [charm person](/spells/charm-person-xphb.md), [invisibility](/spells/invisibility-xphb.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Bard.webp"
```
^statblock
