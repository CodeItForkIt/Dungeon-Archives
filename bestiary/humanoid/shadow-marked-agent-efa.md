...
- "Shadow-Marked Agent"
---
# [Shadow-Marked Agent](/bestiary/humanoid/shadow-marked-agent-efa.md)
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +8, reach 5 ft. or range 20/60 ft.\
      ...
      \ the target's [Speed](/rules/variant-rules/speed-xphb.md) is reduced by 10\
  ...
  - "desc": "The agent casts one of the following spells, requiring no Material components\
      ...
      \ Self](/spells/disguise-self-xphb.md), [Minor Illusion](/spells/minor-illusion-xphb.md)\n\
      \n**1/day:** [Pass without Trace](/spells/pass-without-trace-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The agent has the [Invisible](/rules/conditions.md#Invisible) condition\
      \ until the start of its next turn. This invisibility ends early immediately\
      \ after the agent makes an attack roll."
    "name": "Shadow Cloak"
"source":
  - "EFA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EFA/Shadow-Marked%20Agent.webp"
```
^statblock