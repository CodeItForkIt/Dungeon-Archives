...
---
# [Astral Elf Star Priest](/bestiary/humanoid/astral-elf-star-priest-bam.md)
...
"actions":
  ...
  - "desc": "The elf casts one of the following spells, using Wisdom as the spellcasting\
      \ ability (spell save DC 16):\n\n**2/day each:** [cure wounds](/spells/cure-wounds-xphb.md)\
      \ (8th-level version), [hold person](/spells/hold-person-xphb.md)\n\n**1/day\
      \ each:** [divination](/spells/divination-xphb.md), [sending](/spells/sending-xphb.md),\
      \ [word of recall](/spells/word-of-recall-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "BAM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BAM/Astral%20Elf%20Star%20Priest.webp"
```
^statblock