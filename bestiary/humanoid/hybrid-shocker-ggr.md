...
- "Hybrid Shocker"
---
# [Hybrid Shocker](/bestiary/humanoid/hybrid-shocker-ggr.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 15 ft., one creature. *Hit:*\
      ...
      \ ends, the target takes 5 (1d10) lightning damage at the start of each of\
      \ its turns, and the hybrid shocker can't use its tentacles on another creature."
    "name": "Tentacles"
"source":
  - "GGR"
