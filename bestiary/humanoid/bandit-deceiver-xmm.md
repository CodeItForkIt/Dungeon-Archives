...
- "Bandit Deceiver"
---
# [Bandit Deceiver](/bestiary/humanoid/bandit-deceiver-xmm.md)
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 14, each creature in a 10-foot-radius\
      ...
      \ point the bandit can see within 120 feet. *Failure:* 13 (3d6 + 3) Radiant\
      \ damage, and the target has the [Blinded](/rules/conditions.md#Blinded) condition\
      \ until the start of the bandit's next turn. *Success:* Half damage only."
    "name": "Blinding Flash (Recharge 4-6)"
  - "desc": "The bandit casts one of the following spells, using Intelligence as the\
      \ spellcasting ability (spell save DC 14):\n\n**At will:** [Disguise Self](/spells/disguise-self-xphb.md),\
      \ [Mage Hand](/spells/mage-hand-xphb.md), [Minor Illusion](/spells/minor-illusion-xphb.md)\n\
      \n**1/day each:** [Hold Person](/spells/hold-person-xphb.md) (level 4 version),\
      \ [Mage Armor](/spells/mage-armor-xphb.md) (included in AC), [Major Image](/spells/major-image-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
