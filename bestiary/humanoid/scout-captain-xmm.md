...
- "Scout Captain"
---
# [Scout Captain](/bestiary/humanoid/scout-captain-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Piercing\
      \ damage, plus 10 (3d6) Piercing damage if the attack was made with [Advantage](/rules/variant-rules/advantage-xphb.md)."
    "name": "Shortsword"
  - "desc": "*Ranged Attack Roll:* +5, range 150/600 ft. *Hit:* 7 (1d8 + 3) Piercing\
      \ damage, plus 10 (3d6) Piercing damage if the attack was made with [Advantage](/rules/variant-rules/advantage-xphb.md)."
    "name": "Longbow"
"bonus_actions":
  - "desc": "The scout has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
      \ the next attack roll it makes during the current turn."
    "name": "Aim"
"reactions":
