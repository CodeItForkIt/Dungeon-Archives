...
- "Vadalis Heir"
---
# [Vadalis Heir](/bestiary/humanoid/vadalis-heir-efa.md)
...
"cr": "4"
"traits":
  - "desc": "The heir has [Advantage](/rules/variant-rules/advantage-xphb.md) on an\
      \ attack roll against a creature if at least one of the heir's allies is within\
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +5, range 60 ft. *Hit:* 9 (2d8) Radiant damage,\
      \ and the target emits [Dim Light](/rules/variant-rules/dim-light-xphb.md) in\
      \ a 10-foot radius and can't benefit from the [Invisible](/rules/conditions.md#Invisible)\
  ...
  - "desc": "The heir casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ [Light](/spells/light-xphb.md), [Speak with Animals](/spells/speak-with-animals-xphb.md)\n\
      \n**3/day each:** [Animal Friendship](/spells/animal-friendship-xphb.md), [Animal\
      \ Messenger](/spells/animal-messenger-xphb.md)\n\n**1/day:** [Ice Storm](/spells/ice-storm-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The heir targets a Beast it can see within 30 feet. The target can take\
      \ a [Reaction](/rules/variant-rules/reaction-xphb.md) to move up to half its\
      \ [Speed](/rules/variant-rules/speed-xphb.md) and make one melee attack."
    "name": "Spur Beast"
"source":
  - "EFA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EFA/Vadalis%20Heir.webp"
```
^statblock