...
- "Wolfwere"
---
# [Wolfwere](/bestiary/humanoid/wolfwere-mabjov.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 9\
      \ (1d8 + 4) slashing damage or 10 (1d10 + 5) slashing damage if used with\
      \ two hands."
  ...
  - "desc": "The wolfwere plays a magical melody on an instrument. Every Humanoid\
      ...
      \ 13 Wisdom saving throw or be slowed for 10 minutes, as if the [slow](/spells/slow-xphb.md)\
