...
---
# [Skull Lasher of Myrkul](/bestiary/humanoid/skull-lasher-of-myrkul-bgdia.md)
...
"traits":
  - "desc": "The skull lasher is a 3rd-level spellcaster. Its spellcasting ability\
      ...
      \n**1st level (4 slots):** [detect magic](/spells/detect-magic-xphb.md), [protection\
      \ from evil and good](/spells/protection-from-evil-and-good-xphb.md), [ray of\
      \ sickness](/spells/ray-of-sickness-xphb.md) (see \"Actions\" below), [shield](/spells/shield-xphb.md)\n\
      \n**2nd level (2 slots):** [darkness](/spells/darkness-xphb.md), [misty step](/spells/misty-step-xphb.md)"
    "name": "Spellcasting"
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 60 ft., one creature. *Hit:*\
      ...
      \ of the skull lasher's next turn. If the skull lasher casts this spell using\
      \ a spell slot of 2nd level or higher, the damage increases by 1d8 for each\
