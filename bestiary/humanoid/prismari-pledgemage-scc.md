...
- "Prismari Pledgemage"
---
# [Prismari Pledgemage](/bestiary/humanoid/prismari-pledgemage-scc.md)
...
"traits":
  - "desc": "If the pledgemage is subjected to an effect that allows it to make a\
      ...
      \ provided it isn't [incapacitated](/rules/conditions.md#Incapacitated)."
    "name": "Evasion"
"actions":
  ...
  - "desc": "The pledgemage shines with elemental magic, targeting one creature it\
      ...
      \ pledgemage's choice) and is [stunned](/rules/conditions.md#Stunned) until\
      \ the start of the pledgemage's next turn. On a successful save, the target\
  ...
  - "desc": "The pledgemage casts one of the following spells, requiring no material\
      ...
      \ [gust of wind](/spells/gust-of-wind-xphb.md), [silent image](/spells/silent-image-xphb.md)\n\
      \n**1/day each:** [mage armor](/spells/mage-armor-xphb.md), [water walk](/spells/water-walk-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The pledgemage moves up to its speed, surrounding itself with elemental\
      ...
      \ or be knocked [prone](/rules/conditions.md#Prone). If the pledgemage ends\
      \ its turn in another creature's space, the pledgemage takes 5 (1d10) force\
