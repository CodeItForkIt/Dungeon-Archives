...
---
# [Shadar-kai Shadow Dancer](/bestiary/humanoid/shadar-kai-shadow-dancer-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ \n- **3–4 Grapple.** The target is [grappled](/rules/conditions.md#Grappled)\
      \ (escape DC 14) if it is a Medium or smaller creature. Until the grapple ends,\
      \ the target is [restrained](/rules/conditions.md#Restrained), and the shadar-kai\
