...
- "Archpriest"
---
# [Archpriest](/bestiary/humanoid/archpriest-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +9, reach 5 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Radiant Burst"
  - "desc": "*Wisdom Saving Throw:* DC 17, each enemy in a 20-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the archpriest. *Failure:* 21 (6d6) Radiant damage, and\
      \ the target has the [Stunned](/rules/conditions.md#Stunned) condition until\
  ...
  - "desc": "The archpriest casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Light](/spells/light-xphb.md), [Thaumaturgy](/spells/thaumaturgy-xphb.md)\n\
      \n**1/day each:** [Flame Strike](/spells/flame-strike-xphb.md) (level 6 version),\
      \ [Greater Restoration](/spells/greater-restoration-xphb.md), [Raise Dead](/spells/raise-dead-xphb.md),\
      \ [Zone of Truth](/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The priest casts [Bless](/spells/bless-xphb.md), [Dispel Magic](/spells/dispel-magic-xphb.md),\
      \ [Healing Word](/spells/healing-word-xphb.md), or [Lesser Restoration](/spells/lesser-restoration-xphb.md),\
