...
- "Bone Naga"
---
# [Bone Naga](/bestiary/undead/bone-naga-xmm.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, one creature the naga can see within 60\
      \ feet. *Failure:* 13 (3d6 + 3) Psychic damage, and the target has the [Charmed](/rules/conditions.md#Charmed)\
  ...
  - "desc": "The naga casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Mage Hand](/spells/mage-hand-xphb.md), [Thaumaturgy](/spells/thaumaturgy-xphb.md)\n\
      \n**1/day each:** [Command](/spells/command-xphb.md), [Detect Thoughts](/spells/detect-thoughts-xphb.md),\
