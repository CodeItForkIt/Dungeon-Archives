...
- "Beholder Zombie"
---
# [Beholder Zombie](/bestiary/undead/beholder-zombie-xmm.md)
...
"actions":
  ...
  - "desc": "The zombie randomly shoots one of the following magical rays at a target\
      ...
      \ Saving Throw:* DC 14. *Failure:* The target has the [Paralyzed](/rules/conditions.md#Paralyzed)\
      ...
      \ Half damage only.  \n- **4 Disintegration Ray.** *Dexterity Saving Throw:*\
      \ DC 14. *Failure:* 27 (5d10) Force damage. If the target is a nonmagical\
      \ object or a creation of magical force, a 10-foot [Cube](/rules/variant-rules/cube-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Beholder%20Zombie.webp"
```
^statblock
