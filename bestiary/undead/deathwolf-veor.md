...
- "Deathwolf"
---
# [Deathwolf](/bestiary/undead/deathwolf-veor.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:*\
      ...
      \ throws against the [frightened](/rules/conditions.md#Frightened) condition.\
      \ This curse lasts until removed by the [Remove Curse](/spells/remove-curse-xphb.md)\
  ...
  - "desc": "The deathwolf creates a terrifying phantom of itself in the mind of a\
      ...
      \ on a DC 17 Intelligence saving throw or have the [frightened](/rules/conditions.md#Frightened)\
      \ condition for 1 minute.\n\nWhile the target is [frightened](/rules/conditions.md#Frightened),\
      \ the phantom deals 21 (6d6) psychic damage to the target at the start of\
      \ each of the target's turns. A [frightened](/rules/conditions.md#Frightened)\
...
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Deathwolf.webp"
```
^statblock