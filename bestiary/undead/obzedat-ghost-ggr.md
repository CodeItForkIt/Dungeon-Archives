...
- "Obzedat Ghost"
---
# [Obzedat Ghost](/bestiary/undead/obzedat-ghost-ggr.md)
...
"traits":
  - "desc": "The ghost's innate spellcasting ability is Wisdom (spell save DC 16,\
      ...
      \ requiring no components:\n\n**At will:** [chill touch](/spells/chill-touch-xphb.md)\
      \ (at 5th level, and the ghost regains hit points equal to half the amount of\
      \ damage the target takes)\n\n**1/day each:** [sanctuary](/spells/sanctuary-xphb.md),\
      \ [spirit guardians](/spells/spirit-guardians-xphb.md) (at 4th level)"
    "name": "Innate Spellcasting"
  - "desc": "The ghost has a trait based on who it is, as shown below:\n\n- **Enezesku\
      \ Enfeebling Ray.** Enezesku's Innate Spellcasting trait includes [ray of enfeeblement](/spells/ray-of-enfeeblement-xphb.md),\
      ...
      \ Spellcasting trait includes [misty step](/spells/misty-step-xphb.md), which\
...
"legendary_actions":
  ...
  - "desc": "The Obzedat ghosts conjure 1d6 [indentured spirits](/bestiary/undead/indentured-spirit-ggr.md)\
