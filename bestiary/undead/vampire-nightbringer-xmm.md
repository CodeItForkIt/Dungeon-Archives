...
---
# [Vampire Nightbringer](/bestiary/undead/vampire-nightbringer-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 7 (1d6 + 4) Piercing\
      \ damage plus 10 (3d6) Necrotic damage. The target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](/rules/variant-rules/dim-light-xphb.md) or [Darkness](/rules/variant-rules/darkness-xphb.md),\
      \ the vampire takes the [Hide](/rules/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
