...
- "Wraith"
---
# [Wraith](/bestiary/undead/wraith-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 21 (4d8 + 3) Necrotic\
      \ damage. If the target is a creature, its [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the damage taken."
    "name": "Life Drain"
  - "desc": "The wraith targets a Humanoid corpse within 10 feet of itself that has\
      \ been dead for no longer than 1 minute. The target's spirit rises as a [Specter](/bestiary/undead/specter-xmm.md)\
