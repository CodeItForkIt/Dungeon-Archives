...
- "Alhoon"
---
# [Alhoon](/bestiary/undead/alhoon-mpmm.md)
...
"actions":
  ...
  - "desc": "The alhoon magically emits psychic energy in a 60-foot cone. Each creature\
      ...
      \ (4d8 + 4) psychic damage and be [stunned](/rules/conditions.md#Stunned)\
  ...
  - "desc": "The alhoon casts one of the following spells, requiring no material components\
      ...
      **At will:** [dancing lights](/spells/dancing-lights-xphb.md), [detect magic](/spells/detect-magic-xphb.md),\
      ...
      \n**1/day each:** [dominate monster](/spells/dominate-monster-xphb.md), [globe\
      \ of invulnerability](/spells/globe-of-invulnerability-xphb.md), [invisibility](/spells/invisibility-xphb.md),\
      \ [modify memory](/spells/modify-memory-xphb.md), [plane shift](/spells/plane-shift-xphb.md)\
      \ (self only), [wall of force](/spells/wall-of-force-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Alhoon.webp"
```
^statblock
