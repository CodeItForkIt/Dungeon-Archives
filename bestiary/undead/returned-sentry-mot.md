...
- "Returned Sentry"
---
# [Returned Sentry](/bestiary/undead/returned-sentry-mot.md)
...
"traits":
  ...
  - "desc": "The Returned is immune to any effect that would sense its emotions or\
      \ read its thoughts. Wisdom ([Insight](/rules/skills.md#Insight)) checks to\
...
"source":
  - "MOT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MOT/Returned%20Sentry.webp"
```
^statblock