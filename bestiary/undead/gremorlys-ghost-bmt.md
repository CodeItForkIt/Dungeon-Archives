...
- "Gremorly's Ghost"
---
# [Gremorly's Ghost](/bestiary/undead/gremorlys-ghost-bmt.md)
...
"actions":
  ...
  - "desc": "One Humanoid Gremorly can see within 5 feet of himself must succeed on\
      ...
      \ Good](/spells/dispel-evil-and-good-xphb.md) spell. When the possession ends,\
      \ Gremorly reappears in an unoccupied space within 5 feet of the target. The\
      \ target is immune to this Possession for 24 hours after succeeding on the saving\
  ...
  - "desc": "Gremorly casts one of the following spells, using Intelligence as the\
      ...
      \n**2/day each:** [Bestow Curse](/spells/bestow-curse-xphb.md), [Dispel Magic](/spells/dispel-magic-xphb.md)\n\
      \n**1/day:** [Slow](/spells/slow-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Gremorly%27s%20Ghost.webp"
```
^statblock