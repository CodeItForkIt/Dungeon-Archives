...
- "Vampire Umbral Lord"
---
# [Vampire Umbral Lord](/bestiary/undead/vampire-umbral-lord-xmm.md)
...
"senses": "[Blindsight](/rules/senses.md#Blindsight) 120 ft., passive Perception 23"
...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ inside its resting place, it has the [Paralyzed](/rules/conditions.md#Paralyzed)\
      \ condition for 1 hour, after which it regains 1 [Hit Point](/rules/variant-rules/hit-points-xphb.md)."
    "name": "Shadow Escape"
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +10, range 120 ft. *Hit:* 16 (2d10 + 5) Necrotic\
    ...
    "name": "Sickening Ray"
  - "desc": "The vampire casts [Hunger of Hadar](/spells/hunger-of-hadar-xphb.md)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the vampire can see\
      ...
      \ Necrotic damage. The target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
