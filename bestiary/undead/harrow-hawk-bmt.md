...
- "Harrow Hawk"
---
# [Harrow Hawk](/bestiary/undead/harrow-hawk-bmt.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 8\
    ...
    "name": "Talons"
  - "desc": "The hawk casts [Plane Shift](/spells/plane-shift-xphb.md) on itself,\
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Harrow%20Hawk.webp"
```
^statblock