...
- "Dracolich"
---
# [Dracolich](/bestiary/undead/dracolich-xmm.md)
...
"traits":
  ...
  - "desc": "The dracolich has [Advantage](/rules/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The dracolich has a magical gem. If the dracolich is destroyed while\
      ...
      \ body in 1d20 days, regaining all its [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  - "desc": "The dracolich makes three Rend attacks. It can replace one attack with\
      \ a use of Spellcasting to cast [Ray of Sickness](/spells/ray-of-sickness-xphb.md)\
      \ (level 2 version)."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +13, reach 10 ft. *Hit:* 18 (2d10 + 7) Slashing\
      \ damage plus 4 (1d8) Necrotic damage."
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The dracolich casts one of the following spells, requiring no Material\
      ...
      \ [Ray of Sickness](/spells/ray-of-sickness-xphb.md) (level 2 version)\n\n**1/day\
      \ each:** [Create Undead](/spells/create-undead-xphb.md) (level 8 version),\
...
"regional_effects":
  - "desc": "The region containing a dracolich's lair is warped by its presence, creating\
      ...
      \ lair is [Lightly Obscured](/rules/variant-rules/lightly-obscured-xphb.md)\
...
"legendary_actions":
  - "desc": "The dracolich moves up to half its [Speed](/rules/variant-rules/speed-xphb.md),\
    ...
    "name": "Pounce"
  - "desc": "The dracolich uses Spellcasting to cast [Ray of Sickness](/spells/ray-of-sickness-xphb.md)\
      \ (level 2 version). The dracolich can't take this action again until the start\
      \ of its next turn."
    "name": "Sickening Ray"
  - "desc": "*Wisdom Saving Throw:* DC 19, each creature in a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the dracolich. *Failure:* 11 (2d10) Psychic damage, and\
      \ the target has the [Frightened](/rules/conditions.md#Frightened) condition\
