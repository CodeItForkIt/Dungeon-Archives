...
- "Death Tyrant"
---
# [Death Tyrant](/bestiary/undead/death-tyrant-xmm.md)
...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ target has the [Charmed](/rules/conditions.md#Charmed) condition for 1 hour\
      \ or until it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing\
      \ Ray.** *Constitution Saving Throw:* DC 17. *Failure:* The target has the [Paralyzed](/rules/conditions.md#Paralyzed)\
      ...
      \ take Reactions; its [Speed](/rules/variant-rules/speed-xphb.md) is halved;\
      ...
      \ has the [Restrained](/rules/conditions.md#Restrained) condition until the\
      \ start of the death tyrant's next turn or until the death tyrant has the [Incapacitated](/rules/conditions.md#Incapacitated)\
      ...
      \ if it is a Construct or an Undead). *Failure:* The target has the [Unconscious](/rules/conditions.md#Unconscious)\
...
"bonus_actions":
  - "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
      \ negative energy in a 150-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      ...
      \ there instantly rises as a [Zombie](/bestiary/undead/zombie-xmm.md) under\
      \ the death tyrant's control and takes its turn immediately after the death\
...
"regional_effects":
  - "desc": "The region containing a death tyrant's lair is warped by its presence,\
      ...
      \ a creature within 1 mile of the lair regains [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      \ from a spell, it subtracts 1d10 from the number of [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ allies) that finishes a [Short Rest](/rules/variant-rules/short-rest-xphb.md)\
