...
- "Ghost"
---
# [Ghost](/bestiary/undead/ghost-xmm.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md)\
  ...
  - "desc": "*Charisma Saving Throw:* DC 13, one Humanoid the ghost can see within\
      ...
      \ game statistics are the same, except it uses the possessed target's [Speed](/rules/variant-rules/speed-xphb.md),\
      ...
      \ 5 feet of the target, and the target is immune to this ghost's [Possession](/rules/variant-rules/possession-xphb.md)\
      \ for 24 hours. *Success:* The target is immune to this ghost's [Possession](/rules/variant-rules/possession-xphb.md)\
      \ for 24 hours."
    "name": "Possession (Recharge 6)"
  - "desc": "The ghost casts the [Etherealness](/spells/etherealness-xphb.md) spell,\
      \ requiring no spell components and using Charisma as the spellcasting ability.\
      \ The ghost is visible on the Material Plane while on the Border Ethereal and\
      \ vice versa, but it can't affect or be affected by anything on the other plane.\n"
    "name": "Etherealness"
"source":
  - "XMM"
