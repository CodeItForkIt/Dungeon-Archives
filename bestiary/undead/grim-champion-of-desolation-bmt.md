...
---
# [Grim Champion of Desolation](/bestiary/undead/grim-champion-of-desolation-bmt.md)
...
"actions":
  ...
  - "desc": "The champion summons a hungering rift around a creature it can see within\
      ...
      \ [stunned](/rules/conditions.md#Stunned) condition until the start of the champion's\
      \ next turn. On a successful save, the creature takes half as much damage only.\
      \ If a creature is reduced to 0 hit points by this effect, the creature dies,\
      \ and its body crumbles to dust."
    "name": "Hollow Void"
"bonus_actions":
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Grim%20Champion%20of%20Desolation.webp"
```
^statblock