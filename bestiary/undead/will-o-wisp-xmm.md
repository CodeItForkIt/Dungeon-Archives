...
"traits":
  ...
  - "desc": "The wisp sheds [Bright Light](/rules/variant-rules/bright-light-xphb.md)\
      \ in a 20-foot radius and [Dim Light](/rules/variant-rules/dim-light-xphb.md)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 10, one living creature the wisp can\
      \ see within 5 feet that has 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md).\
      \ *Failure:* The target dies, and the wisp regains 10 (3d6) [Hit Points](/rules/variant-rules/hit-points-xphb.md)."
    "name": "Consume Life"
