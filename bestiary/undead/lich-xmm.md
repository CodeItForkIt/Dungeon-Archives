...
- "Lich"
---
# [Lich](/bestiary/undead/lich-xmm.md)
...
"actions":
  ...
  - "desc": "The lich casts one of the following spells, using Intelligence as the\
      ...
      \ [Fireball](/spells/fireball-xphb.md) (level 5 version), [Invisibility](/spells/invisibility-xphb.md),\
    ...
    "name": "Spellcasting"
"reactions":
  - "desc": "The lich casts [Counterspell](/spells/counterspell-xphb.md) or [Shield](/spells/shield-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing a lich's lair is warped by its presence, creating\
      ...
      \ cast [Clairvoyance](/spells/clairvoyance-xphb.md), requiring no spell components\
      ...
      \ way can be brought back to life only by a True Resurrection or [Wish](/spells/wish-xphb.md)\
      \ spell.  \n\nIf the lich is destroyed or moves its lair elsewhere, these effects\
      \ end immediately. These effects resume if the lich gains a new body (see its\
      \ Spirit Jar trait)."
    "name": ""
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 20, each creature that isn't an Undead\
      \ in a 20-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    "name": "Disrupt Life"
  - "desc": "The lich casts [Fear](/spells/fear-xphb.md), using the same spellcasting\
