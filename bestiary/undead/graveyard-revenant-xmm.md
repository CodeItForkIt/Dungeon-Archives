...
- "Graveyard Revenant"
---
# [Graveyard Revenant](/bestiary/undead/graveyard-revenant-xmm.md)
...
"traits":
  - "desc": "If the revenant dies, it revives 24 hours later unless [Dispel Evil and\
      ...
      \ revives, it animates another group of corpses elsewhere on the same plane\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 10 (1d10 + 5) Bludgeoning\
      ...
      \ have up to two targets [Grappled](/rules/conditions.md#Grappled) in this way\
      \ at a time."
    "name": "Suffocate"
  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the revenant. *Failure:* The target has the [Paralyzed](/rules/conditions.md#Paralyzed)\
