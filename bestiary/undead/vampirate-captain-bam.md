...
- "Vampirate Captain"
---
# [Vampirate Captain](/bestiary/undead/vampirate-captain-bam.md)
...
"actions":
  ...
  - "desc": "A ship upon which the captain stands, along with all creatures and objects\
      ...
      \ maintain it (as if [concentrating](/rules/conditions.md#Concentration) on\
      \ a spell), and it lasts for up to 1 hour. The effect ends if the captain leaves\
      \ the ship."
