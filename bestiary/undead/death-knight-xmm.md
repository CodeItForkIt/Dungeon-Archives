...
- "Death Knight"
---
# [Death Knight](/bestiary/undead/death-knight-xmm.md)
...
"traits":
  ...
  - "desc": "Undead creatures of the death knight's choice (excluding itself) in a\
      \ 60-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  - "desc": "If the death knight is destroyed before it atones for its evil, it gains\
      \ a new body in 1d10 days, reviving with all its [Hit Points](/rules/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +11, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing\
    ...
    "name": "Dread Blade"
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 20-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
  ...
  - "desc": "The death knight casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Command](/spells/command-xphb.md), [Phantom Steed](/spells/phantom-steed-xphb.md)\n\
      \n**2/day each:** [Destructive Wave](/spells/destructive-wave-xphb.md) (Necrotic),\
      \ [Dispel Magic](/spells/dispel-magic-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"legendary_actions":
  - "desc": "The death knight uses Spellcasting to cast [Command](/spells/command-xphb.md).\
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the death knight can\
      ...
      \ [Hit Point](/rules/variant-rules/hit-points-xphb.md) maximum decreases by\
      \ an amount equal to the damage taken. *Failure or Success:* The death knight\
