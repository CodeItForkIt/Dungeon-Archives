...
- "Draconic Shard"
---
# [Draconic Shard](/bestiary/undead/draconic-shard-ftd.md)
...
"actions":
  ...
  - "desc": "The shard disappears as it pours its psychic essence into a Medium or\
      ...
      \ or until an effect that ends possession, such as a [dispel evil and good](/spells/dispel-evil-and-good-xphb.md)\
  ...
  - "desc": "The shard casts one of the following spells, requiring no spell components\
      ...
      **At will:** [detect thoughts](/spells/detect-thoughts-xphb.md), [invisibility](/spells/invisibility-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "The shard targets a creature it can see within 30 feet of it. The target\
      ...
      \ can take only the Attack (shard chooses the target) or [Dash](/rules/actions.md#Dash)\
      \ action on its turn."
