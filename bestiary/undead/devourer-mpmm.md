...
"actions":
  ...
  - "desc": "The devourer chooses a living Humanoid with 0 hit points that it can\
      ...
      \ Dice, it becomes a [zombie](/bestiary/undead/zombie-xmm.md). If it had 3 to\
      \ 5 Hit Dice, it becomes a [ghoul](/bestiary/undead/ghoul-xmm.md). Otherwise,\
      \ it becomes a [wight](/bestiary/undead/wight-xmm.md). A devourer can imprison\
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Devourer.webp"
```
^statblock
