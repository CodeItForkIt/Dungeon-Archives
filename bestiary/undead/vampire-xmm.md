...
- "Vampire"
---
# [Vampire](/bestiary/undead/vampire-xmm.md)
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 17, one creature within 5 feet that is\
      ...
      \ + 4) Piercing damage plus 13 (3d8) Necrotic damage. The target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ by this damage and then buried rises the following sunset as a [Vampire Spawn](/bestiary/undead/vampire-spawn-xmm.md)\
...
"bonus_actions":
  - "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
      ...
      \ than its size and [Speed](/rules/variant-rules/speed-xphb.md), are unchanged.\n\
      ...
      \ liquid. It has [Resistance](/rules/variant-rules/resistance-xphb.md) to all\
      \ damage, except the damage it takes from sunlight."
    "name": "Shape-Shift"
  - "desc": "The vampire casts [Charm Person](/spells/charm-person-xphb.md), requiring\
      \ no spell components and using Charisma as the spellcasting ability (spell\
      \ save DC 17), and the duration is 24 hours. The Charmed target is a willing\
...
"regional_effects":
  - "desc": "The region containing a vampire's lair is warped by its presence, creating\
      ...
      \ smaller Beasts have the [Charmed](/rules/conditions.md#Charmed) condition\
      ...
      \ of the lair is [Lightly Obscured](/rules/variant-rules/lightly-obscured-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "The vampire casts [Command](/spells/command-xphb.md), requiring no spell\
