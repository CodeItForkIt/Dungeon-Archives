...
- "Eldritch Lich"
---
# [Eldritch Lich](/bestiary/undead/eldritch-lich-mcv1sc.md)
...
"cr": "15"
"traits":
  - "desc": "Inside the lich's torso dwells a wormlike parasite that contains the\
      ...
      \ circle cast to contain Undead, the lich instead reappears as an [otyugh](/bestiary/aberration/otyugh-xmm.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ must succeed on a DC 17 Constitution saving throw or be [poisoned](/rules/conditions.md#Poisoned).\
      ...
      \ third time the target fails the save, the target dies and dissolves into a\
      \ [gibbering mouther](/bestiary/aberration/gibbering-mouther-xmm.md) that obeys\
      \ the lich and uses the target's initiative."
  ...
  - "desc": "The lich targets one creature it can see within 120 feet of itself. The\
      ...
      \ of the lich's next turn as incomprehensible whispers fill the target's mind."
  ...
  - "desc": "The lich casts one of the following spells, using Intelligence as the\
      ...
      \n**2/day each:** [dispel magic](/spells/dispel-magic-xphb.md), [hunger of Hadar](/spells/hunger-of-hadar-xphb.md),\
      \ [lightning bolt](/spells/lightning-bolt-xphb.md)\n\n**1/day each:** [arcane\
      \ eye](/spells/arcane-eye-xphb.md), [dimension door](/spells/dimension-door-xphb.md),\
...
"reactions":
  - "desc": "Immediately after taking damage, the lich, along with any equipment it\
      \ is wearing or carrying, magically teleports up to 60 feet to an unoccupied\
      \ space it can see."
    "name": "Far Realm Step"
"source":
  - "MCV1SC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MCV1SC/Eldritch%20Lich.webp"
```
^statblock