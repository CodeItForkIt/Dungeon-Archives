...
- "Revenant"
---
# [Revenant](/bestiary/undead/revenant-xmm.md)
...
"traits":
  ...
  - "desc": "If the revenant dies, it revives 24 hours later in a different body unless\
      \ [Dispel Evil and Good](/spells/dispel-evil-and-good-xphb.md) is cast on its\
      \ corpse. If it revives, it animates a Humanoid corpse elsewhere on the same\
      \ plane of existence; it now looks different but uses the same stat block and\
      \ returns with all its [Hit Points](/rules/variant-rules/hit-points-xphb.md)."
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the revenant can see within\
      ...
      \ If the [Frightened](/rules/conditions.md#Frightened) target is cursed by the\
      \ revenant (see Vow of Revenge), the target also has the [Paralyzed](/rules/conditions.md#Paralyzed)\
...
"bonus_actions":
  - "desc": "The revenant curses one creature it can see within 30 feet of itself.\
      ...
      \ the revenant uses this [Bonus Action](/rules/variant-rules/bonus-action-xphb.md)\
