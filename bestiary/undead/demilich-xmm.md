...
- "Demilich"
---
# [Demilich](/bestiary/undead/demilich-xmm.md)
...
"traits":
  ...
  - "desc": "If the demilich is destroyed, it reforms and regains all its [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      \ in 1d10 days unless a [Wish](/spells/wish-xphb.md) spell is cast on its\
      \ remains."
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +11, reach 5 ft. or range 120 ft. *Hit:*\
    ...
    "name": "Necrotic Burst"
  - "desc": "*Constitution Saving Throw:* DC 19, each creature in a 30-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the demilich. *Failure:* 70 (20d6) Psychic damage. *Failure\
      \ or Success:* The target has the [Frightened](/rules/conditions.md#Frightened)\
...
"regional_effects":
  - "desc": "The region containing a demilich's lair is twisted by its presence, creating\
      ...
      \ than the demilich or one of its allies finishes a [Long Rest](/rules/variant-rules/long-rest-xphb.md)\
      \ within 1 mile of the lair, the creature must succeed on a DC 20 Constitution\
      \ saving throw or have its [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
      \ maximum reduced by 1d4. This reduction lasts until the creature finishes\
      \ a [Long Rest](/rules/variant-rules/long-rest-xphb.md) outside that area. \
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 19, one creature the demilich can see\
      \ within 120 feet. *Failure:* The target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The demilich flies up to its [Fly Speed](/rules/variant-rules/fly-speed-xphb.md),\
      ...
      \ 19. *Failure:* The target has the [Blinded](/rules/conditions.md#Blinded)\
