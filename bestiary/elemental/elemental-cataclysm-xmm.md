...
- "Elemental Cataclysm"
---
# [Elemental Cataclysm](/bestiary/elemental/elemental-cataclysm-xmm.md)
...
"senses": "[Truesight](/rules/senses.md#Truesight) 150 ft., passive Perception 12"
...
"actions":
  ...
  - "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
      ...
      \ a 60-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ [burning](/traps-hazards/burning-xphb.md).  \n- **2 Freezing Waves.** *Strength\
      \ Saving Throw:* DC 23, each creature in a 90-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 22 (5d8) Bludgeoning damage plus 22 (5d8) Cold damage, and\
      \ the target has the [Prone](/rules/conditions.md#Prone) condition. *Success:*\
      \ Half damage only. *Failure or Success:* The target's [Speed](/rules/variant-rules/speed-xphb.md)\
      \ is reduced to 0 until the end of its next turn.  \n- **3 Raging Storm.** A\
      \ storm cloud fills a 60-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ entirely in the cloud have the [Blinded](/rules/conditions.md#Blinded) and\
      \ [Deafened](/rules/conditions.md#Deafened) conditions and can't cast spells\
      \ with a Verbal component. *Dexterity Saving Throw:* DC 23, each creature that\
      \ enters the cloud for the first time on a turn or starts its turn there. *Failure:*\
      \ 18 (4d8) Lightning damage plus 18 (4d8) Thunder damage. *Success:* Half\
      \ damage.  \n- **4 Swallowing Earth.** *Strength Saving Throw:* DC 23, each\
      \ creature in a 90-foot [Cube](/rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ originating from a point on the ground within 150 feet. *Failure:* 18 (4d8)\
      \ Bludgeoning damage plus 18 (4d8) Acid damage, and the target has the [Prone](/rules/conditions.md#Prone)\
      \ condition and is buried under rubble. A buried target has the [Restrained](/rules/conditions.md#Restrained)\
      \ condition, has [Total Cover](/rules/variant-rules/cover-xphb.md), and is suffocating.\
      \ As an action, a buried creature or another creature within 5 feet of it can\
      \ make a DC 18 Strength ([Athletics](/rules/skills.md#Athletics)) check. On\
      \ a successful check, the creature is no longer buried. *Success:* Half damage\
      \ only.  "
    "name": "Cataclysmic Event (Recharge 4-6)"
  - "desc": "The cataclysm casts the [Control Weather](/spells/control-weather-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "The cataclysm moves up to its [Speed](/rules/variant-rules/speed-xphb.md),\
      ...
      \ target has the [Prone](/rules/conditions.md#Prone) condition. *Failure or\
      \ Success:* The cataclysm can't take this action again until the start of its\
      \ next turn."
