...
---
# [Salamander Inferno Master](/bestiary/elemental/salamander-inferno-master-xmm.md)
...
"traits":
  - "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
      \ choice in a 10-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the salamander takes 10 (3d6) Fire damage."
    "name": "Fire Aura"
  - "desc": "The salamander has [Advantage](/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +12, reach 5 ft. or range 30/90 ft.\
    ...
    "name": "Flame Trident"
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 30-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
      \ centered on a point the salamander can see within 120 feet. *Failure:* 35\
      \ (10d6) Fire damage, and the target starts [burning](/traps-hazards/burning-xphb.md),\
      \ taking 5 (1d10) Fire damage at the start of each of its turns instead of\
      \ the normal [burning](/traps-hazards/burning-xphb.md) damage. The target gains\
      \ 1 [Exhaustion](/rules/conditions.md#Exhaustion) level whenever it takes this\
      \ [burning](/traps-hazards/burning-xphb.md) damage. *Success:* Half damage only."
...
"bonus_actions":
  - "desc": "The salamander moves up to its [Speed](/rules/variant-rules/speed-xphb.md)\
      ...
      \ During this movement, fire fills a 5-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the salamander. When the [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
