...
- "Leviathan"
---
# [Leviathan](/bestiary/elemental/leviathan-mpmm.md)
...
"actions":
  ...
  - "desc": "The leviathan magically creates a wave of water that extends from a point\
      ...
      \ bludgeoning damage and is knocked [prone](/rules/conditions.md#Prone). On\
      \ a successful save, a creature takes half as much damage and isn't knocked\
      \ [prone](/rules/conditions.md#Prone). The water spreads out across the ground\
      \ in all directions, extinguishing unprotected flames in its area and within\
      \ 250 feet of it, and then it vanishes."
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Leviathan.webp"
```
^statblock
