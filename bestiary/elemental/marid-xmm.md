...
- "Marid"
---
# [Marid](/bestiary/elemental/marid-xmm.md)
...
"traits":
  ...
  - "desc": "The marid has a 30 percent chance of knowing the [Wish](/spells/wish-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 60-foot-long, 10-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 31 (9d6)\
      \ Cold damage. If the target is a Huge or smaller creature, it is pushed up\
      \ to 20 feet straight away from the marid and has the [Prone](/rules/conditions.md#Prone)\
  ...
  - "desc": "The marid casts one of the following spells, requiring no Material components\
      ...
      \ each:** [Control Water](/spells/control-water-xphb.md), [Gaseous Form](/spells/gaseous-form-xphb.md),\
      \ [Invisibility](/spells/invisibility-xphb.md), [Plane Shift](/spells/plane-shift-xphb.md),\
      \ [Tongues](/spells/tongues-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The marid casts [Fog Cloud](/spells/fog-cloud-xphb.md), using the same\
