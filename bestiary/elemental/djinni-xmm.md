...
- "Djinni"
---
# [Djinni](/bestiary/elemental/djinni-xmm.md)
...
"traits":
  - "desc": "If the djinni dies outside the Elemental Plane of Air, its body dissolves\
      ...
      \ Points](/rules/variant-rules/hit-points-xphb.md) somewhere on the Plane of\
      \ Air."
    "name": "Elemental Restoration"
  - "desc": "The djinni has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
      \ saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The djinni has a 30 percent chance of knowing the [Wish](/spells/wish-xphb.md)\
...
"actions":
  ...
  - "desc": "The djinni conjures a whirlwind at a point it can see within 120 feet.\
      \ The whirlwind fills a 20-foot-radius, 60-foot-high [Cylinder](/rules/variant-rules/cylinder-area-of-effect-xphb.md)\
      ...
      \ and moves with the whirlwind. At the start of each of its turns, the [Restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The djinni casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Evil and Good](/spells/detect-evil-and-good-xphb.md), [Detect\
      \ Magic](/spells/detect-magic-xphb.md)\n\n**2/day each:** [Create Food and Water](/spells/create-food-and-water-xphb.md)\
      \ (can create wine instead of water), [Tongues](/spells/tongues-xphb.md), [Wind\
      \ Walk](/spells/wind-walk-xphb.md)\n\n**1/day each:** [Creation](/spells/creation-xphb.md),\
      \ [Gaseous Form](/spells/gaseous-form-xphb.md), [Invisibility](/spells/invisibility-xphb.md),\
      \ [Major Image](/spells/major-image-xphb.md), [Plane Shift](/spells/plane-shift-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
