...
---
# [Lizardfolk Sovereign](/bestiary/elemental/lizardfolk-sovereign-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (1d10 + 3) Piercing\
      ...
      \ lizardfolk gains [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "The lizardfolk moves up to its [Speed](/rules/variant-rules/speed-xphb.md)\
      \ or [Swim Speed](/rules/variant-rules/swim-speed-xphb.md) straight toward an\
      \ enemy it can see."
    "name": "Charge"
"source":
  - "XMM"
