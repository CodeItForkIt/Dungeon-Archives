...
- "Ice Mephit"
---
# [Ice Mephit](/bestiary/elemental/ice-mephit-xmm.md)
...
"traits":
  - "desc": "The mephit explodes when it dies. *Constitution Saving Throw:* DC 10,\
      \ each creature in a 5-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"actions":
  ...
  - "desc": "The mephit casts [Fog Cloud](/spells/fog-cloud-xphb.md), requiring no\
