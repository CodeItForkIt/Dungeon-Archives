...
- "Fire Elemental"
---
# [Fire Elemental](/bestiary/elemental/fire-elemental-xmm.md)
...
"traits":
  - "desc": "At the end of each of the elemental's turns, each creature in a 10-foot\
      ...
      \ from the elemental takes 5 (1d10) Fire damage. Creatures and flammable objects\
      \ in the [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ start [burning](/traps-hazards/burning-xphb.md)."
    "name": "Fire Aura"
  ...
  - "desc": "The elemental sheds [Bright Light](/rules/variant-rules/bright-light-xphb.md)\
      \ in a 30-foot radius and [Dim Light](/rules/variant-rules/dim-light-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 10 (2d6 + 3) Fire damage.\
      \ If the target is a creature or a flammable object, it starts [burning](/traps-hazards/burning-xphb.md)."
    "name": "Burn"
"source":
  - "XMM"
