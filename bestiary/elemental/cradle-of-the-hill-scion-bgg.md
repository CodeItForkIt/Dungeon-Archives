...
---
# [Cradle of the Hill Scion](/bestiary/elemental/cradle-of-the-hill-scion-bgg.md)
...
"cr": "22"
"traits":
  - "desc": "The cradle is a container for the [scion of Grolantor](/bestiary/giant/scion-of-grolantor-bgg.md).\
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +14 to hit, range 120 ft., one target. *Hit:*\
      ...
      \ Strength saving throw or have the [prone](/rules/conditions.md#Prone) condition."
    "name": "Spit Rock"
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 30 ft., one creature not [grappled](/rules/conditions.md#Grappled)\
      \ by the cradle. *Hit:* the target has the [grappled](/rules/conditions.md#Grappled)\
  ...
  - "desc": "The cradle magically creates a wave of dirt that extends from a point\
      ...
      \ bludgeoning damage, has the [prone](/rules/conditions.md#Prone) condition,\
      \ and is buried under dirt. On a successful save, a creature takes half as much\
      \ damage only.\n\nA buried creature has the [restrained](/rules/conditions.md#Restrained)\
      ...
      \ make a DC 17 Strength ([Athletics](/rules/skills.md#Athletics)) check. On\
      \ a successful check, the buried creature no longer has the [prone](/rules/conditions.md#Prone)\
