...
- "Black Pudding"
---
# [Black Pudding](/bestiary/ooze/black-pudding-xmm.md)
...
"traits":
  ...
  - "desc": "A creature that hits the pudding with a melee attack roll takes 4 (1d8)\
      ...
      \ -5. The penalty can be removed by casting the [Mending](/spells/mending-xphb.md)\
...
"reactions":
  - "desc": "Trigger: While the pudding is Large or Medium and has 10+ [Hit Points](/rules/variant-rules/hit-points-xphb.md),\
      \ it becomes [Bloodied](/rules/conditions.md#Bloodied) or is subjected to Lightning\
      ...
      \ its [Initiative](/rules/variant-rules/initiative-xphb.md). The original pudding's\
      \ [Hit Points](/rules/variant-rules/hit-points-xphb.md) are divided evenly between\
      \ the new puddings (round down)."
    "name": "Split"
"source":
  - "XMM"
