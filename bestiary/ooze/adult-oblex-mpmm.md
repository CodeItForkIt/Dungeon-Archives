...
- "Adult Oblex"
---
# [Adult Oblex](/bestiary/ooze/adult-oblex-mpmm.md)
...
"actions":
  ...
  - "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
      ...
      \ increases by one: the d4 becomes a d6, the d6 becomes a d8, and so\
  ...
  - "desc": "The oblex casts one of the following spells, requiring no spell components\
      ...
      **3/day each:** [charm person](/spells/charm-person-xphb.md) (as 5th-level spell),\
      \ [detect thoughts](/spells/detect-thoughts-xphb.md), [hypnotic pattern](/spells/hypnotic-pattern-xphb.md)"
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Adult%20Oblex.webp"
```
^statblock
