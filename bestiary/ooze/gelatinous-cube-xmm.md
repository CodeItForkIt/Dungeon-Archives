...
- "Gelatinous Cube"
---
# [Gelatinous Cube](/bestiary/ooze/gelatinous-cube-xmm.md)
...
"traits":
  - "desc": "The cube fills its entire space and is transparent. Other creatures can\
      ...
      \ throw.\n\nCreatures inside the cube have [Total Cover](/rules/variant-rules/cover-xphb.md),\
      ...
      \ 12 Strength ([Athletics](/rules/skills.md#Athletics)) check, and the puller\
      \ takes 10 (3d6) Acid damage."
    "name": "Ooze Cube"
  - "desc": "Even when the cube is in plain sight, a creature must succeed on a DC\
      \ 15 Wisdom ([Perception](/rules/skills.md#Perception)) check to notice the\
      \ cube if the creature hasn't witnessed the cube move or otherwise act."
    "name": "Transparent"
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 12 (3d6 + 2) Acid damage."
    "name": "Pseudopod"
  - "desc": "The cube moves up to its [Speed](/rules/variant-rules/speed-xphb.md)\
      ...
      \ room inside itself to contain them (see the Ooze [Cube](/rules/variant-rules/cube-area-of-effect-xphb.md)\
      ...
      \ spells with a Verbal component, has the [Restrained](/rules/conditions.md#Restrained)\
      ...
      \ target can try to escape by taking an action to make a DC 12 Strength ([Athletics](/rules/skills.md#Athletics))\
