...
---
# [Blob of Annihilation](/bestiary/ooze/blob-of-annihilation-xmm.md)
...
|------------|----------------------|
| 1 | An [Amulet of the Planes](/items/amulet-of-the-planes-xdmg.md). |
| 2 | An Artifact of the DM's choice. |
| 3 | The corpses of two gods who were entangled in battle when the blob consumed them. |
| 4 | A Cubic Gate. |
| 5 | A [Deck of Many Things](/items/deck-of-many-things-xdmg.md). |
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +15, reach 30 ft. *Hit:* 24 (3d10 + 8) Force\
      \ damage."
    "name": "Pseudopod"
  - "desc": "The blob moves up to its [Speed](/rules/variant-rules/speed-xphb.md)\
      ...
      \ While engulfed, a target has [Total Cover](/rules/variant-rules/cover-xphb.md)\
      ...
      \ Force damage at the start of each of its turns, is suffocating, has the [Restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The blob lobs a slimy glob at one Large or smaller creature it can see\
      ...
      \ toward the blob, and the target has the [Restrained](/rules/conditions.md#Restrained)\
