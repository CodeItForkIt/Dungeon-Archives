...
- "Elder Oblex"
---
# [Elder Oblex](/bestiary/ooze/elder-oblex-mpmm.md)
...
"actions":
  ...
  - "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
      ...
      \ it benefits from the [greater restoration](/spells/greater-restoration-xphb.md)\
      \ or [heal](/spells/heal-xphb.md) spell. Constructs, Oozes, Plants, and Undead\
      ...
      \ and so on until the die becomes a d20, at which point the target becomes\
      \ [unconscious](/rules/conditions.md#Unconscious) for 1 hour. The effect then\
  ...
  - "desc": "The oblex casts one of the following spells, requiring no spell components\
      ...
      **At will:** [charm person](/spells/charm-person-xphb.md) (as 5th-level spell),\
      \ [detect thoughts](/spells/detect-thoughts-xphb.md)\n\n**3/day each:** [dimension\
      \ door](/spells/dimension-door-xphb.md), [dominate person](/spells/dominate-person-xphb.md),\
      \ [hypnotic pattern](/spells/hypnotic-pattern-xphb.md), [telekinesis](/spells/telekinesis-xphb.md)"
