...
- "Guardian Naga"
---
# [Guardian Naga](/bestiary/celestial/guardian-naga-xmm.md)
...
"traits":
  - "desc": "If the naga dies, it returns to life in 1d6 days and regains all its\
      \ [Hit Points](/rules/variant-rules/hit-points-xphb.md) unless [Dispel Evil\
      \ and Good](/spells/dispel-evil-and-good-xphb.md) is cast on its remains."
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 16, one creature the naga can see within\
      \ 60 feet. *Failure:* 31 (7d8) Poison damage, and the target has the [Blinded](/rules/conditions.md#Blinded)\
  ...
  - "desc": "The naga casts one of the following spells, requiring no Somatic or Material\
      ...
      \ [Clairvoyance](/spells/clairvoyance-xphb.md), [Cure Wounds](/spells/cure-wounds-xphb.md)\
      \ (level 6 version), [Flame Strike](/spells/flame-strike-xphb.md) (level 6 version),\
      \ [Geas](/spells/geas-xphb.md), [True Seeing](/spells/true-seeing-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
