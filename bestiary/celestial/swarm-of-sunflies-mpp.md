...
- "Swarm of Sunflies"
---
# [Swarm of Sunflies](/bestiary/celestial/swarm-of-sunflies-mpp.md)
...
"actions":
  ...
  - "desc": "The target sheds bright light in a 5-foot radius until the end of its\
      \ next turn. During that time, the [invisible](/rules/conditions.md#Invisible)\
      \ condition has no effect on it."
    "name": "Upper Plane"
  - "desc": "If the target is [concentrating](/rules/conditions.md#Concentration)\
      \ on a spell or similar effect, it loses its [concentration](/rules/conditions.md#Concentration)."
    "name": "Neutral Plane"
  ...
  - "desc": "The swarm shines its lights in a dazzling display. Each creature within\
      ...
      \ have the [stunned](/rules/conditions.md#Stunned) condition for 1 minute. A\
