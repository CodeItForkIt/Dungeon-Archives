...
- "Ki-rin"
---
# [Ki-rin](/bestiary/celestial/ki-rin-mpmm.md)
...
"actions":
  ...
  - "desc": "The ki-rin casts one of the following spells, requiring no material components\
      ...
      \ [light](/spells/light-xphb.md), [major image](/spells/major-image-xphb.md)\
      \ (6th-level version), [thaumaturgy](/spells/thaumaturgy-xphb.md)\n\n**3/day\
      \ each:** [cure wounds](/spells/cure-wounds-xphb.md), [dispel magic](/spells/dispel-magic-xphb.md),\
      \ [lesser restoration](/spells/lesser-restoration-xphb.md), [sending](/spells/sending-xphb.md)\n\
      \n**1/day each:** [banishment](/spells/banishment-xphb.md), [calm emotions](/spells/calm-emotions-xphb.md),\
      \ [create food and water](/spells/create-food-and-water-xphb.md), [greater restoration](/spells/greater-restoration-xphb.md),\
      \ [plane shift](/spells/plane-shift-xphb.md), [protection from evil and good](/spells/protection-from-evil-and-good-xphb.md),\
      \ [revivify](/spells/revivify-xphb.md), [wind walk](/spells/wind-walk-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
...
"regional_effects":
  - "desc": "A ki-rin's Celestial nature transforms the region around its lair. Any\
      ...
      \ prey.  \n- **Controlled Weather.** A ki-rin can cast [control weather](/spells/control-weather-xphb.md)\
