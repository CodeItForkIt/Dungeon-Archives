...
- "Planetar"
---
# [Planetar](/bestiary/celestial/planetar-xmm.md)
...
"traits":
  ...
  - "desc": "The planetar has [Advantage](/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +12, reach 10 ft. *Hit:* 14 (2d6 + 7) Slashing\
    ...
    "name": "Radiant Sword"
  - "desc": "*Dexterity Saving Throw:* DC 20, each enemy in a 20-foot-radius [Sphere](/rules/variant-rules/sphere-area-of-effect-xphb.md)\
  ...
  - "desc": "The planetar casts one of the following spells, requiring no Material\
      ...
      \n**1/day each:** [Commune](/spells/commune-xphb.md), [Control Weather](/spells/control-weather-xphb.md),\
      \ [Dispel Evil and Good](/spells/dispel-evil-and-good-xphb.md), [Raise Dead](/spells/raise-dead-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The planetar casts [Cure Wounds](/spells/cure-wounds-xphb.md), [Invisibility](/spells/invisibility-xphb.md),\
      \ [Lesser Restoration](/spells/lesser-restoration-xphb.md), or [Remove Curse](/spells/remove-curse-xphb.md),\
