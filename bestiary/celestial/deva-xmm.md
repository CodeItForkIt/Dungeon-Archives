...
- "Deva"
---
# [Deva](/bestiary/celestial/deva-xmm.md)
...
"actions":
  ...
  - "desc": "The deva casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Evil and Good](/spells/detect-evil-and-good-xphb.md), [Shapechange](/spells/shapechange-xphb.md)\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The deva casts [Cure Wounds](/spells/cure-wounds-xphb.md), [Lesser Restoration](/spells/lesser-restoration-xphb.md),\
      \ or [Remove Curse](/spells/remove-curse-xphb.md), using the same spellcasting\
