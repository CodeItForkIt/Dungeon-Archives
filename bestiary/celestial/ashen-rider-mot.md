...
- "Ashen Rider"
---
# [Ashen Rider](/bestiary/celestial/ashen-rider-mot.md)
...
"traits":
  - "desc": "The ashen rider's spellcasting ability is Wisdom (spell save DC 18).\
      ...
      \n**At will:** [command](/spells/command-xphb.md), [compelled duel](/spells/compelled-duel-xphb.md)\n\
      \n**1/day each:** [banishment](/spells/banishment-xphb.md), [blade barrier](/spells/blade-barrier-xphb.md)"
  ...
  - "desc": "When a creature starts its turn within 30 feet of the ashen rider, the\
      ...
      \ the next 24 hours. On a failed save, the creature can't speak and is [deafened](/rules/conditions.md#Deafened)\
  ...
  - "desc": "If the ashen rider isn't mounted, it can use a bonus action to magically\
      ...
      \ the ashen rider can't be [surprised](/rules/conditions.md#Surprised), and\
...
"legendary_actions":
  ...
  - "desc": "The ashen rider targets a creature it can see within 60 feet of it. The\
      ...
      \ [wish](/spells/wish-xphb.md) spell."
