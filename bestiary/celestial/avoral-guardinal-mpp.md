...
- "Avoral Guardinal"
---
# [Avoral Guardinal](/bestiary/celestial/avoral-guardinal-mpp.md)
...
"traits":
  - "desc": "If the avoral is flying, dives at least 30 feet in a straight line toward\
      ...
      \ damage and have the [prone](/rules/conditions.md#Prone) condition."
    "name": "Dive Attack"
...
"actions":
  ...
  - "desc": "The avoral casts one of the following spells, requiring no material components\
      ...
      \ each:** [command](/spells/command-xphb.md), [hold person](/spells/hold-person-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPP"
