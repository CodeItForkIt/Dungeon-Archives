...
- "Sphinx of Secrets"
---
# [Sphinx of Secrets](/bestiary/celestial/sphinx-of-secrets-xmm.md)
...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
    ...
    "name": "Inscrutable"
  - "desc": "The sphinx has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
      \ saving throws against spells and other magical effects."
    "name": "Magic Resistance"
"actions":
  - "desc": "The sphinx makes three Claw attacks. It can replace one attack with a\
      \ use of [Curse](/rules/variant-rules/curses-xphb.md) of the Riddle."
    "name": "Multiattack"
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ a riddle. The cursed target has [Disadvantage](/rules/variant-rules/disadvantage-xphb.md)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Detect Magic](/spells/detect-magic-xphb.md), [Identify](/spells/identify-xphb.md),\
      ...
      \ Object](/spells/locate-object-xphb.md), [Remove Curse](/spells/remove-curse-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
