...
---
# [Starlight Apparition](/bestiary/celestial/starlight-apparition-bam.md)
...
"actions":
  - "desc": "*Melee  or Ranged Spell Attack:* +6 to hit, reach 5 ft. or range 120\
      ...
      \ a creature, it must succeed on a DC 14 Wisdom saving throw or be [blinded](/rules/conditions.md#Blinded)\
  ...
  - "desc": "One Humanoid that the apparition can see within 5 feet of itself must\
      ...
      \ the apparition then disappears, and the target is [incapacitated](/rules/conditions.md#Incapacitated)\
      ...
      \ evil and good](/spells/dispel-evil-and-good-xphb.md) spell. When the possession\
      \ ends, the apparition reappears in an unoccupied space within 5 feet of the\
      \ body. If it reappears in a location not on the Astral Plane, the apparition\
      \ is destroyed. The target is immune to this apparition's Possession for 24\
      \ hours after succeeding on the saving throw or after the possession ends."
    "name": "Possession (Recharge 6)"
"source":
  - "BAM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BAM/Starlight%20Apparition.webp"
```
^statblock