...
- "Solar"
---
# [Solar](/bestiary/celestial/solar-xmm.md)
...
"traits":
  ...
  - "desc": "The solar has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
...
"actions":
  ...
  - "desc": "The solar casts one of the following spells, requiring no Material components\
      ...
      \ each:** [Commune](/spells/commune-xphb.md), [Control Weather](/spells/control-weather-xphb.md),\
      \ [Dispel Evil and Good](/spells/dispel-evil-and-good-xphb.md), [Resurrection](/spells/resurrection-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The solar casts [Cure Wounds](/spells/cure-wounds-xphb.md) (level 2 version),\
...
"legendary_actions":
  ...
  - "desc": "The solar teleports up to 60 feet to an unoccupied space it can see.\
      \ *Dexterity Saving Throw:* DC 25, each creature in a 10-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
