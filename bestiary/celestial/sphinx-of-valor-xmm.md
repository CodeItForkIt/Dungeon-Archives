...
- "Sphinx of Valor"
---
# [Sphinx of Valor](/bestiary/celestial/sphinx-of-valor-xmm.md)
...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
      \ its permission. Wisdom ([Insight](/rules/skills.md#Insight)) checks made to\
      \ ascertain its intentions or sincerity are made with [Disadvantage](/rules/variant-rules/disadvantage-xphb.md)."
    "name": "Inscrutable"
...
"actions":
  ...
  - "desc": "The sphinx emits a magical roar. Whenever it roars, the roar has a different\
      ...
      \n- **First Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Frightened](/rules/conditions.md#Frightened)\
      \ condition for 1 minute.  \n- **Second Roar.** *Wisdom Saving Throw:* DC 20,\
      \ each enemy in a 500-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      ...
      \ from the sphinx. *Failure:* 44 (8d10) Thunder damage, and the target has\
      \ the [Prone](/rules/conditions.md#Prone) condition. *Success:* Half damage\
      \ only.  "
    "name": "Roar (3/Day)"
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      \ [Detect Evil and Good](/spells/detect-evil-and-good-xphb.md), [Thaumaturgy](/spells/thaumaturgy-xphb.md)\n\
      \n**1/day each:** [Detect Magic](/spells/detect-magic-xphb.md), [Dispel Magic](/spells/dispel-magic-xphb.md),\
      \ [Greater Restoration](/spells/greater-restoration-xphb.md), [Heroes' Feast](/spells/heroes-feast-xphb.md),\
...
"regional_effects":
  - "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is\
      ...
      \ While in its lair, the sphinx can cast [Clairvoyance](/spells/clairvoyance-xphb.md),\
      ...
      \ a [Study](/rules/actions.md#Study) action while within 1 mile of the lair,\
      \ it adds 1d6 to any ability check it makes for that action.  \n\nIf the sphinx\
