...
- "Animal Lord"
---
# [Animal Lord](/bestiary/celestial/animal-lord-xmm.md)
...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ from the animal lord. *Failure:* The target suffers one of the following effects:\n\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      - **Fortify (Forager Only).** The animal lord gains 20 [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md).\
