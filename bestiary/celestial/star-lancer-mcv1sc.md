...
- "Star Lancer"
---
# [Star Lancer](/bestiary/celestial/star-lancer-mcv1sc.md)
...
"cr": "2"
"traits":
  - "desc": "The star lancer doesn't provoke opportunity attacks when it flies out\
      \ of an enemy's reach."
    "name": "Flyby"
"actions":
  ...
  - "desc": "The star lancer and one creature riding it (chosen by the star lancer)\
      \ magically turn [invisible](/rules/conditions.md#Invisible). This effect lasts\
      \ until the star lancer or a creature riding it attacks or casts a spell, or\
      \ until the star lancer's [concentration](/rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/rules/conditions.md#Concentration) on a spell).\
      \ Any equipment worn or carried by the [invisible](/rules/conditions.md#Invisible)\
      \ creatures is also [invisible](/rules/conditions.md#Invisible) for the duration\
      \ of the Invisibility Cloak."
    "name": "Invisibility Cloak (3/Day)"
"source":
  - "MCV1SC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MCV1SC/Star%20Lancer.webp"
```
^statblock