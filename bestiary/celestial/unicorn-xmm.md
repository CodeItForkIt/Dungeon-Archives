...
- "Unicorn"
---
# [Unicorn](/bestiary/celestial/unicorn-xmm.md)
...
"traits":
  ...
  - "desc": "The unicorn has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
...
"actions":
  ...
  - "desc": "The unicorn casts one of the following spells, requiring no spell components\
      ...
      \ will:** [Detect Evil and Good](/spells/detect-evil-and-good-xphb.md), [Druidcraft](/spells/druidcraft-xphb.md)\n\
      \n**1/day each:** [Calm Emotions](/spells/calm-emotions-xphb.md), [Dispel Evil\
      \ and Good](/spells/dispel-evil-and-good-xphb.md), [Entangle](/spells/entangle-xphb.md),\
      \ [Pass without Trace](/spells/pass-without-trace-xphb.md), [Word of Recall](/spells/word-of-recall-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The unicorn touches another creature with its horn and casts [Cure Wounds](/spells/cure-wounds-xphb.md)\
      \ or [Lesser Restoration](/spells/lesser-restoration-xphb.md) on that creature,\
...
"regional_effects":
  - "desc": "The region containing a unicorn's lair is changed by its presence, creating\
      ...
      \ from a spell, it regains the maximum number of [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "The unicorn targets itself or one creature it can see within 60 feet\
      \ of itself. The target gains 10 (3d6) [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md),\
