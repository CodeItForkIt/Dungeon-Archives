...
---
# [Archon of the Triumvirate](/bestiary/celestial/archon-of-the-triumvirate-ggr.md)
...
"traits":
  - "desc": "The archon's innate spellcasting ability is Wisdom (spell save DC 18,\
      ...
      \ spells, requiring no material components:\n\n**At will:** [calm emotions](/spells/calm-emotions-xphb.md),\
      \ [command](/spells/command-xphb.md), [compelled duel](/spells/compelled-duel-xphb.md)"
  ...
  - "desc": "If the archon isn't mounted, it can use a bonus action to magically teleport\
      ...
      \ mount gain advantage on Dexterity saving throws. If the archon is reduced\
