...
- **Choking Depths.** A creature can [hold its breath](/traps-hazards/suffocation-xphb.md) for only 30 seconds while in the domain.  
...
- **Something in the Air.** Creatures other than Cthulhu and its allies have [Disadvantage](/rules/variant-rules/disadvantage-xphb.md) on saving throws to avoid or end the [Frightened](/rules/conditions.md#Frightened) condition.  
