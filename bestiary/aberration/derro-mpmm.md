...
- "Derro"
---
# [Derro](/bestiary/aberration/derro-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +2 to hit, reach 5 ft., one target. *Hit:* 3\
      ...
      \ choose to deal no damage and knock it [prone](/rules/conditions.md#Prone)."
    "name": "Hooked Spear"
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Derro.webp"
```
^statblock
