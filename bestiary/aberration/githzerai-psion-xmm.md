...
- "Githzerai Psion"
---
# [Githzerai Psion](/bestiary/aberration/githzerai-psion-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +8, reach 5 ft. or range 120 ft. *Hit:*\
      ...
      \ of (A) the [Charmed](/rules/conditions.md#Charmed) condition until the start\
      \ of the githzerai's next turn or (B) the [Prone](/rules/conditions.md#Prone)\
  ...
  - "desc": "The githzerai casts one of the following spells, requiring no spell components\
      ...
      **At will:** [Mage Hand](/spells/mage-hand-xphb.md) (the hand is Invisible)\n\
      \n**1/day each:** [Plane Shift](/spells/plane-shift-xphb.md), [See Invisibility](/spells/see-invisibility-xphb.md)"
    "name": "Spellcasting"
"reactions":
  - "desc": "The githzerai casts [Feather Fall](/spells/feather-fall-xphb.md) or [Shield](/spells/shield-xphb.md)\
      \ in response to the spell's trigger, requiring no spell components and using\
