...
- "Roper"
---
# [Roper](/bestiary/aberration/roper-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 17 (3d8 + 4) Piercing\
      \ damage."
    "name": "Bite"
  - "desc": "*Melee Attack Roll:* +7, reach 60 ft. *Hit:* The target has the [Grappled](/rules/conditions.md#Grappled)\
      \ condition (escape DC 14) from one of six tentacles, and the target has the\
      \ [Poisoned](/rules/conditions.md#Poisoned) condition until the grapple ends.\n\
      \nThe tentacle can be damaged, freeing a creature it has [Grappled](/rules/conditions.md#Grappled)\
      \ when destroyed (AC 20, HP 10, [Immunity](/rules/variant-rules/immunity-xphb.md)\
