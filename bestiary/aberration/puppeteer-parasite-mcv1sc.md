...
- "Puppeteer Parasite"
---
# [Puppeteer Parasite](/bestiary/aberration/puppeteer-parasite-mcv1sc.md)
...
"actions":
  ...
  - "desc": "The parasite deals 12 (3d6 + 2) necrotic damage to one creature it\
    ...
    "name": "Consume Life"
"bonus_actions":
  - "desc": "The parasite casts the [suggestion](/spells/suggestion-xphb.md) spell,\
      \ requiring no spell components and using Intelligence as the spellcasting ability\
      \ (spell save DC 13)."
    "name": "Suggestion (Psionics; 1/Day)"
"source":
  - "MCV1SC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MCV1SC/Puppeteer%20Parasite.webp"
```
^statblock