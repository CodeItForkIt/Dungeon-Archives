...
- "Kuo-toa"
---
# [Kuo-toa](/bestiary/aberration/kuo-toa-xmm.md)
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 10, one Large or smaller creature the kuo-toa\
      ...
      \ to make a DC 10 Strength ([Athletics](/rules/skills.md#Athletics)) check to\
      \ free itself or another creature in a net within 5 feet, destroying the net\
      \ on a success."
