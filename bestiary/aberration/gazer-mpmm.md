...
- "Gazer"
---
# [Gazer](/bestiary/aberration/gazer-mpmm.md)
...
"actions":
  ...
  - "desc": "The gazer shoots two of the following magical eye rays at random (roll\
      ...
      \ on a DC 12 Wisdom saving throw or be [charmed](/rules/conditions.md#Charmed)\
      \ until the start of the gazer's next turn. While the target is [charmed](/rules/conditions.md#Charmed)\
      ...
      \ Telekinetic Ray.** If the target is a creature that is Medium or smaller,\
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Gazer.webp"
```
^statblock
