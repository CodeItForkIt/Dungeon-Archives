...
- "Grell"
---
# [Grell](/bestiary/aberration/grell-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 10 ft. *Hit:* 7 (1d10 + 2) Piercing\
      ...
      \ target has the [Poisoned](/rules/conditions.md#Poisoned) condition and repeats\
      \ the save at the end of each of its turns, ending the effect on itself on a\
      \ success. After 1 minute, it succeeds automatically. While [Poisoned](/rules/conditions.md#Poisoned),\
