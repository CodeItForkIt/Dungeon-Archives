...
- "Kalaraq Quori"
---
# [Kalaraq Quori](/bestiary/aberration/kalaraq-quori-erlw.md)
...
"traits":
  - "desc": "The quori's spellcasting ability is Charisma (spell save DC 21, +13\
      ...
      \ no components:\n\n**At will:** [arcane eye](/spells/arcane-eye-xphb.md)\n\n\
      **3/day each:** [clairvoyance](/spells/clairvoyance-xphb.md), [confusion](/spells/confusion-xphb.md),\
      \ [dream](/spells/dream-xphb.md), [eyebite](/spells/eyebite-xphb.md)"
    "name": "Innate Spellcasting (Psionics)"
  - "desc": "The quori can't be [surprised](/rules/conditions.md#Surprised) while\
...
"actions":
  ...
  - "desc": "*Melee Spell Attack:* +13 to hit, reach 5 ft., one target. *Hit:* 29\
      ...
      \ can't be revived by any means short of a [wish](/spells/wish-xphb.md) spell\
  ...
  - "desc": "The quori touches one humanoid, which must succeed on a DC 21 Intelligence\
      ...
      \ curse or [greater restoration](/spells/greater-restoration-xphb.md) spell.\n\
      ...
      \ the [wish](/spells/wish-xphb.md) spell can free the thrall from this control."
  ...
  - "desc": "One humanoid that the quori can see within 5 feet of it must succeed\
      ...
      \ out by an effect like the [dispel evil and good](/spells/dispel-evil-and-good-xphb.md)\
