...
- "Feyr"
---
# [Feyr](/bestiary/aberration/feyr-bam.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one creature. *Hit:*\
      \ 8 (1d10 + 3) piercing damage, and each creature within 10 feet of the feyr\
      \ that can see it must succeed on a DC 13 Wisdom saving throw or be [frightened](/rules/conditions.md#Frightened)\
      \ of the feyr until the end of the feyr's next turn."
    "name": "Frightful Bite"
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 10 ft., one creature. *Hit:*\
      \ 17 (4d6 + 3) psychic damage, and the target is [grappled](/rules/conditions.md#Grappled)\
      ...
      \ one creature."
    "name": "Tentacle"
  - "desc": "The feyr becomes [invisible](/rules/conditions.md#Invisible) until it\
      \ attacks, uses Nightmare Fuel, or uses a bonus action to become visible."
    "name": "Invisibility"
  - "desc": "The feyr targets one [unconscious](/rules/conditions.md#Unconscious)\
      \ creature it can see within 10 feet of itself. The target must succeed on a\
      \ DC 13 Wisdom saving throw or take 27 (5d10) psychic damage, and the feyr\
