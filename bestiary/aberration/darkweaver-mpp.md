...
- "Darkweaver"
---
# [Darkweaver](/bestiary/aberration/darkweaver-mpp.md)
...
"traits":
  - "desc": "While the darkweaver is in dim light or darkness, attack rolls against\
      \ it are made with disadvantage unless the darkweaver has the [incapacitated](/rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Shadowy Form"
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +7 to hit, reach 120 ft., one creature. *Hit:*\
      \ 16 (3d10) necrotic damage, and the target has the [grappled](/rules/conditions.md#Grappled)\
    ...
    "name": "Shadow Web"
  - "desc": "The darkweaver pulls each creature it has [grappled](/rules/conditions.md#Grappled)\
