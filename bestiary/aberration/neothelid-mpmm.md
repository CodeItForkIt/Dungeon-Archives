...
- "Neothelid"
---
# [Neothelid](/bestiary/aberration/neothelid-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +13 to hit, reach 15 ft., one target. *Hit:*\
      ...
      \ saving throw or be swallowed by the neothelid. A swallowed creature is [blinded](/rules/conditions.md#Blinded)\
      ...
      \ creature is no longer [restrained](/rules/conditions.md#Restrained) by it\
      \ and can escape from the corpse by using 20 feet of movement, exiting [prone](/rules/conditions.md#Prone)."
    "name": "Tentacles"
  ...
  - "desc": "The neothelid casts one of the following spells, requiring no spell components\
      ...
      \ [levitate](/spells/levitate-xphb.md)\n\n**1/day each:** [confusion](/spells/confusion-xphb.md),\
      \ [feeblemind](/spells/befuddlement-xphb.md), [telekinesis](/spells/telekinesis-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Neothelid.webp"
```
^statblock
