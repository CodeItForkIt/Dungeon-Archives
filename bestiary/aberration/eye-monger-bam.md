...
- "Eye Monger"
---
# [Eye Monger](/bestiary/aberration/eye-monger-bam.md)
...
"senses": "[darkvision](/rules/senses.md#Darkvision) 120 ft., [blindsight](/rules/senses.md#Blindsight)\
...
"traits":
  ...
  - "desc": "If the eye monger is motionless and has its eye and mouth closed at the\
      ...
      \ a DC 18 Intelligence ([Investigation](/rules/skills.md#Investigation)) check\
      \ to discern that the eye monger is animate."
...
"actions":
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ eye monger can swallow one creature at a time. A swallowed creature is [blinded](/rules/conditions.md#Blinded)\
      \ and [restrained](/rules/conditions.md#Restrained), has total cover against\
      \ attacks and other effects originating outside the eye monger, and takes 35\
      \ (10d6) acid damage at the start of each of its turns.\n\nIf the eye monger\
      \ takes 25 damage or more on a single turn from a creature inside its gullet,\
      \ the eye monger regurgitates the swallowed creature, which falls [prone](/rules/conditions.md#Prone)\
      ...
      \ and can escape from the corpse by using 10 feet of movement, exiting [prone](/rules/conditions.md#Prone)."
    "name": "Bite"
"source":
  - "BAM"
