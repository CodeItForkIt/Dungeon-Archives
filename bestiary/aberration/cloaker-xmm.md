...
- "Cloaker"
---
# [Cloaker](/bestiary/aberration/cloaker-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 13 (3d6 + 3) Piercing\
      ...
      \ to it. While the cloaker is attached, the target has the [Blinded](/rules/conditions.md#Blinded)\
      ...
      \ a DC 14 Strength ([Athletics](/rules/skills.md#Athletics)) check."
    "name": "Attach"
  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 8 (1d10 + 3) Slashing\
      \ damage."
    "name": "Tail"
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 60-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the cloaker. *Failure:* The target has the [Frightened](/rules/conditions.md#Frightened)\
    ...
    "name": "Moan"
  - "desc": "The cloaker casts the [Mirror Image](/spells/mirror-image-xphb.md) spell,\
