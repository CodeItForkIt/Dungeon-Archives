...
- "Ettin Ceremorph"
---
# [Ettin Ceremorph](/bestiary/aberration/ettin-ceremorph-bgg.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ the [grappled](/rules/conditions.md#Grappled) condition (escape DC 14) and\
      \ must succeed on a DC 15 Intelligence saving throw or have the [stunned](/rules/conditions.md#Stunned)\
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one [incapacitated](/rules/conditions.md#Incapacitated)\
      \ Humanoid [grappled](/rules/conditions.md#Grappled) by the ceremorph. *Hit:*\
