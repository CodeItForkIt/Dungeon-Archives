...
- "Mind Flayer"
---
# [Mind Flayer](/bestiary/aberration/mind-flayer-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 22 (4d8 + 4) Psychic\
      ...
      \ has the [Stunned](/rules/conditions.md#Stunned) condition until the grapple\
      \ ends."
    "name": "Tentacles"
  - "desc": "*Constitution Saving Throw:* DC 15, one creature that is [Grappled](/rules/conditions.md#Grappled)\
      ...
      \ [Hit Points](/rules/variant-rules/hit-points-xphb.md), the mind flayer kills\
      \ it and devours its brain."
    "name": "Extract Brain"
  - "desc": "*Intelligence Saving Throw:* DC 15, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 31 (6d8 + 4) Psychic damage, and the target has the [Stunned](/rules/conditions.md#Stunned)\
