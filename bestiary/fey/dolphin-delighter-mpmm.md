...
- "Dolphin Delighter"
---
# [Dolphin Delighter](/bestiary/fey/dolphin-delighter-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5\
      ...
      \ is [blinded](/rules/conditions.md#Blinded) until the start of the dolphin's\
      \ next turn."
    "name": "Dazzling Slam"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Dolphin%20Delighter.webp"
```
^statblock
