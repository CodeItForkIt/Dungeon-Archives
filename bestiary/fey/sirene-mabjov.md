...
- "Sirene"
---
# [Sirene](/bestiary/fey/sirene-mabjov.md)
...
"senses": "[darkvision](/rules/senses.md#Darkvision) 60ft., passive Perception 10"
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +6 to hit, range 80/320 ft., one target. *Hit:*\
    ...
    "name": "Shortbow"
  - "desc": "The sirene casts [suggestion](/spells/suggestion-xphb.md) with a range\
  ...
  - "desc": "The sirene casts one of the following spells, requiring no material components\
      ...
      \ each:** [crown of madness](/spells/crown-of-madness-xphb.md), [fog cloud](/spells/fog-cloud-xphb.md),\
