...
- "Goblin Boss"
---
# [Goblin Boss](/bestiary/fey/goblin-boss-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 5 (1d6 + 2) Slashing\
      \ damage, plus 2 (1d4) Slashing damage if the attack roll had [Advantage](/rules/variant-rules/advantage-xphb.md)."
    "name": "Scimitar"
  - "desc": "*Ranged Attack Roll:* +4, range 80/320 ft. *Hit:* 5 (1d6 + 2) Piercing\
      \ damage, plus 2 (1d4) Piercing damage if the attack roll had [Advantage](/rules/variant-rules/advantage-xphb.md)."
    "name": "Shortbow"
"bonus_actions":
  - "desc": "The goblin takes the [Disengage](/rules/actions.md#Disengage) or [Hide](/rules/actions.md#Hide)\
      \ action."
    "name": "Nimble Escape"
"reactions":
