...
- "Giant Lynx"
---
# [Giant Lynx](/bestiary/fey/giant-lynx-bgg.md)
...
"cr": "1/2"
"traits":
  - "desc": "The lynx can cast [clairvoyance](/spells/clairvoyance-xphb.md), requiring\
      \ no spell components and using Wisdom as the spellcasting ability."
    "name": "Lynx's Sight (1/Day)"
  - "desc": "The lynx has advantage on Dexterity ([Stealth](/rules/skills.md#Stealth))\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 8\
      ...
      \ If the target has the [prone](/rules/conditions.md#Prone) condition, the lynx\
      \ can make another Claws attack against it as a bonus action."
    "name": "Claws"
"source":
  - "BGG"
