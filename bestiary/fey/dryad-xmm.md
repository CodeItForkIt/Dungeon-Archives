...
- "Dryad"
---
# [Dryad](/bestiary/fey/dryad-xmm.md)
...
"cr": "1"
"traits":
  - "desc": "The dryad has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
...
"actions":
  - "desc": "The dryad makes one Vine Lash or Thorn Burst attack, and it can use Spellcasting\
      \ to cast [Charm Monster](/spells/charm-monster-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "The dryad casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Animal Friendship](/spells/animal-friendship-xphb.md), [Charm Monster](/spells/charm-monster-xphb.md)\
      \ (lasts 24 hours; ends early if the dryad casts the spell again), [Druidcraft](/spells/druidcraft-xphb.md)\n\
      \n**1/day each:** [Entangle](/spells/entangle-xphb.md), [Pass without Trace](/spells/pass-without-trace-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
