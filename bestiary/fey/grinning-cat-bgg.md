...
- "Grinning Cat"
---
# [Grinning Cat](/bestiary/fey/grinning-cat-bgg.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 9\
      \ (2d6 + 2) slashing damage. If the grinning cat was [invisible](/rules/conditions.md#Invisible)\
      \ before it attacked, the target must succeed on a DC 12 Strength saving throw\
      \ or have the [prone](/rules/conditions.md#Prone) condition. If the target has\
      \ the [prone](/rules/conditions.md#Prone) condition, the cat can make a Bite\
      \ attack against it as a bonus action."
    "name": "Claws"
  - "desc": "The grinning cat magically becomes [invisible](/rules/conditions.md#Invisible)\
      ...
      \ head, or its grinning mouth. Any equipment the cat wears or carries is [invisible](/rules/conditions.md#Invisible)\
      \ with it."
    "name": "Fade Away"
"bonus_actions":
  - "desc": "The grinning cat becomes visible or makes part of its body visible. Any\
      ...
      \ visible."
    "name": "Fade Back"
  - "desc": "The grinning cat teleports, along with any equipment it is wearing or\
