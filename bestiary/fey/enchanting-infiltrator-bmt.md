...
---
# [Enchanting Infiltrator](/bestiary/fey/enchanting-infiltrator-bmt.md)
...
"actions":
  ...
  - "desc": "The infiltrator magically whispers to a creature it can see within 30\
      ...
      \ have the [stunned](/rules/conditions.md#Stunned) condition due to fear or\
      \ delight (the infiltrator's choice) until the end of the target's next turn,\
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Enchanting%20Infiltrator.webp"
```
^statblock