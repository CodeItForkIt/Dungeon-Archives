...
- "Bugbear Warrior"
---
# [Bugbear Warrior](/bestiary/fey/bugbear-warrior-xmm.md)
...
"skillsaves":
  ...
  - "name": "[Survival](/rules/skills.md#Survival)"
    "desc": "+2"
"gear":
  - "[hide armor](/items/hide-armor-xphb.md)"
  - "three [light hammers](/items/light-hammer-xphb.md)"
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 10 ft. *Hit:* 9 (2d6 + 2) Bludgeoning\
    ...
    "name": "Grab"
  - "desc": "*Melee  or Ranged Attack Roll:* +4 (with [Advantage](/rules/variant-rules/advantage-xphb.md)\
      \ if the target is [Grappled](/rules/conditions.md#Grappled) by the bugbear),\
