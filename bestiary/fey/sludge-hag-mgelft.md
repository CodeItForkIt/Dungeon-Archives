...
- "Sludge Hag"
---
# [Sludge Hag](/bestiary/fey/sludge-hag-mgelft.md)
...
"cr": "3"
"traits":
  - "desc": "**At will:** [acid splash](/spells/acid-splash-xphb.md), [dancing lights](/spells/dancing-lights-xphb.md),\
      \ [minor illusion](/spells/minor-illusion-xphb.md)\n\nThe hag's innate spellcasting\
      \ ability is Charisma (spell save DC 12). She can innately cast the following\
...
"source":
  - "MGELFT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MGELFT/Sludge%20Hag.webp"
```
^statblock