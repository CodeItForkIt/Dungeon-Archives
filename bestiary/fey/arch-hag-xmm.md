...
- "Arch-hag"
---
# [Arch-hag](/bestiary/fey/arch-hag-xmm.md)
...
"traits":
  - "desc": "While within 30 feet of at least two hag allies, the hag can cast one\
      ...
      \ save DC 19): [Augury](/spells/augury-xphb.md), [Find Familiar](/spells/find-familiar-xphb.md),\
  ...
  - "desc": "When the hag drops to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md),\
      ...
      \ as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ [Disadvantage](/rules/variant-rules/disadvantage-xphb.md) on ability checks\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +14, reach 10 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Spectral Claw"
  - "desc": "*Dexterity Saving Throw:* DC 22, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The hag casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Thoughts](/spells/detect-thoughts-xphb.md), [Dimension Door](/spells/dimension-door-xphb.md),\
      \ [Dispel Magic](/spells/dispel-magic-xphb.md), [Hypnotic Pattern](/spells/hypnotic-pattern-xphb.md)\n\
      \n**2/day each:** [Mass Suggestion](/spells/mass-suggestion-xphb.md), [Modify\
      \ Memory](/spells/modify-memory-xphb.md), [Plane Shift](/spells/plane-shift-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Each creature cursed by the hag and within 60 feet of it takes 14 (4d6)\
    ...
    "name": "Witch Strike"
"reactions":
  - "desc": "The hag casts [Counterspell](/spells/counterspell-xphb.md) in response\
...
"regional_effects":
  - "desc": "The region containing an arch-hag's lair is altered by its presence,\
      ...
      \ ability check they make when they take the [Influence](/rules/actions.md#Influence)\
      ...
      \ using a spell slot, it also casts [Confusion](/spells/confusion-xphb.md) centered\
      \ on itself. The spell uses the creature's spellcasting ability and doesn't\
      \ require [Concentration](/rules/conditions.md#Concentration).  \n\nIf the arch-hag\
...
"legendary_actions":
  - "desc": "The hag makes one Spectral Claw attack."
    "name": "Hag's Swipe"
  - "desc": "The hag uses Spellcasting to cast [Dimension Door](/spells/dimension-door-xphb.md)\
      \ or [Hypnotic Pattern](/spells/hypnotic-pattern-xphb.md). The hag can't take\
