...
- "Riffler"
---
# [Riffler](/bestiary/fey/riffler-bmt.md)
...
"actions":
  ...
  - "desc": "The riffler casts the [Plane Shift](/spells/plane-shift-xphb.md) spell\
      \ targeting only itself, requiring no material components and using Charisma\
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Riffler.webp"
```
^statblock