...
"actions":
  ...
  - "desc": "The mite places a hex on a creature it can see within 60 feet of it for\
      ...
      \ an ability check, or a saving throw, it must roll a d6 and subtract the\
      \ number rolled from the d20 roll. On any turn in which it suffers the effect\
      \ of the hex, the target can attack an ally as a reaction, ignoring the effect\
      \ of the hex when it does so. It can then ignore the effect of the hex until\
      \ the end of its turn."
    "name": "Blood Boiling Hex (Recharge 6)"
"source":
  - "MFF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MFF/Mite.webp"
```
^statblock