...
- "Annis Hag"
---
# [Annis Hag](/bestiary/fey/annis-hag-mpmm.md)
...
Much as annis hags befriend children in order to corrupt them, they may adopt a group of ogres, trolls, or other creatures ([ogres](/bestiary/giant/ogre-xmm.md) and [trolls](/bestiary/giant/troll-xmm.md)), ruling them through brute strength, insults, and superstition.
...
"actions":
  ...
  - "desc": "The hag casts one of the following spells, using Charisma as the spellcasting\
      \ ability (spell save DC 13):\n\n**3/day each:** [disguise self](/spells/disguise-self-xphb.md)\
      \ (including the form of a Medium Humanoid), [Fog cloud](/spells/fog-cloud-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Annis%20Hag.webp"
```
^statblock
