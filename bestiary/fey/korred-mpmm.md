...
- "Korred"
---
# [Korred](/bestiary/fey/korred-mpmm.md)
...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](/bestiary/elemental/galeb-duhr-xmm.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
"actions":
  ...
  - "desc": "The korred casts one of the following spells, requiring no spell components\
      ...
      \ [commune with nature](/spells/commune-with-nature-xphb.md) (as an action),\
      \ [meld into stone](/spells/meld-into-stone-xphb.md), [stone shape](/spells/stone-shape-xphb.md)\n\
      \n**1/day:** [Otto's irresistible dance](/spells/ottos-irresistible-dance-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Korred.webp"
```
^statblock
