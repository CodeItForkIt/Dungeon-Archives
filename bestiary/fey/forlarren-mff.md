...
- "Forlarren"
---
# [Forlarren](/bestiary/fey/forlarren-mff.md)
...
"traits":
  - "desc": "The forlarren's innate spellcasting ability is Charisma (spell save DC\
      ...
      \n**At will:** [expeditious retreat](/spells/expeditious-retreat-xphb.md), [false\
      \ life](/spells/false-life-xphb.md), [minor illusion](/spells/minor-illusion-xphb.md),\
      \ [prestidigitation](/spells/prestidigitation-xphb.md)\n\n**3/day each:** [aid](/spells/aid-xphb.md),\
      \ [misty step](/spells/misty-step-xphb.md), [Tasha's hideous laughter](/spells/tashas-hideous-laughter-xphb.md)\n\
      \n**1/day each:** [heal](/spells/heal-xphb.md), [heat metal](/spells/heat-metal-xphb.md),\
...
"actions":
  - "desc": "The forlarren makes two claw attacks and one gore attack, or it makes\
      \ three chromatic ray attacks."
    "name": "Multiattack"
  ...
  - "desc": "*Ranged Spell Attack:* +6 to hit, range 60 ft., one target. *Hit:*\
      \ 3 (1d6) lightning damage plus 3 (1d6) fire damage plus 3 (1d6) cold\
      \ damage."
    "name": "Chromatic Ray"
"source":
  - "MFF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MFF/Forlarren.webp"
```
^statblock