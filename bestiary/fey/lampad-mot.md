...
- "Lampad"
---
# [Lampad](/bestiary/fey/lampad-mot.md)
...
"traits":
  - "desc": "The lampad's spellcasting ability is Charisma (+6 to hit with spell\
      ...
      \ components:\n\n**At will:** [chill touch](/spells/chill-touch-xphb.md) (see\
      \ \"Actions\" below), [gentle repose](/spells/gentle-repose-xphb.md)"
...
"source":
  - "MOT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MOT/Lampad.webp"
```
^statblock