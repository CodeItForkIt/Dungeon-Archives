...
---
# [Hobgoblin Devastator](/bestiary/fey/hobgoblin-devastator-mpmm.md)
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 60 ft., one target. *Hit:*\
      \ 21 (4d8 + 3) force damage, and the target is knocked [prone](/rules/conditions.md#Prone)."
  ...
  - "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
      ...
      \ [prestidigitation](/spells/prestidigitation-xphb.md)\n\n**2/day each:** [fireball](/spells/fireball-xphb.md),\
      \ [fly](/spells/fly-xphb.md), [fog cloud](/spells/fog-cloud-xphb.md), [gust\
      \ of wind](/spells/gust-of-wind-xphb.md), [lightning bolt](/spells/lightning-bolt-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Hobgoblin%20Devastator.webp"
```
^statblock
