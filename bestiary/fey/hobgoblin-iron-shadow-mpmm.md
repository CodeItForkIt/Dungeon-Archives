...
---
# [Hobgoblin Iron Shadow](/bestiary/fey/hobgoblin-iron-shadow-mpmm.md)
...
"actions":
  ...
  - "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
      ...
      \ person](/spells/charm-person-xphb.md), [disguise self](/spells/disguise-self-xphb.md),\
      \ [silent image](/spells/silent-image-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Hobgoblin%20Iron%20Shadow.webp"
```
^statblock
