...
- "Green Hag"
---
# [Green Hag](/bestiary/fey/green-hag-xmm.md)
...
"actions":
  ...
  - "desc": "The hag casts one of the following spells, requiring no Material components\
      ...
      \ [Disguise Self](/spells/disguise-self-xphb.md) (24-hour duration), [Invisibility](/spells/invisibility-xphb.md)\
      \ (self only, and the hag leaves no tracks while Invisible), [Minor Illusion](/spells/minor-illusion-xphb.md),\
