...
- "Fate Hag"
---
# [Fate Hag](/bestiary/fey/fate-hag-bmt.md)
...
"traits":
  ...
  - "desc": "The hag can cast the [Legend Lore](/spells/legend-lore-xphb.md) spell,\
...
"actions":
  ...
  - "desc": "While holding its shears, the hag casts one of the following spells,\
      \ requiring no material components and using Wisdom as the spellcasting ability\
      \ (spell save DC 14):\n\n**At will:** [Bless](/spells/bless-xphb.md), [Guidance](/spells/guidance-xphb.md),\
      \ [Silent Image](/spells/silent-image-xphb.md)\n\n**1/day each:** [Bane](/spells/bane-xphb.md),\
      \ [Bestow Curse](/spells/bestow-curse-xphb.md), [Divination](/spells/divination-xphb.md),\
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Fate%20Hag.webp"
```
^statblock