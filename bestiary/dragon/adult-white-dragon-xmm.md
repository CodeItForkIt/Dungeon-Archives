...
- "Adult White Dragon"
---
# [Adult White Dragon](/bestiary/dragon/adult-white-dragon-xmm.md)
...
"traits":
  - "desc": "The dragon can move across and climb icy surfaces without needing to\
      \ make an ability check. Additionally, [Difficult Terrain](/rules/variant-rules/difficult-terrain-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +11, reach 10 ft. *Hit:* 13 (2d6 + 6) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 19, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient white dragon's lair is affected\
      ...
      \ area within 1 mile of the lair is an area of [extreme cold](/traps-hazards/extreme-cold-xdmg.md).\
      \ Any water in that area is [frigid water](/traps-hazards/frigid-water-xdmg.md).\
      \ See the \"Dungeon Master's Guide\" for rules on extreme cold and frigid water.\
      \  \n- **Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](/rules/variant-rules/lightly-obscured-xphb.md)\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 14, each creature in a 30-foot-radius\
      ...
      \ point the dragon can see within 120 feet. *Failure:* 7 (2d6) Cold damage,\
      \ and the target's [Speed](/rules/variant-rules/speed-xphb.md) is 0 until the\
      \ end of the target's next turn. *Failure or Success:* The dragon can't take\
  ...
  - "desc": "The dragon moves up to half its [Speed](/rules/variant-rules/speed-xphb.md),\
    ...
    "name": "Pounce"
  - "desc": "The dragon casts [Fear](/spells/fear-xphb.md), requiring no Material\
