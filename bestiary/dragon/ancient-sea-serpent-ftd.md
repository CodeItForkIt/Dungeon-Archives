...
- "Ancient Sea Serpent"
---
# [Ancient Sea Serpent](/bestiary/dragon/ancient-sea-serpent-ftd.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 20 ft., one creature. *Hit:*\
      \ 29 (4d10 + 7) bludgeoning damage, and the target is [grappled](/rules/conditions.md#Grappled)\
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 20 ft., one target. *Hit:*\
      ...
      \ sea serpent and knocked [prone](/rules/conditions.md#Prone)."
    "name": "Tail"
