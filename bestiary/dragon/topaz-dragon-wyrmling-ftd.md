...
---
# [Topaz Dragon Wyrmling](/bestiary/dragon/topaz-dragon-wyrmling-ftd.md)
...
| 3 | A topaz dragon wyrmling has developed a taste for crab meat and persistently hunts a giant crab that always manages to evade the wyrmling. (The crab might have been the recipient of a druid's [awaken](/spells/awaken-xphb.md) spell.) |
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      **1/day each:** [bane](/spells/bane-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Topaz%20Dragon%20Wyrmling.webp"
```
^statblock