...
- "Adult Gold Dragon"
---
# [Adult Gold Dragon](/bestiary/dragon/adult-gold-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +14, reach 10 ft. *Hit:* 17 (2d8 + 8) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 21, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "*Strength Saving Throw:* DC 21, each creature that isn't currently affected\
      ...
      \ 3 (1d6) from its damage rolls. It repeats the save at the end of each of\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Guiding Bolt](/spells/guiding-bolt-xphb.md) (level 2 version), [Shapechange](/spells/shapechange-xphb.md)\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 21, one creature the dragon can see within\
      \ 120 feet. *Failure:* 10 (3d6) Force damage, and the target has the [Incapacitated](/rules/conditions.md#Incapacitated)\
