...
---
# [Gold Dragon Wyrmling](/bestiary/dragon/gold-dragon-wyrmling-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 9 (1d10 + 4) Slashing\
      \ damage."
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 13, each creature in a 15-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "*Strength Saving Throw:* DC 13, each creature that isn't currently affected\
      ...
      \ 2 (1d4) from its damage rolls. It repeats the save at the end of each of\
