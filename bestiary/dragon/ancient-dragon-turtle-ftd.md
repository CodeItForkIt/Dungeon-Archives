...
---
# [Ancient Dragon Turtle](/bestiary/dragon/ancient-dragon-turtle-ftd.md)
...
| 3 | A [geas](/spells/geas-xphb.md) spell forces an ancient dragon turtle to carry a lich's tower. |
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 15 ft., one target. *Hit:*\
      ...
      \ on a DC 24 Strength saving throw or be knocked [prone](/rules/conditions.md#Prone)."
    "name": "Tail"
...
"lair_actions":
  - "desc": "As they are presented in the *Monster Manual*, dragon turtles don't have\
      ...
      \ area must succeed on a DC 15 Strength saving throw or be [restrained](/rules/conditions.md#Restrained)\
