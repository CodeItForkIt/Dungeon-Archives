...
- "Adult Brass Dragon"
---
# [Adult Brass Dragon](/bestiary/dragon/adult-brass-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 60-foot-long, 5-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 45 (10d8)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Scorching Ray](/spells/scorching-ray-xphb.md), [Shapechange](/spells/shapechange-xphb.md)\
      ...
      \n**1/day each:** [Detect Thoughts](/spells/detect-thoughts-xphb.md), [Control\
      \ Weather](/spells/control-weather-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
...
"legendary_actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 16, one creature the dragon can see within\
      \ 120 feet. *Failure:* 27 (6d8) Fire damage, and the target's [Speed](/rules/variant-rules/speed-xphb.md)\
