...
---
# [Ancient Copper Dragon](/bestiary/dragon/ancient-copper-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Slowing Breath or (B) Spellcasting to cast [Mind Spike](/spells/mind-spike-xphb.md)\
      \ (level 5 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 22, each creature in an 90-foot-long, 10-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 63 (14d8)\
  ...
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 90-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target can't take Reactions; its [Speed](/rules/variant-rules/speed-xphb.md)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Magic](/spells/detect-magic-xphb.md), [Mind Spike](/spells/mind-spike-xphb.md)\
      \ (level 5 version), [Minor Illusion](/spells/minor-illusion-xphb.md), [Shapechange](/spells/shapechange-xphb.md)\
      ...
      \ [Major Image](/spells/major-image-xphb.md), [Project Image](/spells/project-image-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient copper dragon's lair is changed\
      ...
      \ on a [D20 Test](/rules/variant-rules/d20-test-xphb.md), it must succeed on\
      \ a DC 15 Wisdom saving throw or have the [Incapacitated](/rules/conditions.md#Incapacitated)\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 21, one creature the dragon can see within\
      ...
      \ roll and subtracts the number rolled from the [D20 Test](/rules/variant-rules/d20-test-xphb.md).\
      \ *Failure or Success:* The dragon can't take this action again until the start\
      \ of its next turn."
    "name": "Giggling Magic"
  - "desc": "The dragon uses Spellcasting to cast [Mind Spike](/spells/mind-spike-xphb.md)\
