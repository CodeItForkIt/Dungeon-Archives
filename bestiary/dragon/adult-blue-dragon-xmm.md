...
- "Adult Blue Dragon"
---
# [Adult Blue Dragon](/bestiary/dragon/adult-blue-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Shatter](/spells/shatter-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 19, each creature in a 90-foot-long, 5-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 60 (11d10)\
