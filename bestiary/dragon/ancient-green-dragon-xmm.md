...
---
# [Ancient Green Dragon](/bestiary/dragon/ancient-green-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Mind Spike](/spells/mind-spike-xphb.md) (level\
      \ 5 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 5 version)\n\n**1/day each:** [Geas](/spells/geas-xphb.md), [Modify\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient green dragon's lair is warped\
      ...
      \ a [Long Rest](/rules/variant-rules/long-rest-xphb.md) in that area, it must\
      \ succeed on a DC 15 Constitution saving throw or have the [Poisoned](/rules/conditions.md#Poisoned)\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 21, each creature in a 30-foot-radius\
      ...
      \ point the dragon can see within 90 feet. *Failure:* 17 (5d6) Poison damage,\
