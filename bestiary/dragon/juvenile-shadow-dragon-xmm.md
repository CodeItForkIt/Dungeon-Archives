...
---
# [Juvenile Shadow Dragon](/bestiary/dragon/juvenile-shadow-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 10 ft. *Hit:* 7 (1d8 + 3) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 13, each creature in a 30-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      ...
      \ from its corpse. The shadow is under the dragon's control and shares the dragon's\
