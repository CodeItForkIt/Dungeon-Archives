...
- "Shadow Dragon"
---
# [Shadow Dragon](/bestiary/dragon/shadow-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 17, each creature in a 60-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 35 (10d6) Necrotic damage. *Success:* Half damage. *Failure or\
      \ Success:* A Humanoid reduced to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      \ by this damage dies, and a [Shadow](/bestiary/undead/shadow-xmm.md) rises\
      \ from the corpse. The shadow is under the dragon's control and shares the dragon's\
      \ [Initiative](/rules/variant-rules/initiative-xphb.md) count but acts immediately\
      \ after the dragon."
    "name": "Shadow Breath (Recharge 5-6)"
"bonus_actions":
  - "desc": "While in [Dim Light](/rules/variant-rules/dim-light-xphb.md) or [Darkness](/rules/variant-rules/darkness-xphb.md),\
      \ the dragon takes the [Hide](/rules/actions.md#Hide) action."
    "name": "Shadow Stealth"
"regional_effects":
  - "desc": "The region around a shadow dragon's lair is twisted by its presence,\
      ...
      \ normally create [Bright Light](/rules/variant-rules/bright-light-xphb.md)\
      \ instead create [Dim Light](/rules/variant-rules/dim-light-xphb.md), and creatures\
      \ there have [Advantage](/rules/variant-rules/advantage-xphb.md) on Dexterity\
      \ ([Stealth](/rules/skills.md#Stealth)) checks.  \n\nIf the dragon dies or moves\
