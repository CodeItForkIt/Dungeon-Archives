...
---
# [Ancient Amethyst Dragon](/bestiary/dragon/ancient-amethyst-dragon-ftd.md)
...
"condition_immunities": "[frightened](/rules/conditions.md#Frightened), [prone](/rules/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      \ to hit with spell attacks):\n\n**1/day each:** [blink](/spells/blink-xphb.md),\
      \ [control water](/spells/control-water-xphb.md), [dispel magic](/spells/dispel-magic-xphb.md),\
      \ [freedom of movement](/spells/freedom-of-movement-xphb.md), [globe of invulnerability](/spells/globe-of-invulnerability-xphb.md),\
      \ [plane shift](/spells/plane-shift-xphb.md), [protection from evil and good](/spells/protection-from-evil-and-good-xphb.md),\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon can take\
      ...
      \ dragon casts the [forcecage](/spells/forcecage-xphb.md) spell, using its spell\
      ...
      \ and the chosen space simultaneously until initiative count 20 on the next\
...
"regional_effects":
  - "desc": "The region surrounding a legendary amethyst dragon's lair is altered\
      ...
      - **Background Check.** Once per day, the dragon can cast the [legend lore](/spells/legend-lore-xphb.md)\
      ...
      \ presence. As an action, the dragon can cast the [clairvoyance](/spells/clairvoyance-xphb.md)\
...
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Ancient%20Amethyst%20Dragon.webp"
```
^statblock