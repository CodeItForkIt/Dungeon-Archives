...
- "Ancient Gold Dragon"
---
# [Ancient Gold Dragon](/bestiary/dragon/ancient-gold-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Spellcasting to cast [Guiding Bolt](/spells/guiding-bolt-xphb.md)\
  ...
  - "desc": "*Melee Attack Roll:* +17 to hit, reach 15 ft. *Hit:* 19 (2d8 + 10)\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 24, each creature in a 90-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "*Strength Saving Throw:* DC 24, each creature that isn't currently affected\
      ...
      \ on Strength-based [D20 Tests](/rules/variant-rules/d20-test-xphb.md) and subtracts\
      \ 5 (1d10) from its damage rolls. It repeats the save at the end of each of\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Guiding Bolt](/spells/guiding-bolt-xphb.md) (level 4 version), [Shapechange](/spells/shapechange-xphb.md)\
      ...
      \ required to maintain the spell)\n\n**1/day each:** [Flame Strike](/spells/flame-strike-xphb.md)\
      \ (level 6 version), [Word of Recall](/spells/word-of-recall-xphb.md), [Zone\
      \ of Truth](/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient gold dragon's lair is altered\
      \ by its presence, creating the following effects:\n\n- **Dream Messenger.**\
      \ While in its lair, the dragon can cast [Dream](/spells/dream-xphb.md), requiring\
      \ no Material components and using Charisma as the spellcasting ability. When\
      \ casting the spell this way, the dragon can target any creature within 6 miles.\
      \  \n- **Foretelling Fog.** The area within 1 mile of the lair is [Lightly Obscured](/rules/variant-rules/lightly-obscured-xphb.md)\
      \ by opalescent fog. While in that area, creatures can't be [surprised](/rules/conditions.md#Surprised),\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 24, one creature the dragon can see within\
      \ 120 feet. *Failure:* 24 (7d6) Force damage, and the target has the [Incapacitated](/rules/conditions.md#Incapacitated)\
    ...
    "name": "Banish"
  - "desc": "The dragon uses Spellcasting to cast [Guiding Bolt](/spells/guiding-bolt-xphb.md)\
      \ (level 4 version)."
    "name": "Guiding Light"
