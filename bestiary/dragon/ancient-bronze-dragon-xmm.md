...
---
# [Ancient Bronze Dragon](/bestiary/dragon/ancient-bronze-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Repulsion Breath or (B) Spellcasting to cast [Guiding Bolt](/spells/guiding-bolt-xphb.md)\
      \ (level 2 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 23, each creature in a 120-foot-long, 10-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 82 (15d10)\
      \ Lightning damage. *Success:* Half damage."
    "name": "Lightning Breath (Recharge 5-6)"
  - "desc": "*Strength Saving Throw:* DC 23, each creature in a 30-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Control Water](/spells/control-water-xphb.md), [Scrying](/spells/scrying-xphb.md),\
      \ [Water Breathing](/spells/water-breathing-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient bronze dragon's lair is changed\
      \ by its presence, creating the following effects:\n\n- **Buoying Currents.**\
      \ Creatures within 1 mile of the lair that lack a [Swim Speed](/rules/variant-rules/swim-speed-xphb.md)\
      \ ignore the extra cost of movement while swimming.  \n- **Sun and Storms.**\
      \ While in its lair, the dragon can cast [Control Weather](/spells/control-weather-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 20-foot-radius\
      ...
      \ point the dragon can see within 120 feet. *Failure:* 13 (3d8) Thunder damage,\
      \ and the target has the [Deafened](/rules/conditions.md#Deafened) condition\
