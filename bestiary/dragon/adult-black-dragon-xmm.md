...
- "Adult Black Dragon"
---
# [Adult Black Dragon](/bestiary/dragon/adult-black-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Melf's Acid Arrow](/spells/melfs-acid-arrow-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 60-foot-long, 5-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 54 (12d8)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Fear](/spells/fear-xphb.md), [Melf's Acid Arrow](/spells/melfs-acid-arrow-xphb.md)\
      \ (level 3 version)\n\n**1/day each:** [Speak with Dead](/spells/speak-with-dead-xphb.md),\
      \ [Vitriolic Sphere](/spells/vitriolic-sphere-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient black dragon's lair is warped\
      ...
      \ area [Lightly Obscured](/rules/variant-rules/lightly-obscured-xphb.md). Travel\
      \ for creatures other than the dragon and its allies takes twice the usual time\
      \ in that area.  \n- **Foul Water.** Water sources within 1 mile of the lair\
      \ are supernaturally fouled. A creature that drinks such water must succeed\
      \ on a DC 15 Constitution saving throw or have the [Poisoned](/rules/conditions.md#Poisoned)\
...
"legendary_actions":
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the dragon can see within\
      \ 120 feet. *Failure:* 22 (4d10) Poison damage, and the target has [Disadvantage](/rules/variant-rules/disadvantage-xphb.md)\
  ...
  - "desc": "The dragon uses Spellcasting to cast [Fear](/spells/fear-xphb.md). The\
