...
- "Ancient Red Dragon"
---
# [Ancient Red Dragon](/bestiary/dragon/ancient-red-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Scorching Ray](/spells/scorching-ray-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 2 version), [Detect Magic](/spells/detect-magic-xphb.md), [Scorching\
      \ Ray](/spells/scorching-ray-xphb.md) (level 3 version)\n\n**1/day each:** [Fireball](/spells/fireball-xphb.md)\
      \ (level 6 version), [Scrying](/spells/scrying-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient red dragon's lair is warped\
      ...
      \ Obscured](/rules/variant-rules/lightly-obscured-xphb.md) with clouds of ash.\
      \ Whenever a creature other than the dragon or one of its allies finishes a\
      \ [Long Rest](/rules/variant-rules/long-rest-xphb.md) in that area, that creature\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Command](/spells/command-xphb.md)\
