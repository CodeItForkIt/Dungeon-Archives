...
---
# [Ancient Brass Dragon](/bestiary/dragon/ancient-brass-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Sleep Breath or (B) Spellcasting to cast [Scorching Ray](/spells/scorching-ray-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 21, each creature in a 90-foot-long, 5-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 58 (13d8)\
      \ Fire damage. *Success:* Half damage."
    "name": "Fire Breath (Recharge 5-6)"
  - "desc": "*Constitution Saving Throw:* DC 21, each creature in a 90-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      ...
      \ *2Nd Failure:* The target has the [Unconscious](/rules/conditions.md#Unconscious)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Magic](/spells/detect-magic-xphb.md), [Minor Illusion](/spells/minor-illusion-xphb.md),\
      \ [Scorching Ray](/spells/scorching-ray-xphb.md) (level 3 version), [Shapechange](/spells/shapechange-xphb.md)\
      ...
      \ required to maintain the spell), [Speak with Animals](/spells/speak-with-animals-xphb.md)\n\
      \n**1/day each:** [Control Weather](/spells/control-weather-xphb.md), [Detect\
      \ Thoughts](/spells/detect-thoughts-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The area containing an adult or ancient brass dragon's lair is altered\
      \ by its presence, creating the following effects:\n\n- **Mirages.** While in\
      \ its lair, the dragon can cast [Major Image](/spells/major-image-xphb.md),\
      ...
      \ refreshing. A creature that drinks such water gains 2d4 [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md),\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Scorching Ray](/spells/scorching-ray-xphb.md)\
      \ (level 3 version)."
    "name": "Blazing Light"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 20, one creature the dragon can see within\
      \ 120 feet. *Failure:* 36 (8d8) Fire damage, and the target's [Speed](/rules/variant-rules/speed-xphb.md)\
