...
---
# [Ancient Silver Dragon](/bestiary/dragon/ancient-silver-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Paralyzing Breath or (B) Spellcasting to cast [Ice Knife](/spells/ice-knife-xphb.md)\
      \ (level 2 version)."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +17, reach 15 ft. *Hit:* 19 (2d8 + 10) Slashing\
      \ damage plus 9 (2d8) Cold damage."
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 24, each creature in a 90-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 67 (15d8) Cold damage. *Success:* Half damage."
    "name": "Cold Breath (Recharge 5-6)"
  - "desc": "*Constitution Saving Throw:* DC 24, each creature in a 90-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *1St Failure:* The target has the [Incapacitated](/rules/conditions.md#Incapacitated)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Hold Monster](/spells/hold-monster-xphb.md), [Ice Knife](/spells/ice-knife-xphb.md)\
      \ (level 2 version), [Shapechange](/spells/shapechange-xphb.md) (Beast or Humanoid\
      \ form only, no [Temporary Hit Points](/rules/variant-rules/temporary-hit-points-xphb.md)\
      ...
      \ [Ice Storm](/spells/ice-storm-xphb.md) (level 7 version), [Teleport](/spells/teleport-xphb.md),\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient silver dragon's lair is changed\
      ...
      \ and Storms.** While in its lair, the dragon can cast [Control Weather](/spells/control-weather-xphb.md),\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Hold Monster](/spells/hold-monster-xphb.md).\
      \ The dragon can't take this action again until the start of its next turn."
    "name": "Chill"
  - "desc": "*Dexterity Saving Throw:* DC 23, each creature in a 60-foot-long, 10-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 14 (4d6)\
      \ Cold damage, and the target is pushed up to 30 feet straight away from the\
      \ dragon. *Success:* Half damage only. *Failure or Success:* The dragon can't\
