...
- "Copper Greatwyrm"
---
# [Copper Greatwyrm](/bestiary/dragon/copper-greatwyrm-ftd.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +18 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ it is [grappled](/rules/conditions.md#Grappled) (escape DC 20) and is [restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "*Melee Weapon Attack:* +18 to hit, reach 20 ft., one target. *Hit:*\
      ...
      \ succeed on a DC 26 Strength saving throw or be knocked [prone](/rules/conditions.md#Prone)."
    "name": "Tail"
  - "desc": "The greatwyrm uses one of the following breath weapons:\n\n- **Elemental\
      ...
      \ a failed save, the creature falls [unconscious](/rules/conditions.md#Unconscious)\
      \ for 1 minute. On a successful save, the creature has disadvantage on attack\
      \ rolls and saving throws until the end of the greatwyrm's next turn. An [unconscious](/rules/conditions.md#Unconscious)\
...
"mythic_actions":
  ...
  - "desc": "The greatwyrm unleashes a magical roar. Each creature in a 120-foot-radius\
      ...
      \ throw or take 19 (3d12) thunder damage and be [incapacitated](/rules/conditions.md#Incapacitated)\
      \ until the end of its next turn."
    "name": "Shattering Roar (Costs 2 Actions)"
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Copper%20Greatwyrm.webp"
```
^statblock