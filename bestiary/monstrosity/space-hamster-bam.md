...
- "Space Hamster"
---
# [Space Hamster](/bestiary/monstrosity/space-hamster-bam.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one creature. *Hit:*\
      ...
      \ saving throw or be [blinded](/rules/conditions.md#Blinded) until the start\
      \ of the hamster's next turn."
    "name": "Go for the Eyes (Recharge 6)"
"bonus_actions":
  - "desc": "The hamster takes the [Dash](/rules/actions.md#Dash) or [Disengage](/rules/actions.md#Disengage)\
      \ action."
    "name": "Escape"
"source":
  - "BAM"
