...
- "Sea Spawn"
---
# [Sea Spawn](/bestiary/monstrosity/sea-spawn-mpmm.md)
...
[Krakens](/bestiary/monstrosity/kraken-xmm.md), morkoths, [sea hags](/bestiary/fey/sea-hag-xmm.md), [marids](/bestiary/elemental/marid-xmm.md), [storm giants](/bestiary/giant/storm-giant-xmm.md), [dragon turtles](/bestiary/dragon/dragon-turtle-xmm.md)—all of these and more can mark mortals as their own and claim them as minions. Unlucky folk might become beholden to such a master through a bleak bargain, or they might find themselves cursed by one. Once warped into a fishlike form, a sea spawn can't leave the water for long without courting death.
...
"actions":
  ...
  - "desc": "The sea spawn uses one of the following options (choose one or roll a\
      ...
      \ on itself on a success.  \n- **5–6 Tentacle.** *Melee Weapon Attack:* +4\
      \ to hit, reach 10 ft., one target. *Hit:* 5 (1d6 + 2) bludgeoning damage,\
      \ and the target is [grappled](/rules/conditions.md#Grappled) (escape DC 12)\
      \ if it is a Medium or smaller creature. Until this grapple ends, the sea spawn\
      \ can't use this tentacle on another target.  "
    "name": "Piscine Anatomy"
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Sea%20Spawn.webp"
```
^statblock
