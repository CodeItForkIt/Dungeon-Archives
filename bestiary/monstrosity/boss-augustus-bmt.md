...
- "Boss Augustus"
---
# [Boss Augustus](/bestiary/monstrosity/boss-augustus-bmt.md)
...
"traits":
  - "desc": "Augustus regains 10 hit points at the start of his turn. If he takes\
      ...
      \ doesn't regenerate."
    "name": "Regeneration"
  - "desc": "Augustus wields a [+2 Longsword](/items/2-weapon-xdmg.md)."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 26\
      ...
      \ on a DC 15 Constitution saving throw or be cursed with [lycanthropy](/rules/variant-rules/player-characters-as-lycanthropes-mm.md).\
      ...
      \ remains so until the night ends. A [Remove Curse](/spells/remove-curse-xphb.md)\
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 21\
      ...
      \ on a DC 16 Strength saving throw or have the [prone](/rules/conditions.md#Prone)\
      \ condition."
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Boss%20Augustus.webp"
```
^statblock