...
- "Behir"
---
# [Behir](/bestiary/monstrosity/behir-xmm.md)
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 18, one Large or smaller creature the behir\
      ...
      \ has the [Grappled](/rules/conditions.md#Grappled) condition (escape DC 16),\
  ...
  - "desc": "*Dexterity Saving Throw:* DC 16, each creature in a 90-foot-long, 5-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 66 (12d10)\
...
"bonus_actions":
  - "desc": "*Dexterity Saving Throw:* DC 18, one Large or smaller creature [Grappled](/rules/conditions.md#Grappled)\
      ...
      \ While swallowed, a creature has the [Blinded](/rules/conditions.md#Blinded)\
      \ and [Restrained](/rules/conditions.md#Restrained) conditions, has [Total Cover](/rules/variant-rules/cover-xphb.md)\
      ...
      \ behir and has the [Prone](/rules/conditions.md#Prone) condition. If the behir\
