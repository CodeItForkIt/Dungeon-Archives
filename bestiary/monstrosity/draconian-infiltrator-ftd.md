...
---
# [Draconian Infiltrator](/bestiary/monstrosity/draconian-infiltrator-ftd.md)
...
"actions":
  - "desc": "The draconian makes two Dagger attacks. If both attacks hit the same\
      ...
      \ become [poisoned](/rules/conditions.md#Poisoned) until the end of the target's\
      \ next turn. While [poisoned](/rules/conditions.md#Poisoned) in this way, the\
      \ target is also [paralyzed](/rules/conditions.md#Paralyzed)."
    "name": "Multiattack"
...
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Draconian%20Infiltrator.webp"
```
^statblock