...
- "Medusa"
---
# [Medusa](/bestiary/monstrosity/medusa-mot.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +3 to hit, reach 10 ft., one target. *Hit:*\
      \ 7 (2d6) bludgeoning damage, and the target is [grappled](/rules/conditions.md#Grappled)\
...
"source":
  - "MOT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MOT/Medusa.webp"
```
^statblock