...
- "Creeper"
---
# [Creeper](/bestiary/monstrosity/creeper-mcv3mc.md)
...
"cr": "1/2"
"traits":
  - "desc": "The creeper can't take actions except for [Dash](/rules/actions.md#Dash),\
      \ [Disengage](/rules/actions.md#Disengage), [Hide](/rules/actions.md#Hide),\
      \ and [Search](/rules/actions.md#Search). It can't take bonus actions or reactions."
  ...
  - "desc": "The creeper has the [frightened](/rules/conditions.md#Frightened) condition\
      \ whenever it starts its turn within 60 feet of a feline creature it can see.\
      \ The condition lasts until the start of the creeper's next turn."
