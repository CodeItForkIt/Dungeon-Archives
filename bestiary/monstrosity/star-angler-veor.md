...
- "Star Angler"
---
# [Star Angler](/bestiary/monstrosity/star-angler-veor.md)
...
"bonus_actions":
  - "desc": "The star angler's lure flares with enchanting starlight, targeting one\
      ...
      \ succeed on a DC 13 Wisdom saving throw or have the [charmed](/rules/conditions.md#Charmed)\
      \ condition until the start of the star angler's next turn. While [charmed](/rules/conditions.md#Charmed)\
      \ in this way, the target has the [incapacitated](/rules/conditions.md#Incapacitated)\
      \ condition and must use its movement on its turn to move directly toward the\
      \ star angler; a [charmed](/rules/conditions.md#Charmed) target doesn't avoid\
      \ opportunity attacks, but it does avoid damaging terrain. A target can be [charmed](/rules/conditions.md#Charmed)\
      \ by only one star angler at a time."
    "name": "Lure Charm"
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Star%20Angler.webp"
```
^statblock