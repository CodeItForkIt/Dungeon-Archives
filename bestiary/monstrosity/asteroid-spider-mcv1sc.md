...
- "Asteroid Spider"
---
# [Asteroid Spider](/bestiary/monstrosity/asteroid-spider-mcv1sc.md)
...
"skillsaves":
  ...
  - "name": "[Stealth](/rules/skills.md#Stealth)"
    "desc": "+5"
"senses": "[blindsight](/rules/senses.md#Blindsight) 120 ft. while the spider's eyes\
  \ are closed, [darkvision](/rules/senses.md#Darkvision) 120 ft., passive Perception\
  \ 21"
"languages": ""
"cr": "15"
"traits":
  - "desc": "If the spider is motionless, has its eyes and mouth closed, and has its\
      ...
      \ act, that creature must succeed on a DC 18 Intelligence ([Investigation](/rules/skills.md#Investigation))\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +13 to hit, reach 10 ft., one target. *Hit:*\
      \ 21 (3d8 + 8) piercing damage plus 10 (3d6) acid damage."
    "name": "Bite"
  - "desc": "*Ranged Weapon Attack:* +13 to hit, reach 120 ft., one creature. *Hit:*\
      \ The target is [grappled](/rules/conditions.md#Grappled) (escape DC 18). The\
      \ web strand can be attacked and destroyed (AC 12; 20 hit points; vulnerability\
      \ to fire damage; immunity to bludgeoning, poison, and psychic damage). The\
      \ spider can grapple up to six creatures at a time using its web strands."
    "name": "Web Strand"
...
"bonus_actions":
  - "desc": "The spider weaves a magical web around a spelljamming ship it can see\
      ...
      \ [dispel magic](/spells/dispel-magic-xphb.md) (DC 18)."
    "name": "Snare Ship (1/Day)"
"source":
  - "MCV1SC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MCV1SC/Asteroid%20Spider.webp"
```
^statblock