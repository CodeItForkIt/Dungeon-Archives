...
---
# [Yuan-ti Nightmare Speaker](/bestiary/monstrosity/yuan-ti-nightmare-speaker-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 10 ft., one target. *Hit:*\
      \ 10 (2d6 + 3) bludgeoning damage, and the target is [grappled](/rules/conditions.md#Grappled)\
  ...
  - "desc": "The yuan-ti casts one of the following spells, requiring no material\
      ...
      \ only), [mage hand](/spells/mage-hand-xphb.md), [message](/spells/message-xphb.md),\
      \ [prestidigitation](/spells/prestidigitation-xphb.md)\n\n**3/day:** [suggestion](/spells/suggestion-xphb.md)\n\
      \n**2/day each:** [darkness](/spells/darkness-xphb.md), [fear](/spells/fear-xphb.md)"
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Yuan-ti%20Nightmare%20Speaker.webp"
```
^statblock
