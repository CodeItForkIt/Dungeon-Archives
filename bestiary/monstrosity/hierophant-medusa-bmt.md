...
- "Hierophant Medusa"
---
# [Hierophant Medusa](/bestiary/monstrosity/hierophant-medusa-bmt.md)
...
"cr": "17"
"traits":
  - "desc": "The medusa can cast the [Resurrection](/spells/resurrection-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ DC 20). Until this grapple ends, the target has the [restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The medusa casts one of the following spells, requiring no material components\
      ...
      \ [Light](/spells/light-xphb.md), [Spare the Dying](/spells/spare-the-dying-xphb.md),\
      \ [Thaumaturgy](/spells/thaumaturgy-xphb.md)\n\n**2/day:** [Mass Cure Wounds](/spells/mass-cure-wounds-xphb.md)\
      \ (cast at 8th level)\n\n**1/day each:** [Blade Barrier](/spells/blade-barrier-xphb.md),\
      \ [Divination](/spells/divination-xphb.md), [Greater Restoration](/spells/greater-restoration-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The medusa unleashes petrifying magic from its eyes in a 30-foot cone.\
      ...
      \ it doesn't have the [blinded](/rules/conditions.md#Blinded) condition. If\
      \ the saving throw fails by 5 or more, the creature has the [petrified](/rules/conditions.md#Petrified)\
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Hierophant%20Medusa.webp"
```
^statblock