...
- "Ironscale Hydra"
---
# [Ironscale Hydra](/bestiary/monstrosity/ironscale-hydra-mot.md)
...
"traits":
  ...
  - "desc": "The hydra has five heads. While it has more than one head, the hydra\
      ...
      \ heads die, the hydra dies. At the end of its turn, it grows two heads for\
      \ each of its heads that died since its last turn, unless it has taken fire\
      \ damage since its last turn. The hydra regains 10 hit points for each head\
      \ regrown in this way."
    "name": "Multiple Heads"
