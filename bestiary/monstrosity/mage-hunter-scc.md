...
- "Mage Hunter"
---
# [Mage Hunter](/bestiary/monstrosity/mage-hunter-scc.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:*\
      \ 22 (4d8 + 4) piercing damage, and the target is [grappled](/rules/conditions.md#Grappled)\
  ...
  - "desc": "The hunter emits a pulse of energy that helps it better locate its magical\
      ...
      \ from the hunter and gains no benefit from the [invisible](/rules/conditions.md#Invisible)\
...
"source":
  - "SCC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SCC/Mage%20Hunter.webp"
```
^statblock