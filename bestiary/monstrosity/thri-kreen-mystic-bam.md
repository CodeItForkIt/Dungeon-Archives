...
- "Thri-kreen Mystic"
---
# [Thri-kreen Mystic](/bestiary/monstrosity/thri-kreen-mystic-bam.md)
...
"actions":
  ...
  - "desc": "The thri-kreen casts one of the following spells, requiring no spell\
      \ components and using Wisdom as the spellcasting ability:\n\n**At will:** [levitate](/spells/levitate-xphb.md)\
      \ (self only), [mage hand](/spells/mage-hand-xphb.md) (the hand is invisible)\n\
      \n**1/day each:** [freedom of movement](/spells/freedom-of-movement-xphb.md)\
      \ (self only), [invisibility](/spells/invisibility-xphb.md) (self only)"
    "name": "Spellcasting (Psionics)"
"bonus_actions":
  - "desc": "The thri-kreen changes the color of its carapace to match the color and\
      \ texture of its surroundings, gaining advantage on Dexterity ([Stealth](/rules/skills.md#Stealth))\
