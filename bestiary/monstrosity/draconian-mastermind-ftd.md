...
---
# [Draconian Mastermind](/bestiary/monstrosity/draconian-mastermind-ftd.md)
...
"traits":
  - "desc": "When the draconian is reduced to 0 hit points, its magical essence lashes\
      ...
      \ takes 9 (2d8) lightning damage and is [stunned](/rules/conditions.md#Stunned)\
...
"actions":
  ...
  - "desc": "The draconian exhales a 15-foot cone of noxious gas. Each creature in\
      ...
      \ creature takes 21 (6d6) poison damage and gains 1 level of [exhaustion](/rules/conditions.md#Exhaustion).\
      \ On a successful save, the creature takes half as much damage, doesn't gain\
      \ [exhaustion](/rules/conditions.md#Exhaustion), and is immune to all draconians'\
  ...
  - "desc": "The draconian casts one of the following spells, requiring no material\
      ...
      \n**At will:** [invisibility](/spells/invisibility-xphb.md), [mage hand](/spells/mage-hand-xphb.md)\n\
      \n**2/day each:** [dimension door](/spells/dimension-door-xphb.md), [disguise\
      \ self](/spells/disguise-self-xphb.md), [sending](/spells/sending-xphb.md)"
    "name": "Spellcasting"
"reactions":
