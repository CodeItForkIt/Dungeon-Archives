...
- "Gray Render"
---
# [Gray Render](/bestiary/monstrosity/gray-render-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ target is [prone](/rules/conditions.md#Prone)."
    "name": "Claw"
"reactions":
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Gray%20Render.webp"
```
^statblock
