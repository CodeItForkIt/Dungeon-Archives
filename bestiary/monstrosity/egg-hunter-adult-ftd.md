...
- "Egg Hunter Adult"
---
# [Egg Hunter Adult](/bestiary/monstrosity/egg-hunter-adult-ftd.md)
...
"actions":
  ...
  - "desc": "The egg hunter releases a billow of sparkling blue spores. Each creature\
      ...
      \ 14 Constitution saving throw or be [poisoned](/rules/conditions.md#Poisoned)\
      \ for 1 minute. While [poisoned](/rules/conditions.md#Poisoned) in this way,\
      \ the creature can take either an action or a bonus action on its turn but not\
      \ both, and it can't take reactions. A creature can repeat the saving throw\
