...
- "Boss Delour"
---
# [Boss Delour](/bestiary/monstrosity/boss-delour-bmt.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 26\
      ...
      \ on a DC 14 Constitution saving throw or be cursed with [lycanthropy](/rules/variant-rules/player-characters-as-lycanthropes-mm.md).\
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Boss%20Delour.webp"
```
^statblock