...
- "Brown Scavver"
---
# [Brown Scavver](/bestiary/monstrosity/brown-scavver-bam.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 11\
      ...
      \ the swallowed creature, which falls [prone](/rules/conditions.md#Prone) in\
      \ a space within 10 feet of the scavver. If the scavver dies, a swallowed creature\
      \ is no longer [restrained](/rules/conditions.md#Restrained) by it and can escape\
      \ from the corpse by using 10 feet of movement, exiting [prone](/rules/conditions.md#Prone)."
