...
---
# [Draconian Foot Soldier](/bestiary/monstrosity/draconian-foot-soldier-ftd.md)
...
"traits":
  ...
  - "desc": "When the draconian is reduced to 0 hit points, its body turns to stone\
      ...
      \ must succeed on a DC 11 Constitution saving throw or be [restrained](/rules/conditions.md#Restrained)\
      ...
      \ the effect ends; otherwise the creature is [petrified](/rules/conditions.md#Petrified)\
...
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Draconian%20Foot%20Soldier.webp"
```
^statblock