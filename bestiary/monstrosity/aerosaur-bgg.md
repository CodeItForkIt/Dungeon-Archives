...
- "Aerosaur"
---
# [Aerosaur](/bestiary/monstrosity/aerosaur-bgg.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ 18). Until this grapple ends, the target has the [restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The aerosaur beats its wings, creating bursts of thunderous force. Each\
      ...
      \ up to 30 feet horizontally from the aerosaur, and has the [prone](/rules/conditions.md#Prone)\
