...
- "Hoard Mimic"
---
# [Hoard Mimic](/bestiary/monstrosity/hoard-mimic-ftd.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ creature adhered to the mimic is also [grappled](/rules/conditions.md#Grappled)\
      \ by it (escape DC 16). Until this grapple ends, the target is [restrained](/rules/conditions.md#Restrained).\
  ...
  - "desc": "The mimic sprays a fine mist of acid in a 30-foot cone. Each creature\
      ...
      \ creature takes 27 (6d8) acid damage and is [blinded](/rules/conditions.md#Blinded)\
...
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Hoard%20Mimic.webp"
```
^statblock