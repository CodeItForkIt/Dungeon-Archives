...
- "Achaierai"
---
# [Achaierai](/bestiary/monstrosity/achaierai-mabjov.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:*\
    ...
    "name": "Talons"
"bonus_actions":
  - "desc": "The achaierai takes the [Disengage](/rules/actions.md#Disengage) action."
    "name": "Spring Attack"
"reactions":
  - "desc": "After taking damage the achaierai can use its reaction to release a cloud\
      ...
      \ the target is confused as if from a [confusion](/spells/confusion-xphb.md)\
