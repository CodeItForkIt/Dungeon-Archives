...
- "Liondrake"
---
# [Liondrake](/bestiary/monstrosity/liondrake-ftd.md)
...
"actions":
  ...
  - "desc": "The liondrake lets out a terrifying roar audible out to 300 feet. Any\
      ...
      \ is also [paralyzed](/rules/conditions.md#Paralyzed) for the same duration.\
      \ A creature can repeat the saving throw at the end of its turns, ending the\
      \ effect on itself on a success. If a target's saving throw is successful or\
      \ the effect ends for it, the target is immune to this liondrake's Blood-Chilling\
      \ Roar for the next 24 hours."
    "name": "Blood-Chilling Roar (Recharge 4-6)"
"source":
  - "FTD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Liondrake.webp"
```
^statblock