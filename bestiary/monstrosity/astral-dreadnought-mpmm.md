...
- "Astral Dreadnought"
---
# [Astral Dreadnought](/bestiary/monstrosity/astral-dreadnought-mpmm.md)
...
"traits":
  - "desc": "The dreadnought's eye creates an area of antimagic, as in the [antimagic\
      \ field](/spells/antimagic-field-xphb.md) spell, in a 150-foot cone. At the\
      \ start of each of its turns, it decides which way the cone faces. The cone\
  ...
  - "desc": "Anything the dreadnought swallows is transported to a demiplane that\
      \ can be entered by no other means except a [wish](/spells/wish-xphb.md) spell\
      \ or the dreadnought's Bite and Donjon Visit. A creature can leave the demiplane\
      \ only by using magic that enables planar travel, such as the [plane shift](/spells/plane-shift-xphb.md)\
  ...
  - "desc": "If the dreadnought scores a critical hit against a creature traveling\
      \ by means of the [astral projection](/spells/astral-projection-xphb.md) spell,\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ and this damage reduces it to 0 hit points or it is [incapacitated](/rules/conditions.md#Incapacitated),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Astral%20Dreadnought.webp"
```
^statblock