...
- "Bone Whelk"
---
# [Bone Whelk](/bestiary/monstrosity/bone-whelk-bgdia.md)
...
"traits":
  - "desc": "The bone whelk can cause Medium or smaller objects to adhere to it. A\
      \ Medium or smaller creature that touches the bone whelk is [grappled](/rules/conditions.md#Grappled)\
      \ by it (escape DC 10)."
    "name": "Adhesive"
...
"source":
  - "BGDIA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BGDIA/Bone%20Whelk.webp"
```
^statblock