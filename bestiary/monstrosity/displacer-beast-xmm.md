...
- "Displacer Beast"
---
# [Displacer Beast](/bestiary/monstrosity/displacer-beast-xmm.md)
...
"traits":
  - "desc": "If the displacer beast is subjected to an effect that allows it to make\
      ...
      \ if it has the [Incapacitated](/rules/conditions.md#Incapacitated) condition."
    "name": "Avoidance"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 feet. *Hit:* 9 (1d10 + 4) Slashing\
      \ damage. If target is a Large or smaller creature, it has the [Prone](/rules/conditions.md#Prone)\
      \ condition."
    "name": "Rend"
