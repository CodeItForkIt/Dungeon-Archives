...
---
# [Reduced-Threat Remorhaz](/bestiary/monstrosity/reduced-threat-remorhaz-tftyp.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ is a creature, it is [grappled](/rules/conditions.md#Grappled) (escape DC\
      \ 15). Until this grapple ends, the target is [restrained](/rules/conditions.md#Restrained),\
  ...
  - "desc": "The remorhaz makes one bite attack against a Medium or smaller creature\
      ...
      \ must succeed on a DC 13 Constitution saving throw at the end of that turn\
...
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Reduced-Threat%20Remorhaz.webp"
```
^statblock