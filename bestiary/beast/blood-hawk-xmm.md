...
- "Blood Hawk"
---
# [Blood Hawk](/bestiary/beast/blood-hawk-xmm.md)
...
"cr": "1/8"
"traits":
  - "desc": "The hawk has [Advantage](/rules/variant-rules/advantage-xphb.md) on an\
      \ attack roll against a creature if at least one of the hawk's allies is within\
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Piercing\
      \ damage, or 6 (1d8 + 2) Piercing damage if the target is [Bloodied](/rules/conditions.md#Bloodied)."
    "name": "Beak"
"source":
  - "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Blood%20Hawk.webp"
```
^statblock
