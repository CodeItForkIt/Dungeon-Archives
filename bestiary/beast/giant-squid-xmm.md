...
- "Giant Squid"
---
# [Giant Squid](/bestiary/beast/giant-squid-xmm.md)
...
"reactions":
  - "desc": "Trigger: The squid takes damage while underwater. _Response:_ The squid\
      \ releases ink that fills a 15-foot [Cube](/rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ centered on itself, and the squid moves up to its [Swim Speed](/rules/variant-rules/swim-speed-xphb.md).\
      \ The [Cube](/rules/variant-rules/cube-area-of-effect-xphb.md) is [Heavily Obscured](/rules/variant-rules/heavily-obscured-xphb.md)\
