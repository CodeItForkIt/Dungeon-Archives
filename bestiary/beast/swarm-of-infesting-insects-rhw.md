...
---
# [Swarm of Infesting Insects](/bestiary/beast/swarm-of-infesting-insects-rhw.md)
*Source: RHW p. 271*  
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 12 (4d4 + 2) Poison damage,\
      \ or 7 (2d4 + 2) Poison damage if the swarm is [Bloodied](/rules/conditions.md#Bloodied),\
      \ and the target has the [Poisoned](/rules/conditions.md#Poisoned) condition.\
      \ If the target remains [Poisoned](/rules/conditions.md#Poisoned) in this way\
      \ after 1 hour, it is subjected to the following effect. *Constitution Saving\
      \ Throw:* DC 11. *Failure:* Roll 1d6: on a 1-2, the target has the [Blinded](/rules/conditions.md#Blinded)\
      \ condition; on a 3-4, the target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by 5 (1d10); on a 5-6, the target gains 1 [Exhaustion](/rules/conditions.md#Exhaustion)\
      \ level. The effect lasts until the [Poisoned](/rules/conditions.md#Poisoned)\
      \ condition ends. *Success:* The [Poisoned](/rules/conditions.md#Poisoned) condition\
      \ ends."
    "name": "Infestation"
"source":
  - "RHW"
