...
- "Allosaurus"
---
# [Allosaurus](/bestiary/beast/allosaurus-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 8 (1d8 + 4) Slashing\
      ...
      \ [Prone](/rules/conditions.md#Prone) condition, and the allosaurus can make\
      \ one Bite attack against it."
    "name": "Claws"
"source":
  - "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Allosaurus.webp"
```
^statblock
