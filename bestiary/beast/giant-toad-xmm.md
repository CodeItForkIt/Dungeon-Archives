...
- "Giant Toad"
---
# [Giant Toad](/bestiary/beast/giant-toad-xmm.md)
...
"traits":
  - "desc": "The toad can breathe air and water."
    "name": "Amphibious"
  - "desc": "The toad's [Long Jump](/rules/variant-rules/long-jump-xphb.md) is up\
...
"actions":
  ...
  - "desc": "The toad swallows a Medium or smaller target it is grappling. While swallowed,\
      ...
      \ outside the toad. In addition, the target takes 10 (3d6) Acid damage at\
      \ the end of each of the toad's turns. The toad can have only one target swallowed\
      \ at a time, and it can't use Bite while it has a swallowed target. If the toad\
...
"source":
  - "XMM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/XMM/Giant%20Toad.webp"
```
^statblock
