...
- "Gulthias Blight"
---
# [Gulthias Blight](/bestiary/plant/gulthias-blight-xmm.md)
...
"traits":
  - "desc": "When it finishes a [Long Rest](/rules/variant-rules/long-rest-xphb.md),\
      ...
      \ 1-4, [Twig Blight](/bestiary/plant/twig-blight-xmm.md); on 5-6, [Needle Blight](/bestiary/plant/needle-blight-xmm.md);\
      \ on 7-8, [Vine Blight](/bestiary/plant/vine-blight-xmm.md)."
    "name": "Blight Seeds"
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 20, one Huge or smaller creature the\
      ...
      \ and the target has the [Grappled](/rules/conditions.md#Grappled) condition\
      \ (escape DC 17) from one of six roots. Until the grapple ends, the target has\
      \ the [Restrained](/rules/conditions.md#Restrained) condition and takes 14 (4d6)\
      \ Necrotic damage at the start of each of its turns. The target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the Necrotic damage taken, and the\
      \ blight regains [Hit Points](/rules/variant-rules/hit-points-xphb.md) equal\
      \ to that amount."
