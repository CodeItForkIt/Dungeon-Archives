...
- "Aartuk Starhorror"
---
# [Aartuk Starhorror](/bestiary/plant/aartuk-starhorror-bam.md)
...
"actions":
  ...
  - "desc": "The aartuk casts one of the following spells, requiring no spell components\
      \ and using Wisdom as the spellcasting ability:\n\n**1/day each:** [revivify](/spells/revivify-xphb.md),\
      \ [speak with plants](/spells/speak-with-plants-xphb.md)"
    "name": "Spellcasting (Psionics)"
"bonus_actions":
  - "desc": "The aartuk magically ends the [charmed](/rules/conditions.md#Charmed)\
