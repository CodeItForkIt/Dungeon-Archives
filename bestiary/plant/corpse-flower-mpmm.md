...
- "Corpse Flower"
---
# [Corpse Flower](/bestiary/plant/corpse-flower-mpmm.md)
...
"bonus_actions":
  ...
  - "desc": "The corpse flower animates one corpse in its body, turning it into a\
      \ [zombie](/bestiary/undead/zombie-xmm.md). The zombie appears in an unoccupied\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Corpse%20Flower.webp"
```
^statblock
