...
- "Kelpie"
---
# [Kelpie](/bestiary/plant/kelpie-tftyp.md)
...
"actions":
  ...
  - "desc": "The kelpie chooses one humanoid it can see within 150 feet of it. If\
      ...
      \ maintains [concentration](/rules/conditions.md#Concentration), up to 10 minutes\
      \ (as if [concentrating](/rules/conditions.md#Concentration) on a spell). The\
      \ [charmed](/rules/conditions.md#Charmed) target is [incapacitated](/rules/conditions.md#Incapacitated),\
      \ and instead of holding its breath underwater, it tries to breathe normally\
      \ and immediately runs out of breath, unless it can breathe water. If the [charmed](/rules/conditions.md#Charmed)\
...
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Kelpie.webp"
```
^statblock