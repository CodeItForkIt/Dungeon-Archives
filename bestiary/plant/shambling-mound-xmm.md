...
- "Shambling Mound"
---
# [Shambling Mound](/bestiary/plant/shambling-mound-xmm.md)
...
"traits":
  - "desc": "Whenever the shambling mound is subjected to Lightning damage, it regains\
      \ a number of [Hit Points](/rules/variant-rules/hit-points-xphb.md) equal to\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Medium or smaller creature within\
      ...
      \ has the [Grappled](/rules/conditions.md#Grappled) condition (escape DC 14).\
      \ Until the grapple ends, the target has the [Blinded](/rules/conditions.md#Blinded)\
      \ and [Restrained](/rules/conditions.md#Restrained) conditions, and it takes\
      \ 10 (3d6) Lightning damage at the start of each of its turns. When the shambling\
