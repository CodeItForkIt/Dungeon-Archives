...
- "Gadabout"
---
# [Gadabout](/bestiary/plant/gadabout-mcv1sc.md)
...
"senses": "[blindsight](/rules/senses.md#Blindsight) 10 ft. (blind beyond this radius),\
  \ passive Perception 8"
"languages": ""
"cr": "1/8"
"traits":
  - "desc": "If it has at least 1 hit point, the gadabout can generate an air envelope\
      \ around itself when in a vacuum. This air envelope can sustain the gadabout\
      \ and one other creature in its space indefinitely."
    "name": "Air Envelope"
...
"actions":
  ...
  - "desc": "The gadabout enters the space of a willing Medium or Small creature within\
      ...
      \ is [grappled](/rules/conditions.md#Grappled) (escape DC 0). Any attempt by\
      \ the target to escape the grapple causes the gadabout to use its reaction to\
      \ move into the nearest unoccupied space. While [grappled](/rules/conditions.md#Grappled)\
...
"source":
  - "MCV1SC"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MCV1SC/Gadabout.webp"
```
^statblock