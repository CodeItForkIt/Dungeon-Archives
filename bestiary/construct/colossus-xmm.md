...
- "Colossus"
---
# [Colossus](/bestiary/construct/colossus-xmm.md)
...
"senses": "[Truesight](/rules/senses.md#Truesight) 300 ft., passive Perception 10"
...
"traits":
  ...
  - "desc": "The colossus has [Advantage](/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 26, each creature in a 300-foot-long, 10-foot-wide\
      \ [Line](/rules/variant-rules/line-area-of-effect-xphb.md). *Failure:* 65 (10d12)\
      \ Radiant damage. *Success:* Half damage. *Failure or Success:* A creature reduced\
      \ to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md) by this beam disintegrates\
      \ into dust, leaving behind any magic items it was wearing or carrying."
