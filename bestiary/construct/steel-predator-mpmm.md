...
- "Steel Predator"
---
# [Steel Predator](/bestiary/construct/steel-predator-mpmm.md)
...
"actions":
  ...
  - "desc": "The steel predator casts one of the following spells, requiring no spell\
      ...
      \ [dimension door](/spells/dimension-door-xphb.md) (self only), [plane shift](/spells/plane-shift-xphb.md)\
      \ (self only)"
    "name": "Spellcasting"
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Steel%20Predator.webp"
```
^statblock
