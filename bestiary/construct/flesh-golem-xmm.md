...
- "Flesh Golem"
---
# [Flesh Golem](/bestiary/construct/flesh-golem-xmm.md)
...
"traits":
  ...
  - "desc": "Whenever the golem starts its turn [Bloodied](/rules/conditions.md#Bloodied),\
      ...
      \ goes berserk, it remains so until it is destroyed or it is no longer [Bloodied](/rules/conditions.md#Bloodied).\n\
      \nThe golem's creator, if within 60 feet of the berserk golem, can try to calm\
      \ it by taking an action to make a DC 15 Charisma ([Persuasion](/rules/skills.md#Persuasion))\
      ...
      \ point it resumes rolling for the Berserk trait again if it is still [Bloodied](/rules/conditions.md#Bloodied)."
    "name": "Berserk"
  ...
  - "desc": "The golem has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
