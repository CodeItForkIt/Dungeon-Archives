...
- "Animated Coffin"
---
# [Animated Coffin](/bestiary/construct/animated-coffin-aatm.md)
...
"traits":
  - "desc": "If the animated coffin is motionless at the start of combat, it has advantage\
      \ on its initiative roll. Moreover, if a creature hasn't observed the coffin\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 12\
    ...
    "name": "Slam"
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one Large or smaller\
      \ creature. *Hit:* The target has the [grappled](/rules/conditions.md#Grappled)\
      \ condition (escape DC 13). Until this grapple ends, if the target is not an\
      \ Undead, the target has the [restrained](/rules/conditions.md#Restrained) condition\
