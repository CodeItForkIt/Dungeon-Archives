...
- "Stone Golem"
---
# [Stone Golem](/bestiary/construct/stone-golem-xmm.md)
...
| 2 | Cast [Slow](/spells/slow-xphb.md) on and aid in apprehending anyone who touches a city's prized relic. |
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +9, range 120 ft. *Hit:* 22 (4d10) Force damage."
    "name": "Force Bolt"
"bonus_actions":
  - "desc": "The golem casts the [Slow](/spells/slow-xphb.md) spell, requiring no\
      \ spell components and using Constitution as the spellcasting ability (spell\
      \ save DC 17).\n"
