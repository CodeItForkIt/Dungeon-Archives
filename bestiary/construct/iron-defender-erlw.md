...
- "Iron Defender"
---
# [Iron Defender](/bestiary/construct/iron-defender-erlw.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 6\
      ...
      \ and be [grappled](/rules/conditions.md#Grappled) (escape DC 13). The defender\
      \ can have only one creature [grappled](/rules/conditions.md#Grappled) in this\
      \ way at a time."
    "name": "Bite"
"source":
  - "ERLW"
