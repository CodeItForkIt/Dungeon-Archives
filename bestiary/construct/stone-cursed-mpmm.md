...
- "Stone Cursed"
---
# [Stone Cursed](/bestiary/construct/stone-cursed-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ [restrained](/rules/conditions.md#Restrained) until the end of its next turn,\
      \ when it must repeat the saving throw. The effect ends if the second save is\
      \ successful; otherwise the target is [petrified](/rules/conditions.md#Petrified)\
      \ for 24 hours."
    "name": "Petrifying Claws"
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Stone%20Cursed.webp"
```
^statblock
