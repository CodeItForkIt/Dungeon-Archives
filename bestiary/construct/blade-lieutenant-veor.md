...
- "Blade Lieutenant"
---
# [Blade Lieutenant](/bestiary/construct/blade-lieutenant-veor.md)
...
"traits":
  - "desc": "The lieutenant has advantage on an attack roll against a creature if\
      ...
      \ the ally doesn't have the [incapacitated](/rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Pack Tactics"
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +8 to hit, range 30/120 ft., one target. *Hit:*\
      \ 14 (3d6 + 4) piercing damage, and the target has the [prone](/rules/conditions.md#Prone)\
      \ condition."
...
"bonus_actions":
  - "desc": "The lieutenant targets one ally it can see within 30 feet of itself.\
    ...
    "name": "Command Ally"
  - "desc": "The lieutenant ends the [charmed](/rules/conditions.md#Charmed) and [frightened](/rules/conditions.md#Frightened)\
...
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Blade%20Lieutenant.webp"
```
^statblock