...
- "Runic Colossus"
---
# [Runic Colossus](/bestiary/construct/runic-colossus-bgg.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 20 ft., one target. *Hit:*\
      ...
      \ it must succeed on a DC 22 Dexterity saving throw or have the [prone](/rules/conditions.md#Prone)\
      \ condition. Until the colossus uses its Stomp again or moves, the creature\
      \ has the [restrained](/rules/conditions.md#Restrained) condition. The [restrained](/rules/conditions.md#Restrained)\
      ...
      \ no longer [restrained](/rules/conditions.md#Restrained)."
    "name": "Stomp"
