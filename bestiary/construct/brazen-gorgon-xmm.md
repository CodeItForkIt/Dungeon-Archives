...
- "Brazen Gorgon"
---
# [Brazen Gorgon](/bestiary/construct/brazen-gorgon-xmm.md)
...
"cr": "9"
"traits":
  - "desc": "At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  - "desc": "The gorgon sheds [Bright Light](/rules/variant-rules/bright-light-xphb.md)\
      \ in a 10-foot radius and [Dim Light](/rules/variant-rules/dim-light-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 5 ft. *Hit:* 11 (2d6 + 4) Piercing\
    ...
    "name": "Gore"
  - "desc": "The gorgon moves up to its [Speed](/rules/variant-rules/speed-xphb.md)\
      ...
      \ and the target is pulled into the gorgon's space and has the [Grappled](/rules/conditions.md#Grappled)\
      \ condition (escape DC 14); if the gorgon already has a creature [Grappled](/rules/conditions.md#Grappled),\
      \ the target has the [Prone](/rules/conditions.md#Prone) condition instead.\
      \ Until the grapple ends, the target has the [Restrained](/rules/conditions.md#Restrained)\
