...
- "Dragonbone Golem"
---
# [Dragonbone Golem](/bestiary/construct/dragonbone-golem-ftd.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ it is pinned beneath the bony pinion and [restrained](/rules/conditions.md#Restrained).\
      ...
      \ 17 Strength ([Athletics](/rules/skills.md#Athletics)) check."
    "name": "Pinion"
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12\
  ...
  - "desc": "The golem emits a 60-foot cone of petrifying gas from its mouth. Each\
      ...
      \ take 35 (10d6) poison damage and be [restrained](/rules/conditions.md#Restrained)\
      \ as it begins to turn to stone. The [restrained](/rules/conditions.md#Restrained)\
      \ target must repeat the saving throw at the end of its next turn. On a successful\
      \ save, the effect ends on the target. On a failed save, the target is [petrified](/rules/conditions.md#Petrified)."
