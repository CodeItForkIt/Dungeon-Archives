...
- "Hellfire Engine"
---
# [Hellfire Engine](/bestiary/construct/hellfire-engine-mpmm.md)
...
"actions":
  - "desc": "The hellfire engine moves up to its speed in a straight line. During\
      ...
      \ in the [prone](/rules/conditions.md#Prone) creature's space, the creature\
      \ is also [restrained](/rules/conditions.md#Restrained) until it's no longer\
      \ in the same space as the hellfire engine. While [restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The hellfire engine uses one of the following options (choose one or\
      ...
      \ Styx as a [lemure](/bestiary/fiend/lemure-xmm.md) in Avernus in 1d4 hours.\
      \ If the creature isn't revived before then, only a [wish](/spells/wish-xphb.md)\
      \ spell or killing the [lemure](/bestiary/fiend/lemure-xmm.md) and casting true\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Hellfire%20Engine.webp"
```
^statblock