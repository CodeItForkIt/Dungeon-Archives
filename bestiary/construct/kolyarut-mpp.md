...
- "Kolyarut"
---
# [Kolyarut](/bestiary/construct/kolyarut-mpp.md)
...
"actions":
  ...
  - "desc": "The kolyarut moves up to its speed without provoking opportunity attacks\
      ...
      \ end of the kolyarut's next turn."
    "name": "Edict of Blades (Recharge 5-6)"
  - "desc": "The kolyarut casts [plane shift](/spells/plane-shift-xphb.md), requiring\
      \ no material components and using Intelligence as the spellcasting ability.\
      \ The kolyarut can cast the spell normally, or it can cast the spell on an unwilling\
      \ creature it can see within 60 feet of itself. If it uses the latter option,\
      \ the targeted creature must succeed on a DC 18 Charisma saving throw or be\
      \ sent to a teleportation circle in the Hall of Concordance in Sigil."
