...
- "Blade Scout"
---
# [Blade Scout](/bestiary/construct/blade-scout-veor.md)
...
"actions":
  ...
  - "desc": "The scout deploys a Tiny mechanical trap on a solid surface within 5\
      ...
      \ ([Investigation](/rules/skills.md#Investigation)) check to find. The trap\
      \ lasts for 1 minute. Whenever an enemy enters a space within 10 feet of the\
      \ trap or starts its turn there, it must succeed on a DC 16 Dexterity saving\
...
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Blade%20Scout.webp"
```
^statblock