...
- "Autognome"
---
# [Autognome](/bestiary/construct/autognome-bam.md)
...
"traits":
  - "desc": "Whenever the autognome takes 15 damage or more from a single source and\
      ...
      \ is [incapacitated](/rules/conditions.md#Incapacitated) for 1 minute.  \n-\
      \ **13-14 \"You've Disarmed Me!\".** One of the autognome's arms falls off,\
      \ reducing the number of Shock attacks it can make by 1 until a creature uses\
      \ an action to reattach the arm.  \n- **15-16 \"Who Turned Out the Lights?\"\
      .** The autognome's head falls off and deactivates, causing the autognome to\
      \ be [blinded](/rules/conditions.md#Blinded) and [deafened](/rules/conditions.md#Deafened)\
