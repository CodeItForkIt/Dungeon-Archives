...
---
# [Living Burning Hands](/bestiary/construct/living-burning-hands-erlw.md)
...
For example, if you turn [fireball](/spells/fireball-xphb.md) (a 3rd-level spell) into a living spell, customize the [living lightning bolt](/bestiary/construct/living-lightning-bolt-erlw.md). The living fireball has immunity to fire damage, instead of lightning damage; deals fire damage with its Magical Strike; and replicates [fireball](/spells/fireball-xphb.md) with Spell Mimicry.
...
"source":
  - "ERLW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ERLW/Living%20Burning%20Hands.webp"
```
^statblock