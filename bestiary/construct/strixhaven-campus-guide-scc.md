...
---
# [Strixhaven Campus Guide](/bestiary/construct/strixhaven-campus-guide-scc.md)
...
"actions":
  ...
  - "desc": "Each creature of the guide's choice that is within 30 feet of the guide\
      ...
      \ must move on its turn toward the guide, trying to get within 5 feet of the\
      \ guide. The target doesn't move into obviously dangerous ground, such as a\
      \ fire or a pit. Whenever the [charmed](/rules/conditions.md#Charmed) target\
      \ takes damage, it can repeat the saving throw, ending the effect on itself\
