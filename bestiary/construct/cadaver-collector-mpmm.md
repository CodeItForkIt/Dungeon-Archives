...
- "Cadaver Collector"
---
# [Cadaver Collector](/bestiary/construct/cadaver-collector-mpmm.md)
...
"bonus_actions":
  - "desc": "The collector calls up the enslaved spirits of those it has slain; 1d4\
      \ [specters](/bestiary/undead/specter-xmm.md) (without Sunlight Sensitivity)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Cadaver%20Collector.webp"
```
^statblock
