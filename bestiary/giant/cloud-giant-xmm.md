...
- "Cloud Giant"
---
# [Cloud Giant](/bestiary/giant/cloud-giant-xmm.md)
...
"actions":
  - "desc": "The giant makes two attacks, using Thunderous Mace or Thundercloud in\
      ...
      \ [Fog Cloud](/spells/fog-cloud-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "The giant casts one of the following spells, requiring no Material components\
      ...
      \ [Gaseous Form](/spells/gaseous-form-xphb.md), [Telekinesis](/spells/telekinesis-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The giant casts the [Misty Step](/spells/misty-step-xphb.md) spell, using\
