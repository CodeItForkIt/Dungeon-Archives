...
---
# [Frost Giant Everlasting One](/bestiary/giant/frost-giant-everlasting-one-mpmm.md)
...
"bonus_actions":
  - "desc": "The giant enters a rage. The rage lasts for 1 minute or until the giant\
      \ is [incapacitated](/rules/conditions.md#Incapacitated). While raging, the\
      \ giant gains the following benefits:\n\n- The giant has advantage on Strength\
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Frost%20Giant%20Everlasting%20One.webp"
```
^statblock
