...
---
# [Cloud Giant Smiling One](/bestiary/giant/cloud-giant-smiling-one-mpmm.md)
...
"cr": "11"
"traits":
  - "desc": "The giant can cast the [control weather](/spells/control-weather-xphb.md)\
...
"actions":
  ...
  - "desc": "The giant casts one of the following spells, requiring no material components\
      ...
      \ [light](/spells/light-xphb.md), [minor illusion](/spells/minor-illusion-xphb.md)\n\
      \n**3/day each:** [invisibility](/spells/invisibility-xphb.md), [silent image](/spells/silent-image-xphb.md),\
      \ [suggestion](/spells/suggestion-xphb.md), [tongues](/spells/tongues-xphb.md)\n\
      \n**1/day each:** [gaseous form](/spells/gaseous-form-xphb.md), [major image](/spells/major-image-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Cloud%20Giant%20Smiling%20One.webp"
```
^statblock
