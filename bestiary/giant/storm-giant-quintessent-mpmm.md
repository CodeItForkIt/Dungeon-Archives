...
---
# [Storm Giant Quintessent](/bestiary/giant/storm-giant-quintessent-mpmm.md)
...
"lair_actions":
  - "desc": "A storm giant quintessent can use lair actions in giant form and while\
      ...
      \ or be [deafened](/rules/conditions.md#Deafened) until the end of its next\
      \ turn.  \n- **Fog.** The giant creates a 20-foot-radius sphere of fog (or murky\
      \ water if within water) centered on a point anywhere in its lair. The sphere\
      \ spreads around corners, and its area is heavily obscured. The fog lasts until\
      \ the giant disperses it (no action required), and it can't be dispersed by\
      \ wind.  \n- **Gale.** The giant creates a 60-foot-long, 10-foot-wide line of\
      \ strong wind (or strong current within water) originating from a point anywhere\
...
"legendary_actions":
  ...
  - "desc": "The giant vanishes, dispersing itself into the storm surrounding its\
      ...
      \ creature is using a [control weather](/spells/control-weather-xphb.md) spell\
      \ or similar magic to quell the storm."
    "name": "One with the Storm (Costs 3 Actions)"
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Storm%20Giant%20Quintessent.webp"
```
^statblock
