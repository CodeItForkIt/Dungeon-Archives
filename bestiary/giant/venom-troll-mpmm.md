...
- "Venom Troll"
---
# [Venom Troll](/bestiary/giant/venom-troll-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 7\
      ...
      \ is [poisoned](/rules/conditions.md#Poisoned) until the start of the troll's\
      \ next turn."
    "name": "Bite"
  ...
  - "desc": "The troll slices itself with a claw, releasing a spray of poison in a\
      ...
      \ and is [poisoned](/rules/conditions.md#Poisoned) for 1 minute. On a successful\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Venom%20Troll.webp"
```
^statblock
