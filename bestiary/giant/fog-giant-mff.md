...
- "Fog Giant"
---
# [Fog Giant](/bestiary/giant/fog-giant-mff.md)
...
"traits":
  - "desc": "The giant's innate spellcasting ability is Charisma. It can innately\
      ...
      \ [detect magic](/spells/detect-magic-xphb.md), [fog cloud](/spells/fog-cloud-xphb.md),\
      \ [light](/spells/light-xphb.md)\n\n**3/day each:** [feather fall](/spells/feather-fall-xphb.md),\
      \ [misty step](/spells/misty-step-xphb.md)"
    "name": "Innate Spellcasting"
  - "desc": "During its turn, the fog giant ignores the effects of [fog cloud](/spells/fog-cloud-xphb.md)\
  ...
  - "desc": "The giant has advantage on Wisdom ([Perception](/rules/skills.md#Perception))\
    ...
    "name": "Keen Smell"
"actions":
  - "desc": "The giant makes two greatsword attacks and casts [fog cloud](/spells/fog-cloud-xphb.md)."
    "name": "Multiattack"
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 10 ft., one target. *Hit:*\
      \ 29 (6d6 + 8) slashing damage."
    "name": "Greatsword"
...
"source":
  - "MFF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MFF/Fog%20Giant.webp"
```
^statblock