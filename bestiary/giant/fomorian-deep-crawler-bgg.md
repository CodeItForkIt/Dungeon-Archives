...
---
# [Fomorian Deep Crawler](/bestiary/giant/fomorian-deep-crawler-bgg.md)
...
"traits":
  - "desc": "The fomorian can enter a space large enough for a Large creature without\
      \ squeezing."
    "name": "Contortionist"
  - "desc": "While the fomorian has the [prone](/rules/conditions.md#Prone) condition,\
      \ crawling does not cost it extra movement. In addition, the [prone](/rules/conditions.md#Prone)\
...
"actions":
  ...
  - "desc": "The fomorian targets one creature it can see within 60 feet of itself.\
      ...
      \ psychic damage, have the [prone](/rules/conditions.md#Prone) condition, and\
      \ become cursed for 1 hour. While cursed this way, the target can't stand up\
      \ and end the [prone](/rules/conditions.md#Prone) condition on itself."
