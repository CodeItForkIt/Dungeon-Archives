...
---
# [Frost Giant of Evil Water](/bestiary/giant/frost-giant-of-evil-water-bgg.md)
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +7 to hit, range 50/200 ft., one creature.\
      \ *Hit:* 14 (2d10 + 3) piercing damage, and the target has the [grappled](/rules/conditions.md#Grappled)\
      \ condition (escape DC 16). While the target is [grappled](/rules/conditions.md#Grappled)\
    ...
    "name": "Harpoon"
"bonus_actions":
  - "desc": "The giant pulls the target [grappled](/rules/conditions.md#Grappled)\
