...
- "Troll"
---
# [Troll](/bestiary/giant/troll-xmm.md)
...
"cr": "5"
"traits":
  - "desc": "If the troll ends any turn [Bloodied](/rules/conditions.md#Bloodied)\
      \ and took 15+ Slashing damage during that turn, one of the troll's limbs is\
      \ severed, falls into the troll's space, and becomes a [Troll Limb](/bestiary/giant/troll-limb-xmm.md).\
  ...
  - "desc": "The troll regains 15 [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ if it starts its turn with 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
