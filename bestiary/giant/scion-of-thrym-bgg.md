...
- "Scion of Thrym"
---
# [Scion of Thrym](/bestiary/giant/scion-of-thrym-bgg.md)
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +17 to hit, range 120/480 ft., one target.\
      ...
      \ the target must succeed on a DC 25 Strength saving throw or have the [prone](/rules/conditions.md#Prone)\
      \ condition."
    "name": "Glacier Throw"
...
"bonus_actions":
  - "desc": "The scion moves up to its speed and sends a shock wave through the ground\
      ...
      \ in that area that is [concentrating](/rules/conditions.md#Concentration) must\
      \ succeed on a DC 25 Constitution saving throw or lose [concentration](/rules/conditions.md#Concentration)."
