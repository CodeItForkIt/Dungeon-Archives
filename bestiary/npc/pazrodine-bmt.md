...
- "Pazrodine"
---
# [Pazrodine](/bestiary/npc/pazrodine-bmt.md)
...
"traits":
  - "desc": "Pazrodine can sense when an item is stolen from Seelie Market. She knows\
      \ the distance and direction to stolen items, as if by the [Locate Object](/spells/locate-object-xphb.md)\
      \ spell."
...
"actions":
  ...
  - "desc": "Pazrodine uses one of the following breath weapons:\n\n- **Dream Breath.**\
      ...
      \ 60 (11d10) radiant damage on a failed save, or half as much damage on a\
      \ successful one.  "
  ...
  - "desc": "Pazrodine casts one of the following spells, requiring no material components\
      ...
      \ [Invisibility](/spells/invisibility-xphb.md)\n\n**1/day each:** [Mass Cure\
      \ Wounds](/spells/mass-cure-wounds-xphb.md), [Revivify](/spells/revivify-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Pazrodine.webp"
```
^statblock