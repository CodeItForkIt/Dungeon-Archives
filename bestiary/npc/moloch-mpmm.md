...
- "Moloch"
---
# [Moloch](/bestiary/npc/moloch-mpmm.md)
...
"actions":
  ...
  - "desc": "Moloch casts one of the following spells, requiring no material components\
      ...
      \ his appearance), [confusion](/spells/confusion-xphb.md), [detect magic](/spells/detect-magic-xphb.md),\
      \ [fly](/spells/fly-xphb.md), [major image](/spells/major-image-xphb.md), [stinking\
      \ cloud](/spells/stinking-cloud-xphb.md), [suggestion](/spells/suggestion-xphb.md),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Moloch.webp"
```
^statblock