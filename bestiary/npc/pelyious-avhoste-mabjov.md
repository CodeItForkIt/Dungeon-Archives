...
- "Pelyious Avhoste"
---
# [Pelyious Avhoste](/bestiary/npc/pelyious-avhoste-mabjov.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 9\
      \ (1d10 + 4) piercing damage. If the target is Medium or smaller, it is [grappled](/rules/conditions.md#Grappled)\
      \ (escape DC 16) and until this grapple ends, the target is [restrained](/rules/conditions.md#Restrained),\
  ...
  - "desc": "Pelyious casts one of the following spells, using Intelligence as the\
      ...
      \n**At will:** [fire bolt](/spells/fire-bolt-xphb.md), [light](/spells/light-xphb.md),\
      \ [mage hand](/spells/mage-hand-xphb.md), [prestidigitation](/spells/prestidigitation-xphb.md)\n\
      \n**2/day each:** [detect magic](/spells/detect-magic-xphb.md), [mage armor](/spells/mage-armor-xphb.md),\
      \ [shield](/spells/shield-xphb.md), [suggestion](/spells/suggestion-xphb.md)\n\
      \n**1/day each:** [cone of cold](/spells/cone-of-cold-xphb.md), [counterspell](/spells/counterspell-xphb.md),\
      \ [fly](/spells/fly-xphb.md), [greater invisibility](/spells/greater-invisibility-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
