...
- "Murgaxor"
---
# [Murgaxor](/bestiary/npc/murgaxor-scc.md)
...
"traits":
  ...
  - "desc": "Murgaxor wears an Oriq mask. While wearing the mask, Murgaxor can't be\
      ...
      \ and he adds double his proficiency bonus to Charisma ([Deception](/rules/skills.md#Deception))\
      \ checks (included above)."
    "name": "Oriq Mask"
  - "desc": "While Murgaxor isn't [blinded](/rules/conditions.md#Blinded), he can\
      \ see any creature that isn't an Undead or a Construct within 60 feet of himself,\
...
"actions":
  ...
  - "desc": "Murgaxor chooses a point within 150 feet of himself, and a 20-foot radius\
      ...
      \ necrotic damage and is [incapacitated](/rules/conditions.md#Incapacitated)\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Murgaxor can take one\
      ...
      \ again until he finishes a long rest:\n\n- **Clay Behemoth.** A [clay golem](/bestiary/construct/clay-golem-xmm.md)\
      ...
      \ is within 4 feet of the fist. The fist has a +11 bonus to hit, and on a\
      \ hit, the target takes 13 (3d8) bludgeoning damage and is grappled (escape\
      \ DC 15). The fist disappears if the attack roll misses or if the grapple ends.\
      ...
      \ summons four [mud mephits](/bestiary/elemental/mud-mephit-xmm.md) that appear\
      \ in unoccupied spaces within 15 feet of the ritual circle. The mephits obey\
      \ Murgaxor's commands, take their turns on initiative count 15 (losing initiative\
