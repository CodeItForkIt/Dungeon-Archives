...
- "Graz'zt"
---
# [Graz'zt](/bestiary/npc/grazzt-mpmm.md)
...
"actions":
  ...
  - "desc": "Graz'zt casts one of the following spells, requiring no material components\
      ...
      \ will:** [charm person](/spells/charm-person-xphb.md), [detect magic](/spells/detect-magic-xphb.md),\
      \ [dispel magic](/spells/dispel-magic-xphb.md)\n\n**3/day each:** [darkness](/spells/darkness-xphb.md),\
      \ [dominate person](/spells/dominate-person-xphb.md), [telekinesis](/spells/telekinesis-xphb.md),\
      \ [teleport](/spells/teleport-xphb.md)\n\n**1/day each:** [dominate monster](/spells/dominate-monster-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "Graz'zt makes one Wave of Sorrow attack."
    "name": "Attack"
  - "desc": "One creature [charmed](/rules/conditions.md#Charmed) by Graz'zt that\
      \ Graz'zt can see must use its reaction to move up to its speed as Graz'zt directs."
    "name": "Dance, My Puppet!"
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Graz%27zt.webp"
```
^statblock