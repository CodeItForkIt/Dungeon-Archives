...
- "Hedrun Arnsfirth"
---
# [Hedrun Arnsfirth](/bestiary/npc/hedrun-arnsfirth-tftyp.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:*\
      ...
      \ is destroyed. Hedrun can have no more than twelve [zombies](/bestiary/undead/zombie-xmm.md)\
      \ under its control at one time."
    "name": "Life Drain"
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Hedrun%20Arnsfirth.webp"
```
^statblock