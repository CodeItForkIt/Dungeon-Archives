...
- "Velomachus Lorehold"
---
# [Velomachus Lorehold](/bestiary/npc/velomachus-lorehold-scc.md)
...
"actions":
  ...
  - "desc": "Velomachus casts one of the following spells, requiring no material components\
      ...
      \ other plane](/spells/contact-other-plane-xphb.md) (as an action, contacting\
      \ a long-dead spirit), [divination](/spells/divination-xphb.md), [move earth](/spells/move-earth-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "Velomachus magically summons 1d4 [statue mascots](/bestiary/construct/spirit-statue-mascot-scc.md)\
