...
- "Tloques-Popolocas"
---
# [Tloques-Popolocas](/bestiary/npc/tloques-popolocas-tftyp.md)
...
"cr": "5"
"traits":
  - "desc": "Tloques can cast [hold person](/spells/hold-person-xphb.md) (DC 14) at\
      \ will, requiring no components, but his target must be able to see him.\n"
  ...
  - "desc": "The vampire regains 10 hit points at the start of its turn if it has\
      ...
      \ takes radiant damage or damage from [holy water](/items/holy-water-xphb.md),\
...
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Tloques-Popolocas.webp"
```
^statblock