...
- "Torogar Steelfist"
---
# [Torogar Steelfist](/bestiary/npc/torogar-steelfist-bgdia.md)
...
"cr": "11"
"traits":
  - "desc": "Immediately after using the [Dash](/rules/actions.md#Dash) action, Torogar\
  ...
  - "desc": "As a bonus action, Torogar can enter a rage that lasts for 1 minute.\
      \ The rage ends early if Torogar is knocked [unconscious](/rules/conditions.md#Unconscious)\
  ...
  - "desc": "Torogar wears [gauntlets of flaming fury](/items/gauntlets-of-flaming-fury-bgdia.md)\
      \ and a [belt of fire giant strength](/items/belt-of-fire-giant-strength-xdmg.md).\
      \ Without the belt, his Strength is 21. He also carries a [soul coin](/items/soul-coin-bgdia.md)."
...
"source":
  - "BGDIA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BGDIA/Torogar%20Steelfist.webp"
```
^statblock