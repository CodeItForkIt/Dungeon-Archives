...
- "Demogorgon"
---
# [Demogorgon](/bestiary/npc/demogorgon-mpmm.md)
...
"actions":
  ...
  - "desc": "Demogorgon turns his magical gaze toward one creature he can see within\
      ...
      2 Beguiling Gaze.** The target is [stunned](/rules/conditions.md#Stunned) until\
      ...
      \ of the [confusion](/spells/confusion-xphb.md) spell without making a saving\
      \ throw. The effect lasts until the start of Demogorgon's next turn. Demogorgon\
      \ doesn't need to concentrate on the spell.  \n- **5–6 Hypnotic Gaze.** The\
      \ target is [charmed](/rules/conditions.md#Charmed) by Demogorgon until the\
  ...
  - "desc": "Demogorgon casts one of the following spells, requiring no material components\
      ...
      \ will:** [detect magic](/spells/detect-magic-xphb.md), [major image](/spells/major-image-xphb.md)\n\
      \n**3/day each:** [dispel magic](/spells/dispel-magic-xphb.md), [fear](/spells/fear-xphb.md),\
      \ [telekinesis](/spells/telekinesis-xphb.md)\n\n**1/day each:** [feeblemind](/spells/befuddlement-xphb.md),\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Demogorgon can take\
      ...
      \ rounds in a row:\n\n- **Darkness.** Demogorgon casts the [darkness](/spells/darkness-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing Demogorgon's lair is warped by his magic, creating\
      ...
      \ with [poisonous snakes](/bestiary/beast/venomous-snake-xmm.md) and other venomous\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Demogorgon.webp"
```
^statblock