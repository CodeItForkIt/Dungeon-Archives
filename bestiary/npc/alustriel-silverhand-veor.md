...
---
# [Alustriel Silverhand](/bestiary/npc/alustriel-silverhand-veor.md)
...
"traits":
  ...
  - "desc": "Alustriel carries a magic staff known as the Staff of Silverymoon. In\
      ...
      \ of Power](/items/staff-of-power-xdmg.md)."
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +14 to hit, range 120 ft., one target. *Hit:*\
      ...
      \ a DC 22 Charisma saving throw. On a failed save, the target has the [incapacitated](/rules/conditions.md#Incapacitated)\
  ...
  - "desc": "Alustriel casts one of the following spells, using Intelligence as the\
      ...
      \ [Detect Magic](/spells/detect-magic-xphb.md), [Mage Armor](/spells/mage-armor-xphb.md)\
      \ (self only), [Mage Hand](/spells/mage-hand-xphb.md)\n\n**2/day each:** [Detect\
      \ Thoughts](/spells/detect-thoughts-xphb.md), [Dispel Magic](/spells/dispel-magic-xphb.md),\
      \ [Tongues](/spells/tongues-xphb.md)\n\n**1/day each:** [Telepathy](/spells/telepathy-xphb.md),\
      \ [Teleport](/spells/teleport-xphb.md), [Time Stop](/spells/time-stop-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Brilliant silver fire harmlessly wreathes Alustriel and empowers her.\
      \ The silver fire lasts for 1 hour or until she has the [incapacitated](/rules/conditions.md#Incapacitated)\
