...
- "Asteria"
---
# [Asteria](/bestiary/npc/asteria-bmt.md)
...
"ac": !!int "18"
"ac_class": "[breastplate](/items/breastplate-xphb.md), [shield](/items/shield-xphb.md)"
"hp": !!int "195"
"hit_dice": "26d8 + 78"
"modifier": !!int "5"
"stats":
...
"traits":
  ...
  - "desc": "Asteria wears [Winged Boots](/items/winged-boots-xdmg.md), which grant\
      \ her a flying speed (included in her statistics). She also carries one half\
      \ of a pair of [Sending Stones](/items/sending-stones-xdmg.md); the other half\
      \ of the pair is held by Euryale."
...
"actions":
  ...
  - "desc": "Asteria casts one of the following spells, requiring no material components\
      ...
      \ will:** [Guidance](/spells/guidance-xphb.md), [Light](/spells/light-xphb.md),\
      ...
      \ [Plane Shift](/spells/plane-shift-xphb.md) (self only), [Protection from Evil\
      \ and Good](/spells/protection-from-evil-and-good-xphb.md), [Revivify](/spells/revivify-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Asteria.webp"
```
^statblock