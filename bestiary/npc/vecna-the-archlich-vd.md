...
- "Vecna the Archlich"
---
# [Vecna the Archlich](/bestiary/npc/vecna-the-archlich-vd.md)
...
"traits":
  ...
  - "desc": "Vecna carries a magic dagger named Afterthought. In the hands of anyone\
      \ other than Vecna, Afterthought is a [+2 dagger](/items/2-weapon-xdmg.md)."
...
"actions":
  ...
  - "desc": "Vecna conjures a torrent of flying, spectral entities that fill a 120-foot\
      ...
      \ save, the creature takes 36 (8d8) necrotic damage and is [frightened](/rules/conditions.md#Frightened)\
      \ of Vecna for 1 minute. On a successful save, the creature takes half as much\
      \ damage and isn't [frightened](/rules/conditions.md#Frightened). A [frightened](/rules/conditions.md#Frightened)\
  ...
  - "desc": "Vecna causes necrotic magic to engulf one creature he can see within\
      ...
      \ on a successful one. A Humanoid killed by this magic rises as a [zombie](/bestiary/undead/zombie-xmm.md)\
      \ at the start of Vecna's next turn and acts immediately after Vecna in the\
      \ initiative order. The [zombie](/bestiary/undead/zombie-xmm.md) is under Vecna's\
      \ control."
    "name": "Rotten Fate"
  - "desc": "Vecna casts one of the following spells, requiring no material components\
      ...
      **At will:** [animate dead](/spells/animate-dead-xphb.md) (as an action), [detect\
      \ magic](/spells/detect-magic-xphb.md), [dispel magic](/spells/dispel-magic-xphb.md),\
      \ [fly](/spells/fly-xphb.md), [lightning bolt](/spells/lightning-bolt-xphb.md),\
      ...
      \ monster](/spells/dominate-monster-xphb.md), [globe of invulnerability](/spells/globe-of-invulnerability-xphb.md),\
...
"source":
  - "VD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VD/Vecna%20the%20Archlich.webp"
```
^statblock