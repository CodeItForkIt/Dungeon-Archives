...
- "Sandesyl Morgia"
---
# [Sandesyl Morgia](/bestiary/npc/sandesyl-morgia-hotdq.md)
...
"traits":
  ...
  - "desc": "Sandesyl regains 20 hit points at the start of its turn if it has at\
      ...
      \ radiant damage or damage from [holy water](/items/holy-water-xphb.md), this\
      \ trait doesn't function at the start of Sandesyl's next turn."
    "name": "Regeneration"
  ...
  - "desc": "Sandesyl has the following flaws:\n\n- **Forbiddance.** Sandesyl can't\
      ...
      \ into Sandesyl's heart while Sandesyl is [incapacitated](/rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one willing creature,\
      \ or a creature that is [grappled](/rules/conditions.md#Grappled) by Sandesyl,\
  ...
  - "desc": "Sandesyl targets one humanoid it can see within 30 feet of it. If the\
      ...
      \ throw against this magic or be [charmed](/rules/conditions.md#Charmed) by\
      \ Sandesyl. The [charmed](/rules/conditions.md#Charmed) target regards Sandesyl\
      \ as a trusted friend to be heeded and protected. Although the target isn't\
      \ under Sandesyl's control, it takes Sandesyl's requests or actions in the most\
      \ favorable way it can, and it is a willing target for Sandesyl's bite attack.\n\
      \nEach time Sandesyl or Sandesyl's companions do anything harmful to the target,\
      \ it can repeat the saving throw, ending the effect on itself on a success.\
      \ Otherwise, the effect lasts 24 hours or until Sandesyl is destroyed, is on\
      \ a different plane of existence than the target, or takes a bonus action to\
      \ end the effect."
    "name": "Charm"
  - "desc": "Sandesyl magically calls 2d4 swarms of [bats](/bestiary/beast/swarm-of-bats-xmm.md)\
      \ or [rats](/bestiary/beast/swarm-of-rats-xmm.md), provided that the sun isn't\
      \ up. While outdoors, Sandesyl can call 3d6 [wolves](/bestiary/beast/wolf-xmm.md)\
...
"source":
  - "HotDQ"
  - "ToD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/HotDQ/Sandesyl%20Morgia.webp"
```
^statblock