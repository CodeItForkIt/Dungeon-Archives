...
- "Skr'a S'orsk"
---
# [Skr'a S'orsk](/bestiary/npc/skra-sorsk-egw.md)
...
"traits":
  - "desc": "Skr'a S'orsk is a 5th-level spellcaster. Its spellcasting ability is\
      ...
      \ the following druid spells prepared:\n\n**Cantrips (at will):** [produce flame](/spells/produce-flame-xphb.md),\
      \ [resistance](/spells/resistance-xphb.md), [thorn whip](/spells/thorn-whip-xphb.md)\n\
      \n**1st level (4 slots):** [entangle](/spells/entangle-xphb.md), [fog cloud](/spells/fog-cloud-xphb.md)\n\
      \n**2nd level (3 slots):** [blindness/deafness](/spells/blindness-deafness-xphb.md),\
      \ [spike growth](/spells/spike-growth-xphb.md)\n\n**3rd level (2 slots):** [animate\
      \ dead](/spells/animate-dead-xphb.md), [conjure animals](/spells/conjure-animals-xphb.md)\
      \ (reptiles only)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5\
      \ (1d6 + 2) piercing damage, or 7 (1d10 + 2) piercing damage in [crocodile](/bestiary/beast/crocodile-xmm.md)\
      \ form. If Skr'a S'orsk is in crocodile form and the target is a Large or smaller\
      \ creature, the target is [grappled](/rules/conditions.md#Grappled) (escape\
  ...
  - "desc": "The lizardfolk magically polymorphs into a [crocodile](/bestiary/beast/crocodile-xmm.md),\
...
"source":
  - "EGW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EGW/Skr%27a%20S%27orsk.webp"
```
^statblock