...
- "Erky Timbers"
---
# [Erky Timbers](/bestiary/npc/erky-timbers-tftyp.md)
...
"traits":
  - "desc": "The acolyte is a 1st-level spellcaster. Its spellcasting ability is Wisdom\
      ...
      \n**1st level (3 slots):** [bless](/spells/bless-xphb.md), [cure wounds](/spells/cure-wounds-xphb.md),\
      \ [sanctuary](/spells/sanctuary-xphb.md)"
    "name": "Spellcasting"
"actions":
  ...
  - "desc": "Erky presents his holy Symbol and speaks a prayer censuring the Undead.\
      ...
      \ action, it can use only the [Dash](/rules/actions.md#Dash) action or try to\
      \ escape from an effect that prevents it from moving. If there's nowhere to\
      \ move, the creature can use the [Dodge](/rules/actions.md#Dodge) action."
    "name": "Channel Divinity: Turn Undead (1/Short Rest)"
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Erky%20Timbers.webp"
```
^statblock