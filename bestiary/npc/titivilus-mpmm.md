...
- "Titivilus"
---
# [Titivilus](/bestiary/npc/titivilus-mpmm.md)
...
"actions":
  ...
  - "desc": "Titivilus casts one of the following spells, requiring no material components\
      ...
      \ will:** [alter self](/spells/alter-self-xphb.md), [major image](/spells/major-image-xphb.md),\
      \ [nondetection](/spells/nondetection-xphb.md), [sending](/spells/sending-xphb.md),\
      \ [suggestion](/spells/suggestion-xphb.md)\n\n**3/day each:** [mislead](/spells/mislead-xphb.md),\
      \ [modify memory](/spells/modify-memory-xphb.md)"
    "name": "Spellcasting"
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Titivilus.webp"
```
^statblock