...
- "Obmi"
---
# [Obmi](/bestiary/npc/obmi-tftyp.md)
...
"traits":
  - "desc": "During its first turn, Obmi has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Obmi scores against a [surprised](/rules/conditions.md#Surprised)\
  ...
  - "desc": "Obmi deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Obmi that isn't [incapacitated](/rules/conditions.md#Incapacitated)\
...
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Obmi.webp"
```
^statblock