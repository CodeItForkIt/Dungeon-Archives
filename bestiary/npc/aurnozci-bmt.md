...
- "Aurnozci"
---
# [Aurnozci](/bestiary/npc/aurnozci-bmt.md)
...
"actions":
  ...
  - "desc": "Aurnozci casts one of the following spells, requiring no material components\
      ...
      \ [Detect Magic](/spells/detect-magic-xphb.md), [Heat Metal](/spells/heat-metal-xphb.md)\
      \ (7th-level version)\n\n**2/day each:** [Darkness](/spells/darkness-xphb.md),\
      \ [Dispel Magic](/spells/dispel-magic-xphb.md), [Hold Person](/spells/hold-person-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Aurnozci.webp"
```
^statblock