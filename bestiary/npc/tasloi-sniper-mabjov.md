...
- "Tasloi Sniper"
---
# [Tasloi Sniper](/bestiary/npc/tasloi-sniper-mabjov.md)
...
"traits":
  - "desc": "Tasloi can use their Dexterity for attack and damage rolls with a javelin,\
    ...
    "name": "Javelin Expert"
  - "desc": "The tasloi can take the [Disengage](/rules/actions.md#Disengage) or [Hide](/rules/actions.md#Hide)\
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +6 to hit, range 25/100 ft., one target. *Hit:*\
      ...
      \ on a DC 10 Constitution saving throw or have the [poisoned](/rules/conditions.md#Poisoned)\
