...
- "Lysan"
---
# [Lysan](/bestiary/npc/lysan-veor.md)
...
"traits":
  - "desc": "Lysan's innate spellcasting ability is Intelligence (spell save DC 13,\
      ...
      \ (the hand is invisible)\n\n**3/day each:** [jump](/spells/jump-xphb.md), [misty\
      \ step](/spells/misty-step-xphb.md), [nondetection](/spells/nondetection-xphb.md)\
      \ (self only), [tongues](/spells/tongues-xphb.md)\n\n**1/day each:** [plane\
      \ shift](/spells/plane-shift-xphb.md), [telekinesis](/spells/telekinesis-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 13\
      ...
      \ the [astral projection](/spells/astral-projection-xphb.md) spell), Lysan can\
      \ cut the silvery cord that tethers the target to its material body, instead\
      \ of dealing damage."
    "name": "Silver Greatsword"
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Lysan.webp"
```
^statblock