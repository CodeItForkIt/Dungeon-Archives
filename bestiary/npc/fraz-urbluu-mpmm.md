...
- "Fraz-Urb'luu"
---
# [Fraz-Urb'luu](/bestiary/npc/fraz-urbluu-mpmm.md)
...
Once imprisoned for centuries below Castle Greyhawk on the world of Oerth, Fraz-Urb'luu has slowly rebuilt his power in the Abyss. He seeks the pieces of the legendary [staff of power](/items/staff-of-power-xdmg.md) taken from him by those who imprisoned him and commands his servants to do likewise.
...
"actions":
  ...
  - "desc": "Fraz-Urb'luu casts one of the following spells, requiring no material\
      ...
      \n**At will:** [alter self](/spells/alter-self-xphb.md) (can become Medium when\
      \ changing his appearance), [detect magic](/spells/detect-magic-xphb.md), [dispel\
      \ magic](/spells/dispel-magic-xphb.md), [phantasmal force](/spells/phantasmal-force-xphb.md)\n\
      \n**3/day each:** [mislead](/spells/mislead-xphb.md), [programmed illusion](/spells/programmed-illusion-xphb.md),\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Fraz-Urb'luu can take\
      ...
      \ with the [simulacrum](/spells/simulacrum-xphb.md) spell). This simulacrum\
...
"regional_effects":
  - "desc": "The region containing Fraz-Urb'luu's lair is warped by his magic, creating\
      ...
      \ of the lair, all Charisma ([Persuasion](/rules/skills.md#Persuasion)) and\
      \ Wisdom ([Insight](/rules/skills.md#Insight)) checks have disadvantage, and\
      \ all Charisma ([Deception](/rules/skills.md#Deception)) and Charisma ([Performance](/rules/skills.md#Performance))\
...
"legendary_actions":
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 15 ft., one target. *Hit:*\
      ...
      \ it is also [grappled](/rules/conditions.md#Grappled) (escape DC 24), and it\
      \ is [restrained](/rules/conditions.md#Restrained) until the grapple ends. Fraz-Urb'luu\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Fraz-Urb%27luu.webp"
```
^statblock