...
- "Dyrrn"
---
# [Dyrrn](/bestiary/npc/dyrrn-erlw.md)
...
"lair_actions":
  - "desc": "While within the Palace of Sinew, Dyrrn can invoke the ambient magic\
      ...
      \ reduced by 1d4 each time it fails the saving throw for this lair action.\
...
"legendary_actions":
  ...
  - "desc": "Dyrrn magically emits psychic energy in a 60-foot cone. Each creature\
      ...
      \ (5d8 + 8) psychic damage and be [stunned](/rules/conditions.md#Stunned)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success."
    "name": "Mind Blast (Costs 3 Actions)"
"source":
  - "ERLW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ERLW/Dyrrn.webp"
```
^statblock