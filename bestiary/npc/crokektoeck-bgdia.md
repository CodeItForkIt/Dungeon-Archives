...
- "Crokek'toeck"
---
# [Crokek'toeck](/bestiary/npc/crokektoeck-bgdia.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 15 ft., one target. *Hit:*\
    ...
    "name": "Bite"
  - "desc": "Crokek'toeck opens its mouth and disgorges 1d4 [barlguras](/bestiary/fiend/barlgura-xmm.md),\
      \ 3d6 [gnolls](/bestiary/fiend/gnoll-warrior-xmm.md) led by 1 [gnoll fang\
      \ of Yeenoghu](/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm.md), 6d6 [dretches](/bestiary/fiend/dretch-xmm.md),\
      \ or 1d3 [vrocks](/bestiary/fiend/vrock-xmm.md). Each creature it disgorges\
      \ appears in an unoccupied space within 30 feet of Crokek'toeck's mouth, or\
      \ the next closest unoccupied space."
