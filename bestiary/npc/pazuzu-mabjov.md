...
- "Pazuzu"
---
# [Pazuzu](/bestiary/npc/pazuzu-mabjov.md)
...
> 
> The henchmen Edwin Odesseiron and [Eo Ashmajiir](/bestiary/npc/eo-ashmajiir-mabjov.md) are powerful magic users who want to possess the iron flask to augment their own power. They might compete against each other in their attempts to wrest the flask away from the players.
> 
...
"actions":
  ...
  - "desc": "Pazuzu casts one of the following spells, requiring no material components\
      ...
      \ will:** [astral projection](/spells/astral-projection-xphb.md), [blight](/spells/blight-xphb.md),\
      \ [charm person](/spells/charm-person-xphb.md), [detect evil and good](/spells/detect-evil-and-good-xphb.md),\
      \ [dispel magic](/spells/dispel-magic-xphb.md), [hallow](/spells/hallow-xphb.md),\
      \ [insect plague](/spells/insect-plague-xphb.md), [telekinesis](/spells/telekinesis-xphb.md),\
      \ [teleport](/spells/teleport-xphb.md), [wind walk](/spells/wind-walk-xphb.md)\n\
      \n**2/day each:** [dominate person](/spells/dominate-person-xphb.md), [hypnotic\
      \ pattern](/spells/hypnotic-pattern-xphb.md), [plane shift](/spells/plane-shift-xphb.md)\
      \ (only itself and willing creatures)\n\n**1/day:** [wish](/spells/wish-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Pazuzu casts [dispel magic](/spells/dispel-magic-xphb.md), automatically\
