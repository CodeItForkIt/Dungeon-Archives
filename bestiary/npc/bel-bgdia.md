...
"traits":
  - "desc": "Bel's spellcasting ability is Charisma (spell save DC 23). Bel can innately\
      ...
      \ [detect magic](/spells/detect-magic-xphb.md), [fireball](/spells/fireball-xphb.md)\n\
      \n**3/day each:** [dispel magic](/spells/dispel-magic-xphb.md), [hold monster](/spells/hold-monster-xphb.md),\
      \ [mirror image](/spells/mirror-image-xphb.md), [mislead](/spells/mislead-xphb.md),\
      \ [raise dead](/spells/raise-dead-xphb.md), [teleport](/spells/teleport-xphb.md),\
      \ [wall of fire](/spells/wall-of-fire-xphb.md)\n\n**1/day each:** [imprisonment](/spells/imprisonment-xphb.md),\
      \ [meteor swarm](/spells/meteor-swarm-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ on a DC 23 Constitution saving throw or be [stunned](/rules/conditions.md#Stunned)\
...
"legendary_actions":
  - "desc": "Bel casts [fireball](/spells/fireball-xphb.md)."
    "name": "Fireball"
...
"source":
  - "BGDIA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BGDIA/Bel.webp"
```
^statblock