...
- "Old Croaker"
---
# [Old Croaker](/bestiary/npc/old-croaker-egw.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 7\
      ...
      \ is [grappled](/rules/conditions.md#Grappled) (escape DC 13). Until this grapple\
      \ ends, the target is [restrained](/rules/conditions.md#Restrained), and Old\
      \ Croaker can't bite another target."
    "name": "Bite"
  - "desc": "Old Croaker makes one bite attack against a Medium or smaller target\
      ...
      \ ends. The swallowed target is [blinded](/rules/conditions.md#Blinded) and\
      ...
      \ from the corpse using 5 feet of movement, exiting [prone](/rules/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "EGW"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/EGW/Old%20Croaker.webp"
```
^statblock