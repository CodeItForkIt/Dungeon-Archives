...
- "Zuggtmoy"
---
# [Zuggtmoy](/bestiary/npc/zuggtmoy-mpmm.md)
...
"actions":
  ...
  - "desc": "Zuggtmoy casts one of the following spells, requiring no material components\
      ...
      \ will:** [detect magic](/spells/detect-magic-xphb.md), [locate animals or plants](/spells/locate-animals-or-plants-xphb.md)\n\
      \n**3/day each:** [dispel magic](/spells/dispel-magic-xphb.md), [entangle](/spells/entangle-xphb.md),\
...
"bonus_actions":
  - "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
      ...
      \ is reanimated as a [spore servant](/bestiary/plant/myconid-spore-servant-xmm.md)\
...
"lair_actions":
  - "desc": "On Initiative count 20 (losing initiative ties), Zuggtmoy can take a\
      ...
      \ Zuggtmoy causes four [gas spores](/bestiary/plant/gas-spore-fungus-xmm.md)\
      \ or [violet fungi](/bestiary/plant/violet-fungus-xmm.md) to appear in unoccupied\
      \ spaces that she chooses within the lair. They vanish after 1 hour.  \n- **Unleash\
      \ Spores.** Zuggtmoy uses either her Infestation Spores or her Mind Control\
      \ Spores, centered on a mushroom or other fungus within her lair, instead of\
      \ on herself.  "
    "name": ""
"regional_effects":
  - "desc": "The region containing Zuggtmoy's lair is warped by his magic, creating\
      \ one or more of the following effects:\n\n- **Corrupted Nature.** Within 6\
      \ miles of the lair, all Wisdom ([Medicine](/rules/skills.md#Medicine)) and\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Zuggtmoy.webp"
```
^statblock