...
- "Zariel"
---
# [Zariel](/bestiary/npc/zariel-mpmm.md)
...
"actions":
  ...
  - "desc": "Zariel casts one of the following spells, requiring no material components\
      ...
      \ her appearance), [detect evil and good](/spells/detect-evil-and-good-xphb.md),\
      \ [fireball](/spells/fireball-xphb.md), [invisibility](/spells/invisibility-xphb.md)\
      \ (self only), [major image](/spells/major-image-xphb.md), [wall of fire](/spells/wall-of-fire-xphb.md)\n\
      \n**3/day each:** [blade barrier](/spells/blade-barrier-xphb.md), [dispel evil\
      \ and good](/spells/dispel-evil-and-good-xphb.md), [finger of death](/spells/finger-of-death-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Zariel can take one\
      ...
      \ in a row:\n\n- **Fireball.** Zariel casts the [fireball](/spells/fireball-xphb.md)\
      \ spell.  \n- **Infernal Illusions.** Zariel casts the [major image](/spells/major-image-xphb.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Zariel.webp"
```
^statblock