...
- "Minsc and Boo!"
---
# [Minsc and Boo!](/bestiary/npc/minsc-and-boo-mabjov.md)
...
"traits":
  - "desc": "Boo is Minsc's animal companion. Boo is a miniature giant space hamster\
      \ and has the statistics of a [rat](/bestiary/beast/rat-xmm.md)."
...
"bonus_actions":
  - "desc": "As a bonus action, Minsc talks to Boo and gains the inspiration to go\
      ...
      \ or [frightened](/rules/conditions.md#Frightened). If Minsc is [charmed](/rules/conditions.md#Charmed)\
      ...
      \ to 0 hit points and doesn't die outright, he can make a DC 10 Constitution\
      \ saving throw. If he succeeds, he drops to 1 hit point instead. Each time he\
      \ uses this feature after the first, the DC increases by 5. After 24 hours,\
      \ the DC resets to 10.  "
