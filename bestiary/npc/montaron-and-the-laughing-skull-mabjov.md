...
---
# [Montaron and the Laughing Skull](/bestiary/npc/montaron-and-the-laughing-skull-mabjov.md)
...
"traits":
  ...
  - "desc": "Montaron possesses a [bag of holding](/items/bag-of-holding-xdmg.md).\
      \ He keeps the [demilich](/bestiary/undead/demilich-xmm.md), Xzar, in the bag.\
      \ He also possesses a [portable hole](/items/portable-hole-xdmg.md), which he\
      \ uses to aid in robberies. As a bonus action, Montaron can place his [portable\
      \ hole](/items/portable-hole-xdmg.md) in his [bag of holding](/items/bag-of-holding-xdmg.md).\
...
"actions":
  ...
  - "desc": "Montaron reaches inside his bag of holding and releases Xzar. Xzar is\
      \ a [demilich](/bestiary/undead/demilich-xmm.md) and appears within 5 feet of\
      \ Montaron. Xzar rolls for his own initiative. Xzar can't use lair actions or\
      \ legendary actions. He has a CR of 14."
