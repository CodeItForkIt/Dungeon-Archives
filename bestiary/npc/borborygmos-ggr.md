...
- "Borborygmos"
---
# [Borborygmos](/bestiary/npc/borborygmos-ggr.md)
...
"legendary_actions":
  ...
  - "desc": "Borborygmos yells menacingly at one creature he can see within 60 feet\
      ...
      \ [frightened](/rules/conditions.md#Frightened) of him for 1 minute. If the\
      \ creature is already [frightened](/rules/conditions.md#Frightened), it becomes\
      \ [stunned](/rules/conditions.md#Stunned) instead. A creature can repeat the\
      \ saving throw at the end of each of its turns, ending the effect on itself\
      \ on a success. If a creature's saving throw is successful or the effect ends\
      \ for it, the creature is immune to Borborygmos's Bellow for the next 24 hours."
