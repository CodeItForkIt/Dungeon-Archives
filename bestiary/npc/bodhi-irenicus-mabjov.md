...
- "Bodhi Irenicus"
---
# [Bodhi Irenicus](/bestiary/npc/bodhi-irenicus-mabjov.md)
...
| Panther's gift | You can cast the [polymorph](/spells/polymorph-xphb.md) spell once per day without using any verbal or somatic components You can only cast it on yourself and it must be a panther | 7 |
| Vampire's gift | You can cast the [dominate person](/spells/dominate-person-xphb.md) spell once per day without using any verbal or somatic components | 9 |
^supernatural-gifts-from-bodhi-irenicus
...
"traits":
  ...
  - "desc": "If Bodhi is destroyed, her body immediately appears in her resting place.\
      ...
      \ she regains 1 hit point. While [paralyzed](/rules/conditions.md#Paralyzed)\
  ...
  - "desc": "Bodhi Irenicus has the following flaws:\n\n- **Elvish Song.** Bodhi can't\
      ...
      \ of wood is driven into Bodhi's heart while she is [incapacitated](/rules/conditions.md#Incapacitated)\
      \ in her resting place, Bodhi is [paralyzed](/rules/conditions.md#Paralyzed)\
...
"actions":
  ...
  - "desc": "Bodhi targets one Humanoid she can see within 30 feet of her. If the\
      ...
      \ or be [charmed](/rules/conditions.md#Charmed) by Bodhi. The [charmed](/rules/conditions.md#Charmed)\
      ...
      \ destroyed, is on a different plane of existence than the target, or takes\
