...
- "Uvashar"
---
# [Uvashar](/bestiary/npc/uvashar-veor.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 9\
      ...
      \ until it is lifted by a [remove curse](/spells/remove-curse-xphb.md) spell\
      \ or similar magic."
    "name": "Claw"
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Uvashar.webp"
```
^statblock