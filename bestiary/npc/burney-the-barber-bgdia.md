...
- "Burney the Barber"
---
# [Burney the Barber](/bestiary/npc/burney-the-barber-bgdia.md)
...
"traits":
  ...
  - "desc": "Burney has the benefits of the [healer](/feats/healer-xphb.md) feat as\
      \ well as proficiency with both the [healer's kit](/items/healers-kit-xphb.md)\
      \ and the [herbalism kit](/items/herbalism-kit-xphb.md)."
    "name": "Healer"
  - "desc": "Burney has received several blessings in her service to Bahamut:\n\n\
      ...
      \ [mind blank](/spells/mind-blank-xphb.md) spell, and cannot be detected by\
      \ magical or mundane means unless she wishes it. In exchange for this blessing,\
      ...
      \ though by a [word of recall](/spells/word-of-recall-xphb.md) spell. This explains\
      \ why Burney simply seems to appear amid the fully deployed marketplace each\
      \ morning it is active to provide service and tell stories.  \n- Once each day,\
      \ when Burney so desires, she can instantly transport herself to the court of\
      \ Bahamut via a powerful blessing akin to the [plane shift](/spells/plane-shift-xphb.md)\
      \ spell.  "
...
"legendary_actions":
  ...
  - "desc": "Burney beats its wings. Each creature within 15 feet of Burney must succeed\
      ...
      \ and be knocked [prone](/rules/conditions.md#Prone). Burney can then fly up\
      \ to half its flying speed."
    "name": "Wing Attack (Costs 2 Actions)"
"source":
  - "BGDIA"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BGDIA/Burney%20the%20Barber.webp"
```
^statblock