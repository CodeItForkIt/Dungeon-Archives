...
- "Aurelia"
---
# [Aurelia](/bestiary/npc/aurelia-ggr.md)
...
"reactions":
  ...
  - "desc": "When Aurelia is subjected to an effect that would move her, knock her\
      \ [prone](/rules/conditions.md#Prone), or both, she can use her reaction to\
      \ be neither moved nor knocked [prone](/rules/conditions.md#Prone)."
    "name": "Unyielding"
