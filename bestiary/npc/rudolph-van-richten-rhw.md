...
- "Rudolph van Richten"
---
# [Rudolph van Richten](/bestiary/npc/rudolph-van-richten-rhw.md)
*Source: RHW p. 264*  
...
Over the years, Rudolph has adventured alongside heroes like monster hunter George Weathermay and detectives Alanik Ray and Arthur Sedgewick. A new generation of heroes, including Ez d'Avenir and Gennifer and Laurie Weathermay-Foxgrove, have learned from the doctor and continue his fight against evil.
...
"cr": "5"
"traits":
  - "desc": "While [Bloodied](/rules/conditions.md#Bloodied), Rudolph has [Resistance](/rules/variant-rules/resistance-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 5 (1d6 + 2) Slashing\
      \ damage plus 5 (2d4) Radiant damage. Critical *Hit:* The target has the [Poisoned](/rules/conditions.md#Poisoned)\
      \ condition until it finishes a [Long Rest](/rules/variant-rules/long-rest-xphb.md).\
  ...
  - "desc": "*Charisma Saving Throw:* DC 15, each creature of Rudolph's choice in\
      \ a 30-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md). *Failure:*\
      \ 18 (4d8) Psychic damage, and the target has the [Frightened](/rules/conditions.md#Frightened)\
      \ condition until the end of Rudolph's next turn. *Success:* Half damage only."
    "name": "Repel Evil (Recharge 5-6)"
"bonus_actions":
  - "desc": "Rudolph casts [Cure Wounds](/spells/cure-wounds-xphb.md), [Dispel Evil\
      \ and Good](/spells/dispel-evil-and-good-xphb.md), or [Sanctuary](/spells/sanctuary-xphb.md),\
