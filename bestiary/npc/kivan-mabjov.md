...
- "Kivan"
---
# [Kivan](/bestiary/npc/kivan-mabjov.md)
...
Kivan is the primary contact for members of the Emerald Enclave at low levels. Kivan can connect you with an animal or plant companion for a short duration. Your group can only have one of these companions at a time. Once the companion has helped you for a 24-hour period you can make an [Animal Handling](/rules/skills.md#Animal%20Handling), [Nature](/rules/skills.md#Nature) or [Persuasion](/rules/skills.md#Persuasion) check (depending on the creature) to convince them to stay with you for another 24 hours. Each time you make this check it increases by 1. If the companion dies while helping you, you can never gain the aid of that type of creature again. If the companion leaves your service without dying, then you can ask Kivan for another companion after one month has passed.

**Animal and Plant Companions via Kivan**

| Magical Plant and Animal Companion | Required Level | Skill Check |
|------------------------------------|----------------|-------------|
| Overly enthusiastic blink dog | 1 | DC 15 [Animal Handling](/rules/skills.md#Animal%20Handling) |
| Sulky needle blight | 1 | DC 15 [Nature](/rules/skills.md#Nature) |
| Air headed satyr | 3 | DC 15 [Persuasion](/rules/skills.md#Persuasion) |
| Prankster vine blight | 3 | DC 15 [Nature](/rules/skills.md#Nature) |
| Sarcastic dryad | 5 | DC 15 [Persuasion](/rules/skills.md#Persuasion) |
| Awakened tree with confusing wisdom | 7 | DC 20 [Nature](/rules/skills.md#Nature) |
| Doom and gloom hamadryad | 7 | DC 20 [Persuasion](/rules/skills.md#Persuasion) |
^animal-and-plant-companions-via-kivan
...
"cr": "7"
"traits":
  - "desc": "Kivan has advantage on saving throws against being [charmed](/rules/conditions.md#Charmed),\
      \ and magic can't put Kivan to sleep."
    "name": "Fey Ancestry"
  - "desc": "Kivan has advantage on Wisdom ([Perception](/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 7\
      \ (1d8 + 3) slashing damage or 8 (1d10 + 3) slashing damage if wielded with\
      \ two hands."
    "name": "Longsword"
  - "desc": "*Ranged Weapon Attack:* +7 to hit, ranged 150/600 ft., one target.\
  ...
  - "desc": "Kivan makes a Longbow attack against any number of creatures he can see\
    ...
    "name": "Volley (2/Day)"
"bonus_actions":
  - "desc": "Kivan designates one creature he can see within 60 feet as his prey.\
      \ The first time each turn that Kivan hits his prey with a weapon attack, the\
      \ prey takes an extra 7 (2d6) damage from the weapon."
    "name": "Kivan's Mark"
"source":
  - "MaBJoV"
