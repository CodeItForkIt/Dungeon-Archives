...
- monster/type/humanoid/lycanthrope
statblock: inline
statblock-link: "#^statblock"
aliases:
- "Gennifer Weathermay-Foxgrove"
---
# [Gennifer Weathermay-Foxgrove](/bestiary/npc/gennifer-weathermay-foxgrove-rhw.md)
*Source: RHW p. 278*  
...
"cr": "3"
"traits":
  - "desc": "If reduced to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md),\
      ...
      \ immediately revives in her hybrid form with all her [Hit Points](/rules/variant-rules/hit-points-xphb.md)."
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +5, range 60 ft. *Hit:* 14 (2d10 + 3) Radiant\
      \ damage."
    "name": "Radiant Wisp"
  - "desc": "*Constitution Saving Throw:* DC 13, each creature in a 15-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from Gennifer. *Failure:* 18 (4d8) Radiant damage. If the target\
      \ is an Undead creature, it has the [Stunned](/rules/conditions.md#Stunned)\
  ...
  - "desc": "Gennifer casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ [Mending](/spells/mending-xphb.md)\n\n**1/day each:** [Locate Animals or Plants](/spells/locate-animals-or-plants-xphb.md),\
      \ [Magic Circle](/spells/magic-circle-xphb.md), [Protection from Poison](/spells/protection-from-poison-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Gennifer casts [Healing Word](/spells/healing-word-xphb.md), using the\
