...
- "Valygar"
---
# [Valygar](/bestiary/npc/valygar-mabjov.md)
...
"traits":
  ...
  - "desc": "When Valygar deals damage to a creature that is [concentrating](/rules/conditions.md#Concentration)\
      \ on a spell, that creature has disadvantage on the saving throw it makes to\
      \ maintain its [concentration](/rules/conditions.md#Concentration)."
    "name": "Mage Slaying"
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +8 to hit, range 30/120 ft., one target. *Hit:*\
    ...
    "name": "Hand Crossbow"
"bonus_actions":
  - "desc": "While in dim light or darkness, Valygar can take the [Hide](/rules/actions.md#Hide)\
