...
- "Hutijin"
---
# [Hutijin](/bestiary/npc/hutijin-mpmm.md)
...
Across the Hells, Hutijin's name fills lesser devils with fear and loathing, for this duke commands two companies of [pit fiends](/bestiary/fiend/pit-fiend-xmm.md). With such soldiers under his command, Hutijin can easily crush any rival who gets in his way while also defending Mephistopheles against armies seeking to contest his dominion. Hutijin has amassed enough power to challenge the lord of Cania, but he has never wavered in his support for his master—suggesting, perhaps, that Mephistopheles has some hold over him.
...
"actions":
  ...
  - "desc": "Hutijin casts one of the following spells, requiring no material components\
      ...
      \ will:** [alter self](/spells/alter-self-xphb.md) (can become Medium when changing\
      \ his appearance), [detect magic](/spells/detect-magic-xphb.md), [hold monster](/spells/hold-monster-xphb.md),\
      \ [invisibility](/spells/invisibility-xphb.md) (self only), [lightning bolt](/spells/lightning-bolt-xphb.md),\
      \ [suggestion](/spells/suggestion-xphb.md), [wall of fire](/spells/wall-of-fire-xphb.md)\n\
      \n**3/day:** [dispel magic](/spells/dispel-magic-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Hutijin.webp"
```
^statblock