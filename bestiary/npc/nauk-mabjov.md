...
- "Nauk"
---
# [Nauk](/bestiary/npc/nauk-mabjov.md)
...
"traits":
  - "desc": "When Nauk uses the Imbibe Potion action more than once in an hour, roll\
      ...
      \ works normally. In addition, Nauk turns [invisible](/rules/conditions.md#Invisible)\
  ...
  - "desc": "When Nauk is reduced to 0 hit points but not killed outright, he can\
    ...
    "name": "Relentless"
  - "desc": "Nauk wears [adamantine plate armor](/items/adamantine-armor-xdmg.md).\
      \ He wields a [+1 maul](/items/1-weapon-xdmg.md) and a [+1 heavy crossbow](/items/1-weapon-xdmg.md)\
      \ which is already factored into his stats. He has 2 [potions of resistance\
      \ (cold)](/items/potion-of-cold-resistance-xdmg.md), 2 [potions of resistance\
      \ (fire)](/items/potion-of-fire-resistance-xdmg.md), 2 [potions of resistance\
      \ (lightning)](/items/potion-of-lightning-resistance-xdmg.md). He has 2 [potions\
      \ of heroism](/items/potion-of-heroism-xdmg.md) and 4 [potions of superior healing](/items/potion-of-superior-healing-xdmg.md)."
    "name": "Special Items"
"actions":
  ...
  - "desc": "Nauk drinks a potion from the following list:\n\n- Potion of heroism:\
      ...
      \ is under the effect of the [bless](/spells/bless-xphb.md) spell (no [concentration](/rules/conditions.md#Concentration)\
      \ required).  \n- Potion of resistance: Nauk gains resistance from one damage\
      \ type for 1 hour. Nauk chooses from one of these damage types: cold, fire,\
