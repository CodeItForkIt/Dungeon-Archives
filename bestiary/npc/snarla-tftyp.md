...
- "Snarla"
---
# [Snarla](/bestiary/npc/snarla-tftyp.md)
...
A humanoid creature can be afflicted with the curse of lycanthropy after being wounded by a lycanthrope, or if one or both of its parents are lycanthropes. A [remove curse](/spells/remove-curse-xphb.md) spell can rid an afflicted lycanthrope of the curse, but a natural born lycanthrope can be freed of the curse only with a wish.
...
"traits":
  - "desc": "Snarla is a 6th-level spellcaster. Her spellcasting ability is Intelligence\
      ...
      \ [light](/spells/light-xphb.md), [mage hand](/spells/mage-hand-xphb.md), [shocking\
      \ grasp](/spells/shocking-grasp-xphb.md)\n\n**1st level (4 slots):** [magic\
      ...
      \ image](/spells/mirror-image-xphb.md), [web](/spells/web-xphb.md)\n\n**3rd\
      \ level (3 slots):** [dispel magic](/spells/dispel-magic-xphb.md), [fear](/spells/fear-xphb.md),\
      \ [haste](/spells/haste-xphb.md), [stinking cloud](/spells/stinking-cloud-xphb.md)"
    "name": "Spellcasting"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 6\
      ...
      \ on a DC 12 Constitution saving throw or be cursed with werewolf [lycanthropy](/rules/variant-rules/player-characters-as-lycanthropes-mm.md)."
...
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Snarla.webp"
```
^statblock