...
- "Shadrix Silverquill"
---
# [Shadrix Silverquill](/bestiary/npc/shadrix-silverquill-scc.md)
...
"senses": "[blindsight](/rules/senses.md#Blindsight) 120 ft., passive Perception 21"
"languages": "all"
"cr": "22"
"traits":
...
"actions":
  ...
  - "desc": "Shadrix exhales an entwined burst of blinding radiance and unnerving\
      ...
      \ and 31 (7d8) psychic damage and is [blinded](/rules/conditions.md#Blinded)\
      \ until the start of Shadrix's next turn. On a successful save, a creature takes\
      \ half as much damage and isn't [blinded](/rules/conditions.md#Blinded)."
  ...
  - "desc": "Shadrix casts one of the following spells, requiring no material components\
      ...
      \ each:** [darkness](/spells/darkness-xphb.md), [daylight](/spells/daylight-xphb.md),\
      \ [hypnotic pattern](/spells/hypnotic-pattern-xphb.md), [sending](/spells/sending-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "Shadrix magically summons 1d4 [inkling mascots](/bestiary/ooze/inkling-mascot-scc.md)\
