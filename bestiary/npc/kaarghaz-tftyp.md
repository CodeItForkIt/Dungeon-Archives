...
- "Kaarghaz"
---
# [Kaarghaz](/bestiary/npc/kaarghaz-tftyp.md)
...
"traits":
  - "desc": "Kaarghaz is a 4th-level spellcaster. His spellcasting ability is Charisma\
      ...
      \n**1st level (6 slots):** [burning hands](/spells/burning-hands-xphb.md), [shield](/spells/shield-xphb.md),\
      \ [sleep](/spells/sleep-xphb.md)\n\n**2nd level (3 slots):** [invisibility](/spells/invisibility-xphb.md),\
  ...
  - "desc": "While in sunlight, the troglodyte has disadvantage on attack rolls, as\
      \ well as on Wisdom ([Perception](/rules/skills.md#Perception)) checks that\
      \ rely on sight."
...
"source":
  - "TftYP"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Kaarghaz.webp"
```
^statblock