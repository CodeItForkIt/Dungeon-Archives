...
- "Sangora"
---
# [Sangora](/bestiary/npc/sangora-veor.md)
...
"traits":
  ...
  - "desc": "When it drops to 0 hit points outside its resting place, Sangora transforms\
      ...
      \ is then [paralyzed](/rules/conditions.md#Paralyzed) until it regains at least\
      \ 1 hit point. After spending 1 hour in its resting place with 0 hit points,\
  ...
  - "desc": "Sangora regains 20 hit points at the start of its turn if it has at least\
      ...
      \ damage or damage from [holy water](/items/holy-water-xphb.md), this trait\
      \ doesn't function at the start of Sangora's next turn."
    "name": "Regeneration"
  ...
  - "desc": "Sangora has the following flaws:\n\n- **Forbiddance.** Sangora can't\
      ...
      \ into Sangora's heart while Sangora is [incapacitated](/rules/conditions.md#Incapacitated)\
      \ in its resting place, Sangora is [paralyzed](/rules/conditions.md#Paralyzed)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one creature. *Hit:*\
      \ 8 (1d8 + 4) bludgeoning damage. Instead of dealing damage, Sangora can grapple\
      \ the target (escape DC 18)."
    "name": "Unarmed Strike (Vampire Form Only)"
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one willing creature,\
      \ or a creature that is [grappled](/rules/conditions.md#Grappled) by Sangora,\
      ...
      \ taken, and Sangora regains hit points equal to that amount. The reduction\
      ...
      \ buried in the ground rises the following night as a [vampire spawn](/bestiary/undead/vampire-spawn-xmm.md)\
  ...
  - "desc": "Sangora targets one humanoid it can see within 30 feet of it. If the\
      ...
      \ against this magic or be [charmed](/rules/conditions.md#Charmed) by Sangora.\
      \ The [charmed](/rules/conditions.md#Charmed) target regards Sangora as a trusted\
      \ friend to be heeded and protected. Although the target isn't under Sangora's\
      \ control, it takes Sangora's requests or actions in the most favorable way\
      \ it can, and it is a willing target for Sangora's bite attack.\n\nEach time\
      \ Sangora or Sangora's companions do anything harmful to the target, it can\
      \ repeat the saving throw, ending the effect on itself on a success. Otherwise,\
      \ the effect lasts 24 hours or until Sangora is destroyed, is on a different\
      \ plane of existence than the target, or takes a bonus action to end the effect."
    "name": "Charm"
  - "desc": "Sangora magically calls 2d4 swarms of [bats](/bestiary/beast/swarm-of-bats-xmm.md)\
      \ or [rats](/bestiary/beast/swarm-of-rats-xmm.md), provided that the sun isn't\
      \ up. While outdoors, Sangora can call 3d6 [wolves](/bestiary/beast/wolf-xmm.md)\
      \ instead. The called creatures arrive in 1d4 rounds, acting as allies of\
      \ Sangora and obeying its spoken commands. The beasts remain for 1 hour, until\
      \ Sangora dies, or until Sangora dismisses them as a bonus action."
...
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Sangora.webp"
```
^statblock