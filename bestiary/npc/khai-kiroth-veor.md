...
- "Khai Kiroth"
---
# [Khai Kiroth](/bestiary/npc/khai-kiroth-veor.md)
...
"cr": "19"
"traits":
  - "desc": "Magical darkness doesn't impede Khai's [darkvision](/rules/senses.md#Darkvision)."
    "name": "Devil's Sight"
...
"actions":
  ...
  - "desc": "Each creature of Khai's choice that is within 120 feet and aware of Khai\
      \ must succeed on a DC 18 Wisdom saving throw or become [frightened](/rules/conditions.md#Frightened)\
  ...
  - "desc": "Khai chooses up to four other creatures within 60 feet of it that can\
      ...
      \ attack rolls with advantage and can't be [frightened](/rules/conditions.md#Frightened)."
  ...
  - "desc": "Khai targets one Dragon it can see within 120 feet of it. The Dragon\
      ...
      \ of the Dragon Queen for 1 hour. On a failed save, the target is [charmed](/rules/conditions.md#Charmed)\
      \ by Khai for 1 hour. While [charmed](/rules/conditions.md#Charmed) in this\
      \ way, the target regards Khai as a trusted friend to be heeded and protected.\
      \ This effect ends if Khai or its companions deal damage to the target."
    "name": "Power of the Dragon Queen"
"source":
  - "VEoR"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Khai%20Kiroth.webp"
```
^statblock