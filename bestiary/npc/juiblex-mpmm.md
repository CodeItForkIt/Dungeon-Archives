...
- "Juiblex"
---
# [Juiblex](/bestiary/npc/juiblex-mpmm.md)
...
"actions":
  ...
  - "desc": "Juiblex spews out a corrosive slime, targeting one creature that it can\
      ...
      \ [mending](/spells/mending-xphb.md) spell."
  ...
  - "desc": "Juiblex casts one of the following spells, requiring no material components\
      ...
      \ [detect magic](/spells/detect-magic-xphb.md)\n\n**3/day each:** [contagion](/spells/contagion-xphb.md),\
      \ [gaseous form](/spells/gaseous-form-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Juiblex can take one\
      ...
      \ in a row:\n\n- **Green Slime.** A [green slime](/traps-hazards/green-slime-xdmg.md)\
      ...
      \ in that area must succeed on a DC 21 Strength saving throw or become [restrained](/rules/conditions.md#Restrained).\
...
"legendary_actions":
  ...
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ scraped off with an action, the target is [poisoned](/rules/conditions.md#Poisoned),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Juiblex.webp"
```
^statblock