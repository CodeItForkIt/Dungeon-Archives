...
- "Marfulb"
---
# [Marfulb](/bestiary/npc/marfulb-rot.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 4\
      \ (1d8) cold damage. If the target is a Medium or smaller creature it is [grappled](/rules/conditions.md#Grappled)\
      \ (escape DC 11). Until this grapple ends, the toad can't bite another target."
    "name": "Bite"
"source":
  - "RoT"
  - "ToD"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/RoT/Marfulb.webp"
```
^statblock