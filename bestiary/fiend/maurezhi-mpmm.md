...
- "Maurezhi"
---
# [Maurezhi](/bestiary/fiend/maurezhi-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 175, Mordenkainen's Tome of Foes p. 133*  

When Doresain, the King of Ghouls, corrupted a society of elves, he created a new sort of demon—the maurezhi—to lead packs of [ghouls](/bestiary/undead/ghoul-xmm.md) and [ghasts](/bestiary/undead/ghast-xmm.md) on the Material Plane.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 14\
      ...
      \ 24 hours later as a [ghoul](/bestiary/undead/ghoul-xmm.md)  unless it has\
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 12\
    ...
    "name": "Claw"
  - "desc": "The maurezhi targets one dead ghoul or [ghast](/bestiary/undead/ghast-xmm.md)\
      \ it can see within 30 feet of it. The target is revived with all its hit points."
    "name": "Raise Ghoul (Recharge 5-6)"
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Maurezhi.webp"
```
^statblock
