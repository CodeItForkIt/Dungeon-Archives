...
- "Spirit Naga"
---
# [Spirit Naga](/bestiary/fiend/spirit-naga-xmm.md)
...
"traits":
  - "desc": "If it dies, the naga returns to life in 1d6 days and regains all its\
      \ [Hit Points](/rules/variant-rules/hit-points-xphb.md). Only a [Wish](/spells/wish-xphb.md)\
...
"actions":
  ...
  - "desc": "The naga casts one of the following spells, requiring no Somatic or Material\
      ...
      \ Hand](/spells/mage-hand-xphb.md), [Minor Illusion](/spells/minor-illusion-xphb.md),\
      ...
      \ [Hold Person](/spells/hold-person-xphb.md) (level 3 version), [Lightning Bolt](/spells/lightning-bolt-xphb.md)\
      \ (level 4 version)"
    "name": "Spellcasting"
"source":
  - "XMM"
