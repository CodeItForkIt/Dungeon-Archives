...
- "Farastu Demodand"
---
# [Farastu Demodand](/bestiary/fiend/farastu-demodand-mpp.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 16\
      ...
      \ 15, with disadvantage). The farastu has two claws, each of which can grapple\
      \ one creature."
    "name": "Claw"
  ...
  - "desc": "The farastu casts one of the following spells, requiring no material\
      ...
      \ [dispel magic](/spells/dispel-magic-xphb.md), [fog cloud](/spells/fog-cloud-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPP"
