...
- "Alkilith"
---
# [Alkilith](/bestiary/fiend/alkilith-mpmm.md)
...
"traits":
  ...
  - "desc": "Any creature that isn't a demon that starts its turn within 30 feet of\
      ...
      \ fails by 5 or more, the creature is instead subjected to the [confusion](/spells/confusion-xphb.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Alkilith.webp"
```
^statblock
