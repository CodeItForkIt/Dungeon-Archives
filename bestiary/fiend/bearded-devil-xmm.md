...
- "Bearded Devil"
---
# [Bearded Devil](/bestiary/fiend/bearded-devil-xmm.md)
...
"senses": "[Darkvision](/rules/senses.md#Darkvision) 120 ft. (unimpeded by magical\
  \ [Darkness](/rules/variant-rules/darkness-xphb.md)), passive Perception 10"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 7 (1d8 + 3) Piercing\
      ...
      \ can't regain [Hit Points](/rules/variant-rules/hit-points-xphb.md)."
    "name": "Beard"
  - "desc": "*Melee Attack Roll:* +5, reach 10 ft. *Hit:* 8 (1d10 + 3) Slashing\
      ...
      \ loses 5 (1d10) [Hit Points](/rules/variant-rules/hit-points-xphb.md) at\
      \ the start of each of its turns. The wound closes after 1 minute, after a spell\
      \ restores [Hit Points](/rules/variant-rules/hit-points-xphb.md) to the target,\
