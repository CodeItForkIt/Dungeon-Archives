...
- "Nupperibo"
---
# [Nupperibo](/bestiary/fiend/nupperibo-mpmm.md)
...
Individually, nupperibos are weak, but they're rarely alone and can be dangerous when gathered into packs. Clouds of stinging insects, [stirges](/bestiary/monstrosity/stirge-xmm.md), and other vermin surround them in a terrifying, reeking sheath that torments any non-devil that draws near.
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Nupperibo.webp"
```
^statblock