...
- "Erinyes"
---
# [Erinyes](/bestiary/fiend/erinyes-xmm.md)
...
"traits":
  ...
  - "desc": "The erinyes has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
  ...
  - "desc": "The erinyes has a magic rope. While bearing it, the erinyes can use the\
      ...
      \ Points](/rules/variant-rules/hit-points-xphb.md), if it is 5+ feet away from\
      \ the erinyes for 1 hour or more, or if the erinyes dies. If the rope is damaged\
      \ or destroyed, the erinyes can fully restore it when finishing a [Short](/rules/variant-rules/short-rest-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 16, one creature the erinyes can see within\
      \ 120 feet. *Failure:* 14 (4d6) Force damage, and the target has the [Restrained](/rules/conditions.md#Restrained)\
      \ condition until the rope is destroyed, the erinyes uses a [Bonus Action](/rules/variant-rules/bonus-action-xphb.md)\
