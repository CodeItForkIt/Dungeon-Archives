...
- "Howler"
---
# [Howler](/bestiary/fiend/howler-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 10\
      ...
      \ is [frightened](/rules/conditions.md#Frightened). This attack ignores damage\
      \ resistance."
    "name": "Rending Bite"
  - "desc": "The howler emits a keening howl in a 60-foot cone. Each creature in that\
      ...
      \ damage and be [frightened](/rules/conditions.md#Frightened) until the end\
      \ of the howler's next turn. While a creature is [frightened](/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Howler.webp"
```
^statblock
