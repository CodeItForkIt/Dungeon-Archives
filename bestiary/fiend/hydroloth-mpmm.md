...
- "Hydroloth"
---
# [Hydroloth](/bestiary/fiend/hydroloth-mpmm.md)
...
"actions":
  ...
  - "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
      ...
      \ itself on a success. A [greater restoration](/spells/greater-restoration-xphb.md)\
      \ or [remove curse](/spells/remove-curse-xphb.md) spell cast on the target ends\
      \ this effect early."
  ...
  - "desc": "The hydroloth casts one of the following spells, requiring no material\
      ...
      \ (self only)\n\n**3/day each:** [control water](/spells/control-water-xphb.md),\
      \ [crown of madness](/spells/crown-of-madness-xphb.md), [fear](/spells/fear-xphb.md),\
      \ [suggestion](/spells/suggestion-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Hydroloth.webp"
```
^statblock