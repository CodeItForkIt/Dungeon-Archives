...
- "Dretch"
---
# [Dretch](/bestiary/fiend/dretch-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 4 (1d6 + 1) Slashing\
      \ damage."
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 11, each creature in a 10-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the dretch. *Failure:* The target has the [Poisoned](/rules/conditions.md#Poisoned)\
