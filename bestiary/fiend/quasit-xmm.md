...
- "Quasit"
---
# [Quasit](/bestiary/fiend/quasit-xmm.md)
...
"cr": "1"
"traits":
  - "desc": "The quasit has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
...
"actions":
  ...
  - "desc": "The quasit shape-shifts to resemble a bat ([Speed](/rules/variant-rules/speed-xphb.md)\
      ...
      \ same in each form, except for its [Speed](/rules/variant-rules/speed-xphb.md).\
      \ Any equipment it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The quasit casts [Invisibility](/spells/invisibility-xphb.md) on itself,\
