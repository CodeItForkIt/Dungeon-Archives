...
- "Kelubar Consul"
---
# [Kelubar Consul](/bestiary/fiend/kelubar-consul-mabjov.md)
...
"traits":
  ...
  - "desc": "The kelubar is unaffected by difficult terrain, and spells and other\
      \ magical affects don't reduce its speed or cause it to be [paralyzed](/rules/conditions.md#Paralyzed)\
      \ or [restrained](/rules/conditions.md#Restrained). If the kelubar spends 5\
      \ feet of movement is automatically escapes from nonmagical restraints or a\
      \ creature that has it [grappled](/rules/conditions.md#Grappled). It is also\
      \ able to move underwater with no movement or attack penalties."
  ...
  - "desc": "Any creature that is not a demodand and starts its turn within 30 feet\
      ...
      \ the [poisoned](/rules/conditions.md#Poisoned) condition for 1 minute. On a\
      \ successful saving throw, the creature is immune to the stench of this kelubar\
      \ for 1 hour."
    "name": "Stench"
"actions":
  ...
  - "desc": "The kelubar casts one of the following spells, requiring no material\
      ...
      \n**At will:** [clairvoyance](/spells/clairvoyance-xphb.md), [detect magic](/spells/detect-magic-xphb.md),\
      \ [fear](/spells/fear-xphb.md), [invisibility](/spells/invisibility-xphb.md)\
      \ (self only), [spider climb](/spells/spider-climb-xphb.md), [tongues](/spells/tongues-xphb.md)\n\
      \n**2/day each:** [dispel magic](/spells/dispel-magic-xphb.md), [fog cloud](/spells/fog-cloud-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The kelubar rolls a d6. A result of 1-2 summons in two allied [farastu\
      \ stalkers](/bestiary/fiend/farastu-stalker-mabjov.md), a result of 3-4 summons\
      \ in one allied [kelubar consul](/bestiary/fiend/kelubar-consul-mabjov.md)."
