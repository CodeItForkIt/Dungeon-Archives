...
- "Nycaloth"
---
# [Nycaloth](/bestiary/fiend/nycaloth-xmm.md)
...
"traits":
  ...
  - "desc": "The nycaloth has [Advantage](/rules/variant-rules/advantage-xphb.md)\
...
"bonus_actions":
  - "desc": "The nycaloth has the [Invisible](/rules/conditions.md#Invisible) condition\
      \ for 1 minute, and it teleports up to 30 feet to an unoccupied space it can\
      \ see. The condition ends early immediately after it deals damage."
