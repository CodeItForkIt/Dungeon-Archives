...
- "Sibriex"
---
# [Sibriex](/bestiary/fiend/sibriex-mpmm.md)
...
"actions":
  ...
  - "desc": "The sibriex targets up to three creatures it can see within 120 feet\
      ...
      \ it to also gain 1 level of [exhaustion](/rules/conditions.md#Exhaustion).\
      \ While [poisoned](/rules/conditions.md#Poisoned) in this way, the target must\
      \ repeat the saving throw at the start of each of its turns. Three successful\
      \ saves against the poison end it, and ending the poison removes any levels\
      \ of [exhaustion](/rules/conditions.md#Exhaustion) caused by it. Each failed\
      \ save causes the target to gain another level of [exhaustion](/rules/conditions.md#Exhaustion).\
      \ Once the target reaches 6 levels of [exhaustion](/rules/conditions.md#Exhaustion),\
      \ it dies and instantly transforms into a living [manes](/bestiary/fiend/manes-xmm.md)\
      \ under the sibriex's control. The transformation of the body can be undone\
      \ only by a [wish](/spells/wish-xphb.md) spell."
    "name": "Warp Creature"
  - "desc": "The sibriex casts one of the following spells, requiring no material\
      ...
      \n**At will:** [command](/spells/command-xphb.md), [dispel magic](/spells/dispel-magic-xphb.md),\
      \ [hold monster](/spells/hold-monster-xphb.md)\n\n**1/day:** [feeblemind](/spells/befuddlement-xphb.md)"
    "name": "Spellcasting"
