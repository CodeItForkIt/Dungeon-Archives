...
- "Bulezau"
---
# [Bulezau](/bestiary/fiend/bulezau-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 8\
      ...
      \ disease or become [poisoned](/rules/conditions.md#Poisoned) until the disease\
      \ ends. While [poisoned](/rules/conditions.md#Poisoned) in this way, the target\
      \ sports festering boils, coughs up flies, and sheds rotting skin, and the target\
      \ must repeat the saving throw after every 24 hours that elapse. On a successful\
      \ save, the disease ends. On a failed save, the target's hit point maximum is\
      \ reduced by 4 (1d8). The target dies if its hit point maximum is reduced\
      \ to 0."
    "name": "Barbed Tail"
"source":
  - "MPMM"
