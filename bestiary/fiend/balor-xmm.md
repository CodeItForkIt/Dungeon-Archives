...
- "Balor"
---
# [Balor](/bestiary/fiend/balor-xmm.md)
...
"traits":
  - "desc": "The balor explodes when it dies. *Dexterity Saving Throw:* DC 20, each\
      ...
      \ Points](/rules/variant-rules/hit-points-xphb.md) somewhere in the Abyss."
    "name": "Death Throes"
  - "desc": "At the end of each of the balor's turns, each creature in a 5-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  - "desc": "The balor has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
