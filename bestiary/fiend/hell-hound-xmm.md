...
- "Hell Hound"
---
# [Hell Hound](/bestiary/fiend/hell-hound-xmm.md)
...
"cr": "3"
"traits":
  - "desc": "The hound has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
      \ an attack roll against a creature if at least one of the hound's allies is\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 7 (1d8 + 3) Piercing\
    ...
    "name": "Bite"
  - "desc": "*Dexterity Saving Throw:* DC 12, each creature in a 15-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
