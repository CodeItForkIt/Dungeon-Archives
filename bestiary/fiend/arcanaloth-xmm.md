...
- "Arcanaloth"
---
# [Arcanaloth](/bestiary/fiend/arcanaloth-xmm.md)
...
"traits":
  ...
  - "desc": "The arcanaloth has [Advantage](/rules/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The arcanaloth has a magic tome. While holding or carrying the tome,\
      ...
      \ 35; and [Immunity](/rules/variant-rules/immunity-xphb.md) to Necrotic, Poison,\
      \ and Psychic damage. The tome regains all its [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ create a new one when it finishes a [Short](/rules/variant-rules/short-rest-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (2d4 + 5) Slashing\
      ...
      \ tome and can escape only if the tome is reduced to 0 [Hit Points](/rules/variant-rules/hit-points-xphb.md)."
  ...
  - "desc": "The arcanaloth casts one of the following spells, requiring no Material\
      ...
      \ DC 17):\n\n**At will:** [Alter Self](/spells/alter-self-xphb.md), [Detect\
      \ Magic](/spells/detect-magic-xphb.md), [Identify](/spells/identify-xphb.md),\
      \ [Mage Hand](/spells/mage-hand-xphb.md), [Prestidigitation](/spells/prestidigitation-xphb.md)\n\
      \n**1/day each:** [Contact Other Plane](/spells/contact-other-plane-xphb.md),\
...
"bonus_actions":
  - "desc": "The arcanaloth teleports up to 30 feet to an unoccupied space it can\
    ...
    "name": "Teleport"
"reactions":
  - "desc": "The arcanaloth casts [Counterspell](/spells/counterspell-xphb.md) in\
