...
- "Kakkuu Spyder-Fiend"
---
# [Kakkuu Spyder-Fiend](/bestiary/fiend/kakkuu-spyder-fiend-veor.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 14\
    ...
    "name": "Bite"
  - "desc": "The kakkuu pulls each creature within 60 feet of itself that is [grappled](/rules/conditions.md#Grappled)\
  ...
  - "desc": "*Ranged Weapon Attack:* +6 to hit, reach 30/60 ft., one Large or smaller\
      ...
      \ the target also has the [restrained](/rules/conditions.md#Restrained) condition.\
      \ A web snare grappling a creature can be attacked and destroyed (AC 10; 10\
      \ hit points; immunity to bludgeoning, poison, and psychic damage)."
    "name": "Web Snare"
"source":
  - "VEoR"
