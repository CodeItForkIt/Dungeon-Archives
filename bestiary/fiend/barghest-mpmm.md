...
- "Barghest"
---
# [Barghest](/bestiary/fiend/barghest-mpmm.md)
...
"actions":
  ...
  - "desc": "The barghest casts one of the following spells, requiring no material\
      ...
      \n**At will:** [levitate](/spells/levitate-xphb.md), [minor illusion](/spells/minor-illusion-xphb.md),\
      \ [pass without trace](/spells/pass-without-trace-xphb.md)\n\n**1/day each:**\
      \ [charm person](/spells/charm-person-xphb.md), [dimension door](/spells/dimension-door-xphb.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Barghest.webp"
```
^statblock
