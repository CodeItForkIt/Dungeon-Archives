...
- "Degloth"
---
# [Degloth](/bestiary/fiend/degloth-veor.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ creature, the target has the [grappled](/rules/conditions.md#Grappled) condition\
      \ (escape DC 18). Until this grapple ends, the target has the [restrained](/rules/conditions.md#Restrained)\
      \ condition, and the degloth can't use this fist to grapple another target.\
      \ The degloth has two fists."
    "name": "Razor Fist"
"bonus_actions":
  - "desc": "The degloth targets one creature currently [grappled](/rules/conditions.md#Grappled)\
