...
- "Narzugon"
---
# [Narzugon](/bestiary/fiend/narzugon-mpmm.md)
...
Narzugons wield hell-forged lances that shunt the souls of any they killed to the River Styx for rebirth as [lemures](/bestiary/fiend/lemure-xmm.md). Every lance bears the marks of both a narzugon and its master.

Each narzugon claims a [nightmare](/bestiary/fiend/nightmare-xmm.md) as its mount. These steeds are bound by [infernal tack](/items/infernal-tack-mtf.md) and must respond to the summons and commands of the spurs' wearer.
...
"cr": "13"
"traits":
  - "desc": "The narzugon wears spurs that are part of [infernal tack](/items/infernal-tack-mtf.md),\
      \ which allow it to summon its [nightmare](/bestiary/fiend/nightmare-xmm.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ kills a creature with a soul, the soul rises from the River Styx as a [lemure](/bestiary/fiend/lemure-xmm.md)\
      \ in Avernus in 1d4 hours. If the creature isn't revived before then, only\
      \ a [wish](/spells/wish-xphb.md) spell or killing the lemure and casting true\
