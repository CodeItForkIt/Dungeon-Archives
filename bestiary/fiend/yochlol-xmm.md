...
- "Yochlol"
---
# [Yochlol](/bestiary/fiend/yochlol-xmm.md)
...
"traits":
  ...
  - "desc": "The yochlol has [Advantage](/rules/variant-rules/advantage-xphb.md) on\
...
"actions":
  - "desc": "The yochlol makes two Caustic Lash attacks, and it can use Spellcasting\
      \ to cast [Web](/spells/web-xphb.md) or [Dominate Person](/spells/dominate-person-xphb.md)\
      \ if available."
    "name": "Multiattack"
  ...
  - "desc": "The yochlol casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Detect Thoughts](/spells/detect-thoughts-xphb.md), [Gaseous\
      \ Form](/spells/gaseous-form-xphb.md) (self only), [Web](/spells/web-xphb.md)\n\
      \n**1/day:** [Dominate Person](/spells/dominate-person-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"reactions":
  - "desc": "Trigger: The yochlol is hit by an attack roll. _Response:_ The yochlol\
      ...
      \ it has the [Incapacitated](/rules/conditions.md#Incapacitated) condition."
    "name": "Toxic Escape"
"source":
  - "XMM"
