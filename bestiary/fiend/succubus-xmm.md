...
- "Succubus"
---
# [Succubus](/bestiary/fiend/succubus-xmm.md)
...
"traits":
  - "desc": "When the succubus finishes a [Long Rest](/rules/variant-rules/long-rest-xphb.md),\
      \ it can shape-shift into an [Incubus](/bestiary/fiend/incubus-xmm.md), using\
      \ that stat block instead of this one."
    "name": "Incubus Form"
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 16 (2d10 + 5) Psychic\
      \ damage."
    "name": "Fiendish Touch"
  - "desc": "The succubus casts [Dominate Person](/spells/dominate-person-xphb.md)\
  ...
  - "desc": "*Constitution Saving Throw:* DC 15, one creature [Charmed](/rules/conditions.md#Charmed)\
      ...
      \ Half damage. *Failure or Success:* The target's [Hit Point](/rules/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "The succubus shape-shifts to resemble a Medium or Small Humanoid or back\
      ...
      \ its [Fly Speed](/rules/variant-rules/fly-speed-xphb.md) is available only\
