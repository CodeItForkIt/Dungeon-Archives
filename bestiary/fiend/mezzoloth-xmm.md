...
- "Mezzoloth"
---
# [Mezzoloth](/bestiary/fiend/mezzoloth-xmm.md)
...
"traits":
  ...
  - "desc": "The mezzoloth has [Advantage](/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 9 (2d4 + 4) Slashing\
      ...
      \ condition (escape DC 14) from two of four claws, and it has the [Restrained](/rules/conditions.md#Restrained)\
  ...
  - "desc": "The mezzoloth casts one of the following spells, requiring no Material\
      ...
      \n**1/day each:** [Cloudkill](/spells/cloudkill-xphb.md), [Darkness](/spells/darkness-xphb.md),\
