...
- "Swarm of Lemures"
---
# [Swarm of Lemures](/bestiary/fiend/swarm-of-lemures-xmm.md)
...
"senses": "[Darkvision](/rules/senses.md#Darkvision) 120 ft. (unimpeded by magical\
  \ [Darkness](/rules/variant-rules/darkness-xphb.md)), passive Perception 11"
...
"traits":
  - "desc": "If the swarm dies in the Nine Hells, it revives with all its [Hit Points](/rules/variant-rules/hit-points-xphb.md)\
      \ in 1d10 days unless it is killed by a creature under the effects of a [Bless](/spells/bless-xphb.md)\
      \ spell or its remains are sprinkled with [Holy Water](/items/holy-water-xphb.md)."
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 11 (2d8 + 2) Poison damage,\
      \ or 9 (2d6 + 2) Poison damage if the swarm is [Bloodied](/rules/conditions.md#Bloodied)."
    "name": "Vile Slime"
"source":
  - "XMM"
