...
- "Manes Vaporspawn"
---
# [Manes Vaporspawn](/bestiary/fiend/manes-vaporspawn-xmm.md)
...
"traits":
  - "desc": "The manes can move through a space as narrow as 1 inch without expending\
    ...
    "name": "Contortionist"
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 5-foot [Emanation](/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](/rules/variant-rules/dim-light-xphb.md) or [Darkness](/rules/variant-rules/darkness-xphb.md),\
      \ the manes takes the [Hide](/rules/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
