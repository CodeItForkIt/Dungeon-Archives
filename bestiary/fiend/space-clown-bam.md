...
- "Space Clown"
---
# [Space Clown](/bestiary/fiend/space-clown-bam.md)
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 120 ft., one creature. *Hit:*\
      ...
      \ and is [incapacitated](/rules/conditions.md#Incapacitated) for 1 minute. The\
  ...
  - "desc": "The clown casts one of the following spells, requiring no material components\
      ...
      \n**1/day each:** [mirror image](/spells/mirror-image-xphb.md), [spider climb](/spells/spider-climb-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The clown veils itself and everything it is wearing and carrying in an\
      ...
      \ as a floating balloon). Maintaining this effect requires the clown's [concentration](/rules/conditions.md#Concentration)\
      \ (as if [concentrating](/rules/conditions.md#Concentration) on a spell), and\
      \ the illusion fails to hold up to physical inspection. As an action, a creature\
      \ that can see the clown's illusory form can make a DC 15 Wisdom ([Insight](/rules/skills.md#Insight))\
