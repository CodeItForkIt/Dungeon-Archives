...
- "Werevulture"
---
# [Werevulture](/bestiary/fiend/werevulture-bmt.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 10\
      ...
      \ Curse](/spells/remove-curse-xphb.md) spell or a similar effect. If the cursed\
      \ target drops to 0 hit points, it becomes a werevulture under the DM's control\
      \ and regains 10 hit points."
...
"source":
  - "BMT"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Werevulture.webp"
```
^statblock