...
- "Ultroloth"
---
# [Ultroloth](/bestiary/fiend/ultroloth-xmm.md)
...
"traits":
  ...
  - "desc": "The ultroloth has [Advantage](/rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 15 ft. *Hit:* 25 (6d6 + 4) Force damage,\
    ...
    "name": "Mercurial Whip"
  - "desc": "*Wisdom Saving Throw:* DC 17, each creature in a 30-foot [Cone](/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 10 (3d6) Psychic damage, and the target has the [Stunned](/rules/conditions.md#Stunned)\
  ...
  - "desc": "The ultroloth casts one of the following spells, requiring no Material\
      ...
      \ DC 17):\n\n**At will:** [Alter Self](/spells/alter-self-xphb.md), [Clairvoyance](/spells/clairvoyance-xphb.md),\
      \ [Detect Magic](/spells/detect-magic-xphb.md)\n\n**1/day each:** [Dimension\
      \ Door](/spells/dimension-door-xphb.md), [Fireball](/spells/fireball-xphb.md)\
      \ (level 5 version), [Wall of Fire](/spells/wall-of-fire-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The ultroloth casts [Dispel Magic](/spells/dispel-magic-xphb.md), [Invisibility](/spells/invisibility-xphb.md)\
      \ (self only), [Misty Step](/spells/misty-step-xphb.md), or [Suggestion](/spells/suggestion-xphb.md),\
