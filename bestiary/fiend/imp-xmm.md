...
"actions":
  ...
  - "desc": "The imp shape-shifts to resemble a rat ([Speed](/rules/variant-rules/speed-xphb.md)\
      ...
      \ except for its [Speed](/rules/variant-rules/speed-xphb.md). Any equipment\
      \ it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The imp casts [Invisibility](/spells/invisibility-xphb.md) on itself,\
