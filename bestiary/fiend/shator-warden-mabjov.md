...
- "Shator Warden"
---
# [Shator Warden](/bestiary/fiend/shator-warden-mabjov.md)
...
"actions":
  ...
  - "desc": "The shator exhales poisonous spit in a 20-foot line that is 5 feet wide.\
      ...
      \ 22 (5d8) acid damage on a failed save and having the [paralyzed](/rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The shator casts one of the following spells, requiring no material components\
      ...
      \ will:** [clairvoyance](/spells/clairvoyance-xphb.md), [detect magic](/spells/detect-magic-xphb.md),\
      ...
      \n**2/day each:** [cloudkill](/spells/cloudkill-xphb.md), [dispel magic](/spells/dispel-magic-xphb.md),\
      \ [plane shift](/spells/plane-shift-xphb.md), [Tasha's hideous laughter](/spells/tashas-hideous-laughter-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The shator rolls a d6. A result of 1-2 summons in two allied [farastu\
      ...
      \ in one allied [shator warden](/bestiary/fiend/shator-warden-mabjov.md)."
    "name": "Summon Demodand (1/Day)"
"reactions":
  - "desc": "When hit with a melee attack, the shator expels a toxic slime. The attacker\
      \ must succeed on a DC 18 Dexterity saving throw or have the [paralyzed](/rules/conditions.md#Paralyzed)\
      \ condition for 1 minute. A creature can repeat the saving throw at the end\
      \ of each of its turns, ending the effect on a success."
