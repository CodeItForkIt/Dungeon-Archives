...
- "Amnizu"
---
# [Amnizu](/bestiary/fiend/amnizu-mpmm.md)
...
"actions":
  ...
  - "desc": "The amnizu casts one of the following spells, requiring no material components\
      ...
      **At will:** [command](/spells/command-xphb.md)\n\n**3/day:** [dominate monster](/spells/dominate-monster-xphb.md)\n\
...
"source":
  - "MPMM"
  - "MTF"
"image": "https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Amnizu.webp"
```
^statblock