...
- "Baernaloth"
---
# [Baernaloth](/bestiary/fiend/baernaloth-mpp.md)
...
"actions":
  ...
  - "desc": "The baernaloth exhales gray vapors that coalesce at a point it can see\
      ...
      \ psychic damage and has the [charmed](/rules/conditions.md#Charmed) condition\
  ...
  - "desc": "The baernaloth casts one of the following spells, requiring no material\
      ...
      \ [phantasmal force](/spells/phantasmal-force-xphb.md), [suggestion](/spells/suggestion-xphb.md)\n\
      \n**1/day each:** [cloudkill](/spells/cloudkill-xphb.md), [plane shift](/spells/plane-shift-xphb.md)\
      \ (self only), [scrying](/spells/scrying-xphb.md) (as an action)"
    "name": "Spellcasting"
"reactions":
